import { a as e, i as t, n, r, t as i } from "./main.js";
//#region node_modules/sql-escaper/lib/index.js
var a = /* @__PURE__ */ i(((e) => {
	Object.defineProperty(e, "__esModule", { value: !0 }), e.raw = e.format = e.escape = e.arrayToList = e.bufferToString = e.objectToValues = e.escapeId = e.temporalToString = e.dateToString = void 0;
	var n = t("node:buffer"), r = new Uint8Array(128), i = {}, a = [
		"where",
		"order",
		"group",
		"having",
	...
	r[s.singleQuote] = 1, r[s.backtick] = 1, r[s.dash] = 1, r[s.slash] = 1;
	for (let e of a) {
		let t = e.charCodeAt(0), n = i[t];
		n ? n.push(e) : i[t] = [e];
	}
	var c = Object.prototype.hasOwnProperty, l = (e) => typeof e == "object" && !!e && !Array.isArray(e) && !(e instanceof Set) && !(e instanceof Map), u = (e) => e >= 65 && e <= 90 || e >= 97 && e <= 122 || e >= 48 && e <= 57 || e === 95, d = (e) => e === s.space || e === s.tab || e === s.newline || e === s.carriageReturn, f = (e) => e | 32, p = (e, t, n, r) => {
		let i = n.length;
		for (let r = 0; r < i; r++) if (f(e.charCodeAt(t + r)) !== n.charCodeAt(r)) return !1;
		return (t === 0 || !u(e.charCodeAt(t - 1))) && (t + i >= r || !u(e.charCodeAt(t + i)));
	}, m = (e, t) => {
		let n = e.charCodeAt(t), r = e.charCodeAt(t + 1);
		if (n === s.singleQuote) {
			for (let n = t + 1; n < e.length; n++) if (e.charCodeAt(n) === s.backslash) n++;
			else if (e.charCodeAt(n) === s.singleQuote) return n + 1;
			return e.length;
		}
		if (n === s.backtick) {
			let n = e.length;
			for (let r = t + 1; r < n; r++) if (e.charCodeAt(r) === s.backtick) {
				if (e.charCodeAt(r + 1) === s.backtick) {
					r++;
					continue;
				}
				return r + 1;
		...
		if (n === s.dash && r === s.dash) {
			let n = e.charCodeAt(t + 2);
			if (Number.isNaN(n) || n <= s.space) {
				let n = e.indexOf("\n", t + 2);
				return n === -1 ? e.length : n + 1;
			}
			return -1;
		}
		if (n === s.slash && r === s.asterisk) {
			let n = e.charCodeAt(t + 2);
			if (n === s.exclamation || n === s.plus) return -1;
			let r = e.indexOf("*/", t + 2);
		...
		for (let f = t; f < n;) {
			...
			if (u(t)) {
				if (o === 0 && !(t >= 48 && t <= 57)) {
					let n = i[t | 32];
					if (n) {
						for (let t = 0; t < n.length; t++) if (p(e, f, n[t], a)) return !1;
					}
				}
				do
					f++;
				while (f < n && u(e.charCodeAt(f)));
				c = !0, l = !1;
				continue;
			}
			if (o === 0) {
				if (t === s.semicolon) return !1;
				if (t === s.comma) {
					l = !0, c = !0, f++;
					continue;
				}
		...
		for (let i = t; i < n; i++) {
			...
			let a = t | 32;
			if (a === 115 && p(e, i, "set", n)) return i + 3;
			if (a === 107 && p(e, i, "key", n)) {
				let t = i + 3;
				for (; t < n && d(e.charCodeAt(t));) t++;
				if (p(e, t, "update", n)) return t + 6;
			}
		}
		return -1;
	}, v = (e) => Object.prototype.toString.call(e) === "[object Date]", y = (e) => Object.prototype.toString.call(e).startsWith("[object Temporal."), b = (e) => typeof e == "object" && !!e && "toSqlString" in e && typeof e.toSqlString == "function", x = (e) => {
		let t = o.escapeChars;
		t.lastIndex = 0;
		let n = t.exec(e);
		if (n === null) return `'${e}'`;
		let r = e.length, i = "'" + e.slice(0, n.index), a = n.index;
		for (let t = n.index; t < r; t++) {
			let n;
			...
			i += e.slice(a, t) + n, a = t + 1;
		}
		return i + e.slice(a) + "'";
	}, S = (e) => e < 10 ? "0" + e : "" + e, C = (e) => e < 10 ? "00" + e : e < 100 ? "0" + e : "" + e, w = (e) => e < 10 ? "000" + e : e < 100 ? "00" + e : e < 1e3 ? "0" + e : "" + e, T = (e) => {
		if (e === "Z") return 0;
		let t = e.match(o.timezone);
		return t ? (t[1] === "-" ? -1 : 1) * (Number.parseInt(t[2], 10) + (t[3] ? Number.parseInt(t[3], 10) : 0) / 60) * 60 : !1;
	};
	e.dateToString = (e, t) => {
		if (Number.isNaN(e.getTime())) return "NULL";
		let n, r, i, a, o, s, c;
		if (t === "local") n = e.getFullYear(), r = e.getMonth() + 1, i = e.getDate(), a = e.getHours(), o = e.getMinutes(), s = e.getSeconds(), c = e.getMilliseconds();
		else {
			let l = T(t), u = e.getTime();
			l !== !1 && l !== 0 && (u += l * 6e4);
			let d = new Date(u);
			n = d.getUTCFullYear(), r = d.getUTCMonth() + 1, i = d.getUTCDate(), a = d.getUTCHours(), o = d.getUTCMinutes(), s = d.getUTCSeconds(), c = d.getUTCMilliseconds();
		}
		return x(w(n) + "-" + S(r) + "-" + S(i) + " " + S(a) + ":" + S(o) + ":" + S(s) + "." + C(c));
	}, e.temporalToString = (t, n) => typeof t.epochMilliseconds == "number" ? (0, e.dateToString)(new Date(t.epochMilliseconds), n || "local") : t[Symbol.toStringTag] === "Temporal.PlainDateTime" ? x(t.toString().replace("T", " ")) : x(t.toString()), e.escapeId = (t, n) => {
		if (Array.isArray(t)) {
			let r = t.length, i = "";
			for (let a = 0; a < r; a++) a > 0 && (i += ", "), i += (0, e.escapeId)(t[a], n);
			return i;
		}
		let r = String(t), i = !n && r.indexOf("->") !== -1;
		return n || i ? r.indexOf("`") === -1 ? `\`${r}\`` : `\`${r.replace(o.backtick, "``")}\`` : r.indexOf("`") === -1 && r.indexOf(".") === -1 ? `\`${r}\`` : `\`${r.replace(o.backtick, "``").replace(o.dot, "`.`")}\``;
	}, e.objectToValues = (t, n) => {
		let r = "";
		if (t instanceof Map) {
			for (let [i, a] of t) typeof a != "function" && (r.length > 0 && (r += ", "), r += (0, e.escapeId)(String(i)), r += " = ", r += (0, e.escape)(a, !0, n));
			return r;
		}
		for (let i in t) {
			if (!c.call(t, i)) continue;
			let a = t[i];
			typeof a != "function" && (r.length > 0 && (r += ", "), r += (0, e.escapeId)(i), r += " = ", r += (0, e.escape)(a, !0, n));
		}
		return r;
	}, e.bufferToString = (e) => `X${x(e.toString("hex"))}`, e.arrayToList = (t, n) => {
		let r = t.length, i = "";
		for (let a = 0; a < r; a++) {
			a > 0 && (i += ", ");
			let r = t[a];
			Array.isArray(r) ? i += `(${(0, e.arrayToList)(r, n)})` : r instanceof Set ? i += `(${(0, e.arrayToList)(Array.from(r), n)})` : i += (0, e.escape)(r, !0, n);
		}
		return i;
	}, e.escape = (t, r, i) => {
		...
		switch (typeof t) {
			...
			case "object": return v(t) ? (0, e.dateToString)(t, i || "local") : y(t) ? (0, e.temporalToString)(t, i) : Array.isArray(t) ? (0, e.arrayToList)(t, i) : t instanceof Set ? (0, e.arrayToList)(Array.from(t), i) : n.Buffer.isBuffer(t) ? (0, e.bufferToString)(t) : t instanceof Uint8Array ? (0, e.bufferToString)(n.Buffer.from(t)) : b(t) ? String(t.toSqlString()) : r == null && (l(t) || t instanceof Map) ? (0, e.objectToValues)(t, i) : x(String(t));
			case "string": return x(t);
			default: return x(String(t));
		}
	}, e.format = (t, n, r, i) => {
		if (n == null) return t;
		let a = Array.isArray(n) ? n : [n], o = a.length, c = -2, u = -1, p = "", m = 0, y = 0, x = h(t, 0);
		for (; y < o && x !== -1;) {
			let n = x + 1, o;
			for (; t.charCodeAt(n) === 63;) n++;
			let S = n - x, C = a[y];
			if (S > 2) {
				x = h(t, n);
				continue;
			}
			if (S === 2) o = (0, e.escapeId)(C);
			else if (typeof C == "number" || typeof C == "bigint") o = `${C}`;
			else if (typeof C == "object" && C && !r) if (!(Array.isArray(C) || C instanceof Uint8Array || C instanceof Date || b(C) || v(C)) && (l(C) || C instanceof Map)) {
				let n = x - 1;
				for (; n >= m && d(t.charCodeAt(n));) n--;
				let r = n >= m ? f(t.charCodeAt(n)) : 0;
				if ((r < 97 || r > 122) && r !== s.comma) o = (0, e.escape)(C, !0, i);
				else {
					for (c === -2 && (c = _(t), u = c === -1 ? -1 : _(t, c)); u !== -1 && u <= x;) c = u, u = _(t, u);
					o = c !== -1 && c <= x && g(t, c, x) ? (0, e.objectToValues)(C, i) : (0, e.escape)(C, !0, i);
				}
			} else o = (0, e.escape)(C, !0, i);
			else o = (0, e.escape)(C, r, i);
			p += t.slice(m, x), p += o, m = n, y++, x = h(t, n);
		}
		return m === 0 ? t : m < t.length ? p + t.slice(m) : p;
	}, e.raw = (e) => {
		if (typeof e != "string") throw TypeError("argument sql must be a string");
		return { toSqlString: () => e };
	};
})), o = /* @__PURE__ */ i(((e) => {
	Object.defineProperty(e, "__esModule", { value: !0 }), e.createLRU = void 0, e.createLRU = (e) => {
		let { max: t } = e;
		if (!(Number.isInteger(t) && t > 0)) throw TypeError("`max` must be a positive integer");
		let n = 0, r = 0, i = 0, a = [], { onEviction: o } = e, s = /* @__PURE__ */ new Map(), c = Array(t).fill(void 0), l = Array(t).fill(void 0), u = Array(t).fill(0), d = Array(t).fill(0), f = (e) => {
			u[i] = e, d[e] = i, u[e] = 0, i = e;
		}, p = (e) => {
			if (e === i) return;
			let t = u[e], n = d[e];
			e === r ? r = t : u[n] = t, d[t] = n, f(e);
		}, m = (e) => {
			let t = i, f = Math.min(n, e), p = n - f, m = Array(f), h = Array(f);
			for (let e = 0; e < p; e++) {
				let e = c[r];
				o?.(e, l[r]), s.delete(e), r = u[r];
			}
			for (let e = f - 1; e >= 0; e--) m[e] = c[t], h[e] = l[t], s.set(c[t], e), t = d[t];
			r = 0, i = f - 1, n = f, c.length = e, l.length = e, u.length = e, d.length = e;
			for (let e = 0; e < f; e++) c[e] = m[e], l[e] = h[e], u[e] = e + 1, d[e] = e - 1;
			a = [];
			for (let t = f; t < e; t++) a.push(t);
		}, h = (e) => {
			c.length = e, l.length = e, u.length = e, d.length = e, c.fill(void 0, t), l.fill(void 0, t), u.fill(0, t), d.fill(0, t);
		};
		return {
			set(e, m) {
				if (e === void 0) return;
				...
				if (h === void 0) {
					if (n === t) {
						h = r;
						let e = c[h];
						o?.(e, l[h]), s.delete(e), r = u[h], d[r] = 0;
					} else h = a.length > 0 ? a.pop() : n, n++;
					s.set(e, h), c[h] = e, l[h] = m, n === 1 ? r = i = h : f(h);
				} else o?.(e, l[h]), l[h] = m, p(h);
			},
			get(e) {
				let t = s.get(e);
				if (t !== void 0) return t !== i && p(t), l[t];
			},
			peek: (e) => {
				let t = s.get(e);
				return t === void 0 ? void 0 : l[t];
			},
			has: (e) => s.has(e),
			*keys() {
				let e = i;
				for (let t = 0; t < n; t++) yield c[e], e = d[e];
			},
			*values() {
				let e = i;
				for (let t = 0; t < n; t++) yield l[e], e = d[e];
			},
			*entries() {
				let e = i;
				for (let t = 0; t < n; t++) yield [c[e], l[e]], e = d[e];
			},
			forEach: (e) => {
				let t = i;
				for (let r = 0; r < n; r++) {
			...
			delete(e) {
				...
				o?.(e, l[t]), s.delete(e), a.push(t), c[t] = void 0, l[t] = void 0;
				let f = d[t], p = u[t];
				return t === r ? r = p : u[f] = p, t === i ? i = f : d[p] = f, n--, !0;
			},
			evict: (e) => {
				let t = Math.min(e, n);
				for (; t > 0;) {
					let e = r, i = c[e];
					o?.(i, l[e]), s.delete(i), c[e] = void 0, l[e] = void 0, r = u[e], d[r] = 0, n--, a.push(e), t--;
				}
				n === 0 && (r = i = 0);
			},
			clear() {
				if (o) {
					let e = r;
					for (let t = 0; t < n; t++) o(c[e], l[e]), e = u[e];
				}
				s.clear(), c.fill(void 0), l.fill(void 0), a = [], n = 0, r = i = 0;
			},
			resize: (e) => {
				if (!(Number.isInteger(e) && e > 0)) throw TypeError("`max` must be a positive integer");
				e !== t && (e < t ? m(e) : h(e), t = e);
			},
			get max() {
				return t;
	...
	var { createLRU: n } = o(), r = n({ max: 15e3 });
	function i(e, t, n, r) {
		let i = [
			e,
			typeof n.nestTables,
			n.nestTables,
			!!n.rowsAsArray,
			!!(n.supportBigNumbers || r.supportBigNumbers),
			!!(n.bigNumberStrings || r.bigNumberStrings),
	...
	function a(e, t, n, a, o) {
		let s = i(e, t, n, a), c = r.get(s);
		return c || (c = o(t, n, a), r.set(s, c), c);
	}
	function s(e) {
		r.resize(e);
	}
	...
	function n(e, t) {
		var t = t || {};
		this._capacity = t.capacity, this._head = 0, this._tail = 0, Array.isArray(e) ? this._fromArray(e) : (this._capacityMask = 3, this._list = [
			,
			,
			,
			,
	...
	n.prototype.peekAt = function(e) {
		...
		if (t === (t | 0) && this._head !== this._tail) {
			var n = this.size(), r = this._list.length;
			if (!(t >= n || t < -n)) {
				t < 0 && (t += n), t = this._head + t & this._capacityMask;
				var i = this._list[t], a;
				if (e < n / 2) {
					for (a = e; a > 0; a--) this._list[t] = this._list[t = t - 1 + r & this._capacityMask];
					this._list[t] = void 0, this._head = this._head + 1 + r & this._capacityMask;
				} else {
					for (a = n - 1 - e; a > 0; a--) this._list[t] = this._list[t = t + 1 + r & this._capacityMask];
		...
		if (n === (n | 0) && this._head !== this._tail) {
			var a = this.size(), o = this._list.length;
			if (!(n >= a || n < -a || t < 1)) {
				if (n < 0 && (n += a), t === 1 || !t) return r = [,], r[0] = this.removeOne(n), r;
				if (n === 0 && n + t >= a) return r = this.toArray(), this.clear(), r;
				n + t > a && (t = a - n);
				var s;
				for (r = Array(t), s = 0; s < t; s++) r[s] = this._list[this._head + n + s & this._capacityMask];
				if (n = this._head + n & this._capacityMask, e + t === a) {
					for (this._tail = this._tail - t + o & this._capacityMask, s = t; s > 0; s--) this._list[n = n + 1 + o & this._capacityMask] = void 0;
					return r;
				}
				if (e === 0) {
					for (this._head = this._head + t + o & this._capacityMask, s = t - 1; s > 0; s--) this._list[n = n + 1 + o & this._capacityMask] = void 0;
					return r;
				}
				if (n < a / 2) {
					for (this._head = this._head + e + t + o & this._capacityMask, s = e; s > 0; s--) this.unshift(this._list[n = n - 1 + o & this._capacityMask]);
					for (n = this._head - 1 + o & this._capacityMask; i > 0;) this._list[n = n - 1 + o & this._capacityMask] = void 0, i--;
					e < 0 && (this._tail = n);
				} else {
					for (this._tail = n, n = n + t + o & this._capacityMask, s = a - (t + e); s > 0; s--) this.push(this._list[n++]);
					for (n = this._tail; i > 0;) this._list[n = n + 1 + o & this._capacityMask] = void 0, i--;
				}
				return this._head < 2 && this._tail > 1e4 && this._tail <= o >>> 2 && this._shrinkArray(), r;
			}
		}
		...
		if (n === (n | 0)) {
			var r = this.size();
			if (n < 0 && (n += r), !(n > r)) if (arguments.length > 2) {
				var i, a, o, s = arguments.length, c = this._list.length, l = 2;
				if (!r || n < r / 2) {
					for (a = Array(n), i = 0; i < n; i++) a[i] = this._list[this._head + i & this._capacityMask];
					for (t === 0 ? (o = [], n > 0 && (this._head = this._head + n + c & this._capacityMask)) : (o = this.remove(n, t), this._head = this._head + n + c & this._capacityMask); s > l;) this.unshift(arguments[--s]);
					for (i = n; i > 0; i--) this.unshift(a[i - 1]);
				} else {
					a = Array(r - (n + t));
					var u = a.length;
					for (i = 0; i < u; i++) a[i] = this._list[this._head + n + t + i & this._capacityMask];
					for (t === 0 ? (o = [], n != r && (this._tail = this._head + n + c & this._capacityMask)) : (o = this.remove(n, t), this._tail = this._tail - u + c & this._capacityMask); l < s;) this.push(arguments[l++]);
					for (i = 0; i < u; i++) this.push(a[i]);
				}
				return o;
			} else return this.remove(n, t);
		}
	}, n.prototype.clear = function() {
		this._list = Array(this._list.length), this._head = 0, this._tail = 0;
	}, n.prototype.isEmpty = function() {
		return this._head === this._tail;
	}, n.prototype.toArray = function() {
		return this._copyArray(!1);
	}, n.prototype._fromArray = function(e) {
		var t = e.length, n = this._nextPowerOf2(t);
		this._list = Array(n), this._capacityMask = n - 1, this._tail = t;
		for (var r = 0; r < t; r++) this._list[r] = e[r];
	}, n.prototype._copyArray = function(e, t) {
		var n = this._list, r = n.length, i = this.length;
		if (t |= i, t == i && this._head < this._tail) return this._list.slice(this._head, this._tail);
		var a = Array(t), o = 0, s;
		if (e || this._head > this._tail) {
			for (s = this._head; s < r; s++) a[o++] = n[s];
			for (s = 0; s < this._tail; s++) a[o++] = n[s];
		} else for (s = this._head; s < this._tail; s++) a[o++] = n[s];
		return a;
	...
	}, n.prototype._nextPowerOf2 = function(e) {
	...
	n.prototype.write = function(e) {
		return this.addBOM &&= (e = t + e, !1), this.encoder.write(e);
	...
	r.prototype.write = function(e) {
		...
		return this.pass || !n ? n : (n[0] === t && (n = n.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0, n);
	...
	function i(e, t) {
		this.enc = e.encodingName, this.bomAware = e.bomAware, this.enc === "base64" ? this.encoder = c : this.enc === "utf8" ? this.encoder = f : this.enc === "cesu8" && (this.enc = "utf8", this.encoder = l, r.from("eda0bdedb2a9", "hex").toString() !== "💩" && (this.decoder = u, this.defaultCharUnicode = t.defaultCharUnicode));
	}
	...
	u.prototype.write = function(e) {
		for (var t = this.acc, n = this.contBytes, r = this.accBytes, i = "", a = 0; a < e.length; a++) {
			var o = e[a];
			(o & 192) == 128 ? n > 0 ? (t = t << 6 | o & 63, n--, r++, n === 0 && (r === 2 && t < 128 && t > 0 || r === 3 && t < 2048 ? i += this.defaultCharUnicode : i += String.fromCharCode(t))) : i += this.defaultCharUnicode : (n > 0 && (i += this.defaultCharUnicode, n = 0), o < 128 ? i += String.fromCharCode(o) : o < 224 ? (t = o & 31, n = 1, r = 1) : o < 240 ? (t = o & 15, n = 2, r = 1) : i += this.defaultCharUnicode);
		}
	...
	r.prototype.write = function(e) {
		for (var n = t.from(e, "ucs2"), r = t.alloc(n.length * 2 + 4), i = this.isLE ? r.writeUInt32LE : r.writeUInt32BE, a = 0, o = 0; o < n.length; o += 2) {
			...
			if (this.highSurrogate) if (c || !l) i.call(r, this.highSurrogate, a), a += 4;
			else {
	...
	p.prototype.encoder = m, p.prototype.decoder = h, p.prototype.bomAware = !0;
	function m(e, n) {
	...
	m.prototype.write = function(e) {
		for (var n = this.inBase64, r = this.base64Accum, i = this.base64AccumIdx, a = t.alloc(e.length * 5 + 10), o = 0, s = 0; s < e.length; s++) {
			...
			c >= 32 && c <= 126 ? (n &&= (i > 0 && (o += a.write(r.slice(0, i).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), o), i = 0), a[o++] = u, !1), n || (a[o++] = c, c === f && (a[o++] = u))) : (n ||= (a[o++] = f, !0), n && (r[i++] = c >> 8, r[i++] = c & 255, i == r.length && (o += a.write(r.toString("base64").replace(/\//g, ","), o), i = 0)));
		}
	...
	var g = s.slice();
	g[44] = !0, h.prototype.write = function(e) {
		for (var n = "", r = 0, i = this.inBase64, a = this.base64Accum, o = 0; o < e.length; o++) if (!i) e[o] == f && (n += this.iconv.decode(e.slice(r, o), "ascii"), r = o + 1, i = !0);
		else if (!g[e[o]]) {
			if (o == r && e[o] == u) n += "&";
			else {
	...
	l.prototype.encoder = u, l.prototype.decoder = f, l.prototype._getDecodeTrieNode = function(e) {
		...
		for (var r = this.decodeTables[e], o = !1, s = {}, c = 0; c < 256; c++) {
			var l = r[c], u = t + c;
			if (!n[u]) if (l >= 0) this._setEncodeChar(l, u), o = !0;
			else if (l <= a) {
				var d = a - l;
				if (!s[d]) {
					var f = u << 8 >>> 0;
	...
	u.prototype.write = function(e) {
		for (var r = t.alloc(e.length * (this.gb18030 ? 4 : 3)), a = this.leadSurrogate, o = this.seqObj, c = -1, l = 0, u = 0;;) {
			...
			if (d >= 55296 && d < 57344) if (d < 56320) if (a === -1) {
				a = d;
				continue;
			} else a = d, d = n;
			...
			if (o !== void 0 && d != n) {
				...
				if (typeof m == "object") {
					o = m;
					continue;
				} else typeof m == "number" ? f = m : m ?? (m = o[s], m !== void 0 && (f = m, c = d));
				o = void 0;
			} else if (d >= 0) {
				var h = this.encodeTable[d >> 8];
				if (h !== void 0 && (f = h[d & 255]), f <= i) {
					o = this.encodeTableSeq[i - f];
					continue;
				}
				if (f == n && this.gb18030) {
					var g = p(this.gb18030.uChars, d);
					if (g != -1) {
						var f = this.gb18030.gbChars[g] + (d - this.gb18030.uChars[g]);
						r[u++] = 129 + Math.floor(f / 12600), f %= 12600, r[u++] = 48 + Math.floor(f / 1260), f %= 1260, r[u++] = 129 + Math.floor(f / 10), f %= 10, r[u++] = 48 + f;
						continue;
					}
				}
			}
			f === n && (f = this.defaultCharSingleByte), f < 256 ? r[u++] = f : f < 65536 ? (r[u++] = f >> 8, r[u++] = f & 255) : f < 16777216 ? (r[u++] = f >> 16, r[u++] = f >> 8 & 255, r[u++] = f & 255) : (r[u++] = f >>> 24, r[u++] = f >>> 16 & 255, r[u++] = f >>> 8 & 255, r[u++] = f & 255);
		}
	...
	f.prototype.write = function(e) {
		for (var o = t.alloc(e.length * 2), s = this.nodeIdx, c = this.prevBytes, l = this.prevBytes.length, u = -this.prevBytes.length, d, f = 0, m = 0; f < e.length; f++) {
			var h = f >= 0 ? e[f] : c[f + l], d = this.decodeTables[s][h];
			if (!(d >= 0)) if (d === n) d = this.defaultCharUnicode.charCodeAt(0), f = u;
			else if (d === r) {
				if (f >= 3) var g = (e[f - 3] - 129) * 12600 + (e[f - 2] - 48) * 1260 + (e[f - 1] - 129) * 10 + (h - 48);
				else var g = (c[f - 3 + l] - 129) * 12600 + ((f - 2 >= 0 ? e[f - 2] : c[f - 2 + l]) - 48) * 1260 + ((f - 1 >= 0 ? e[f - 1] : c[f - 1 + l]) - 129) * 10 + (h - 48);
				var _ = p(this.gb18030.gbChars, g);
	...
	n.exports = {
		...
		cp936: {
			type: "_dbcs",
			table: function() {
				return ne(), e(ee).default;
			}
		},
		gbk: {
			type: "_dbcs",
			table: function() {
				return (ne(), e(ee).default).concat((ae(), e(re).default));
			}
		},
		xgbk: "gbk",
		isoir58: "gbk",
		...
		big5hkscs: {
			type: "_dbcs",
			table: function() {
				return (he(), e(pe).default).concat((ve(), e(ge).default));
			},
			encodeSkipVals: [
				36457,
				36463,
	...
	var t = Se(), { createLRU: n } = o(), r = n({ max: 500 });
	e.decode = function(e, n, i, a, o) {
		if (Buffer.isEncoding(n)) return e.toString(n, i, a);
		let s;
		if (!o) s = r.get(n), s || (s = t.getDecoder(n), r.set(n, s));
		else {
			let e = {
				encoding: n,
				options: o
			}, i = JSON.stringify(e);
			s = r.get(i), s || (s = t.getDecoder(e.encoding, e.options), r.set(i, s));
		}
		let c = s.write(e.slice(i, a)), l = s.end();
		return l ? c + l : c;
	}, e.encode = function(e, n, r) {
		if (Buffer.isEncoding(n)) return Buffer.from(e, n);
		let i = t.getEncoder(n, r || {}), a = i.write(e), o = i.end();
		return o && o.length > 0 ? Buffer.concat([a, o]) : a;
	};
})), A = /* @__PURE__ */ i(((e, t) => {
	t.exports = {
		0: "DECIMAL",
		...
		254: "STRING",
		255: "GEOMETRY"
	}, t.exports.DECIMAL = 0, t.exports.TINY = 1, t.exports.SHORT = 2, t.exports.LONG = 3, t.exports.FLOAT = 4, t.exports.DOUBLE = 5, t.exports.NULL = 6, t.exports.TIMESTAMP = 7, t.exports.LONGLONG = 8, t.exports.INT24 = 9, t.exports.DATE = 10, t.exports.TIME = 11, t.exports.DATETIME = 12, t.exports.YEAR = 13, t.exports.NEWDATE = 14, t.exports.VARCHAR = 15, t.exports.BIT = 16, t.exports.VECTOR = 242, t.exports.JSON = 245, t.exports.NEWDECIMAL = 246, t.exports.ENUM = 247, t.exports.SET = 248, t.exports.TINY_BLOB = 249, t.exports.MEDIUM_BLOB = 250, t.exports.LONG_BLOB = 251, t.exports.BLOB = 252, t.exports.VAR_STRING = 253, t.exports.STRING = 254, t.exports.GEOMETRY = 255;
})), j = /* @__PURE__ */ i(((e, n) => {
	var r = l(), i = t("buffer").Buffer, a = u(), o = k(), s = A(), c = /* @__PURE__ */ new Date(NaN), d = "000000000000";
	function f(e, t) {
		let n = t.toString();
		return n.length >= e ? n : (d + n).slice(-e);
	}
	var p = 45, m = 43, h = (() => {
		let e = !1;
		return JSON.parse("0", (t, n, r) => (e = r !== void 0 && typeof r.source == "string", n)), e;
	})(), g = /\d{16}/, _ = /^-?\d+$/;
	function v(e, t, n) {
		return typeof t == "number" && !Number.isSafeInteger(t) && n !== void 0 && _.test(n.source) ? n.source : t;
	}
	var y = 46, b = 101, x = 69;
	n.exports = class e {
		constructor(e, t, n, r) {
			this.sequenceId = e, this.numPackets = 1, this.buffer = t, this.start = n, this.offset = n + 4, this.end = r;
		}
		reset() {
		...
		readInt64JSNumber() {
			return new a(this.readInt32(), this.readInt32(), !0).toNumber();
		}
		readSInt64JSNumber() {
			let e = this.readInt32(), t = this.readInt32();
			return t & 2147483648 ? new a(e, t, !1).toNumber() : e + 4294967296 * t;
		}
		readInt64String() {
			return new a(this.readInt32(), this.readInt32(), !0).toString();
		}
		readSInt64String() {
			return new a(this.readInt32(), this.readInt32(), !1).toString();
		}
		readInt64() {
			let e = new a(this.readInt32(), this.readInt32(), !0), t = e.toNumber();
			return Number.isSafeInteger(t) ? t : e.toString();
		}
		readSInt64() {
			let e = new a(this.readInt32(), this.readInt32(), !1), t = e.toNumber();
			return Number.isSafeInteger(t) ? t : e.toString();
		}
		isEOF() {
		...
		readLengthCodedNumber(e, t) {
			let n = this.buffer[this.offset++];
			return n < 251 ? n : this.readLengthCodedNumberExt(n, e, t);
		}
		readLengthCodedNumberSigned(e) {
			return this.readLengthCodedNumber(e, !0);
		}
		readLengthCodedNumberExt(e, t, n) {
			let r, i, o;
			if (e === 251) return null;
			if (e === 252) return this.readInt8() + (this.readInt8() << 8);
			if (e === 253) return this.readInt8() + (this.readInt8() << 8) + (this.readInt8() << 16);
			if (e === 254) {
				if (r = this.readInt32(), i = this.readInt32(), i === 0) return r;
				if (i < 2097152) return i * 4294967296 + r;
				o = new a(r, i, !n);
				let e = o.toNumber(), s = o.toString();
				return t || !Number.isSafeInteger(e) ? s : e;
			}
			throw console.trace(), Error(`Should not reach here: ${e}`);
		}
		readFloat() {
			let e = this.buffer.readFloatLE(this.offset);
			return this.offset += 4, e;
		}
		readDouble() {
			let e = this.buffer.readDoubleLE(this.offset);
			return this.offset += 8, e;
		}
		readBuffer(e) {
			return e === void 0 && (e = this.end - this.offset), this.offset += e, this.buffer.slice(this.offset - e, this.offset);
		}
		readDateTime(e) {
			if (!e || e === "Z" || e === "local") {
				let t = this.readInt8();
				if (t === 251) return null;
				let n = 0, r = 0, i = 0, a = 0, o = 0, s = 0, l = 0;
				return t > 3 && (n = this.readInt16(), r = this.readInt8(), i = this.readInt8()), t > 6 && (a = this.readInt8(), o = this.readInt8(), s = this.readInt8()), t > 10 && (l = this.readInt32() / 1e3), n + r + i + a + o + s + l === 0 ? c : e === "Z" ? new Date(Date.UTC(n, r - 1, i, a, o, s, l)) : new Date(n, r - 1, i, a, o, s, l);
			}
			let t = this.readDateTimeString(6, "T", null);
			return t ? (t.length === 10 && (t += "T00:00:00"), new Date(t + e)) : c;
		}
		readDateTimeString(e, t, n) {
			let r = this.readInt8(), i = 0, a = 0, o = 0, c = 0, l = 0, u = 0, d = 0, p;
			return r > 3 && (i = this.readInt16(), a = this.readInt8(), o = this.readInt8(), p = [
				f(4, i),
				f(2, a),
				f(2, o)
			].join("-")), r > 6 ? (c = this.readInt8(), l = this.readInt8(), u = this.readInt8(), p += `${t || " "}${[
				f(2, c),
				f(2, l),
				f(2, u)
			].join(":")}`) : (n === s.DATETIME || n === s.TIMESTAMP) && (p += " 00:00:00"), r > 10 && (d = this.readInt32(), p += ".", e && (d = f(6, d), d.length > e && (d = d.substring(0, e))), p += d), p;
		}
		readTimeString(e) {
			let t = this.readInt8();
			if (t === 0) return "00:00:00";
			let n = this.readInt8() ? -1 : 1, r = 0, i = 0, a = 0, o = 0, s = 0;
			return t > 6 && (r = this.readInt32(), i = this.readInt8(), a = this.readInt8(), o = this.readInt8()), t > 10 && (s = this.readInt32()), e ? (i += r * 24, a += i * 60, o += a * 60, s += o * 1e3, s *= n, s) : (n === -1 ? "-" : "") + [
				f(2, r * 24 + i),
				f(2, a),
				f(2, o)
			].join(":") + (s ? `.${s}`.replace(/0+$/, "") : "");
		}
		readLengthCodedString(e) {
			let t = this.readLengthCodedNumber();
			return t === null ? null : (this.offset += t, o.decode(this.buffer, e, this.offset - t, this.offset));
		}
		readLengthCodedBuffer() {
			let e = this.readLengthCodedNumber();
			return e === null ? null : this.readBuffer(e);
		}
		readNullTerminatedString(e) {
			let t = this.offset, n = this.offset;
			for (; n < this.end && this.buffer[n] !== 0;) n += 1;
			return this.offset = n + 1, o.decode(this.buffer, e, t, n);
		}
		readString(e, t) {
			return typeof e == "string" && t === void 0 && (t = e, e = void 0), e === void 0 && (e = this.end - this.offset), this.offset += e, o.decode(this.buffer, t, this.offset - e, this.offset);
		}
		parseInt(e, t) {
			if (e === null) return null;
			if (e >= 14 && !t) {
				let t = this.buffer.toString("ascii", this.offset, this.offset + e);
				return this.offset += e, Number(t);
			}
			let n = 0, r = this.offset, i = this.offset + e, a = 1;
			if (e === 0) return 0;
			this.buffer[this.offset] === p && (this.offset++, a = -1);
			let o, s = i - this.offset;
			if (t) {
				if (s >= 15) return o = this.readString(i - this.offset, "binary"), n = parseInt(o, 10), Number.isSafeInteger(a * n) ? a * n : a === -1 ? `-${o}` : o;
				if (s > 16) return o = this.readString(i - this.offset), a === -1 ? `-${o}` : o;
			}
			for (this.buffer[this.offset] === m && this.offset++; this.offset < i;) n *= 10, n += this.buffer[this.offset] - 48, this.offset++;
			let c = n * a;
			return !t || Number.isSafeInteger(c) ? c : this.buffer.toString("ascii", r, i);
		}
		parseIntNoBigCheck(e) {
			if (e === null) return null;
			let t = 0, n = this.offset + e, r = 1;
			if (e === 0) return 0;
			for (this.buffer[this.offset] === p && (this.offset++, r = -1), this.buffer[this.offset] === m && this.offset++; this.offset < n;) t *= 10, t += this.buffer[this.offset] - 48, this.offset++;
			return t * r;
		}
		parseGeometryValue() {
			let e = this.readLengthCodedBuffer(), t = 4;
			if (e === null || !e.length) return null;
			let n = e.length;
			function r() {
				let i, a, o, s, c, l, u, d, f = null;
				if (t + 5 > n) return null;
				let p = e.readUInt8(t);
				t += 1;
				let m = p ? e.readUInt32LE(t) : e.readUInt32BE(t);
				switch (t += 4, m) {
					case 1:
						if (t + 16 > n) return null;
						i = p ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, a = p ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, f = {
							x: i,
							y: a
						};
						break;
					case 2:
						if (t + 4 > n || (c = p ? e.readUInt32LE(t) : e.readUInt32BE(t), t += 4, c > (n - t) / 16)) return null;
						for (f = [], o = c; o > 0 && !(t + 16 > n); o--) i = p ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, a = p ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, f.push({
							x: i,
							y: a
						});
						break;
					case 3:
						if (t + 4 > n || (l = p ? e.readUInt32LE(t) : e.readUInt32BE(t), t += 4, l > (n - t) / 4)) return null;
						for (f = [], o = l; o > 0 && !(t + 4 > n); o--) {
							for (c = p ? e.readUInt32LE(t) : e.readUInt32BE(t), t += 4, d = [], s = c; s > 0 && !(t + 16 > n); s--) i = p ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, a = p ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, d.push({
								x: i,
								y: a
							});
							f.push(d);
					...
					case 6:
					case 7:
						if (t + 4 > n || (u = p ? e.readUInt32LE(t) : e.readUInt32BE(t), t += 4, u > (n - t) / 9)) return null;
						for (f = [], o = u; o > 0; o--) f.push(r());
						break;
				}
				return f;
			}
		...
		parseVector() {
			let e = this.readLengthCodedNumber(), t = this.offset + e, n = [];
			for (; this.offset < t && this.offset < this.end;) n.push(this.readFloat());
			return n;
		}
		parseJson(e, t) {
			let n = this.readLengthCodedString(e);
			return t && h && n !== null && g.test(n) ? JSON.parse(n, v) : JSON.parse(n);
		}
		parseDate(e) {
			let t = this.readLengthCodedNumber();
			if (t === null) return null;
			if (t !== 10) return /* @__PURE__ */ new Date(NaN);
			let n = this.parseInt(4);
			this.offset++;
			let r = this.parseInt(2);
			this.offset++;
			let i = this.parseInt(2);
			return !e || e === "local" ? new Date(n, r - 1, i) : e === "Z" ? new Date(Date.UTC(n, r - 1, i)) : /* @__PURE__ */ new Date(`${f(4, n)}-${f(2, r)}-${f(2, i)}T00:00:00${e}`);
		}
		parseDateTime(e) {
			let t = this.readLengthCodedString("binary");
			return t === null ? null : !e || e === "local" ? new Date(t) : /* @__PURE__ */ new Date(`${t}${e}`);
		}
		parseFloat(e) {
			if (e === null) return null;
			if (e === 0) return 0;
			if (e > 17) {
				let t = this.buffer.toString("utf8", this.offset, this.offset + e);
				return this.offset += e, Number.parseFloat(t);
			}
			let t = 0, n = this.offset + e, r = 1, i = !1, a = 0;
			for (this.buffer[this.offset] === p && (this.offset++, r = -1), this.buffer[this.offset] === m && this.offset++; this.offset < n;) if (a = this.buffer[this.offset], a === y) i = !0, this.offset++;
			else if (a === b || a === x) {
				let t = n - e, r = this.buffer.toString("utf8", t, n);
				return this.offset = n, Number.parseFloat(r);
			} else t *= 10, t += this.buffer[this.offset] - 48, this.offset++, i && (r *= 10);
			return t / r;
		}
		parseLengthCodedIntNoBigCheck() {
			return this.parseIntNoBigCheck(this.readLengthCodedNumber());
		}
		parseLengthCodedInt(e) {
			return this.parseInt(this.readLengthCodedNumber(), e);
		}
		...
		asError(e) {
			...
			let t = this.readInt16(), n = "";
			this.buffer[this.offset] === 35 && (this.skip(1), n = this.readBuffer(5).toString());
			let i = this.readString(void 0, e), a = Error(i);
			return a.code = r[t], a.errno = t, a.sqlState = n, a.sqlMessage = i, a;
		}
		writeInt32(e) {
			this.buffer.writeUInt32LE(e, this.offset), this.offset += 4;
		}
		writeInt24(e) {
			this.writeInt8(e & 255), this.writeInt16(e >> 8);
		}
		writeInt16(e) {
			this.buffer.writeUInt16LE(e, this.offset), this.offset += 2;
		}
		writeInt8(e) {
			this.buffer.writeUInt8(e, this.offset), this.offset++;
		}
		writeDouble(e) {
			this.buffer.writeDoubleLE(e, this.offset), this.offset += 8;
		}
		writeBuffer(e) {
			e.copy(this.buffer, this.offset), this.offset += e.length;
		}
		writeNull() {
			this.buffer[this.offset] = 251, this.offset++;
		}
		writeNullTerminatedString(e, t) {
			let n = o.encode(e, t);
			this.buffer.length && n.copy(this.buffer, this.offset), this.offset += n.length, this.writeInt8(0);
		}
		writeString(e, t) {
			if (e === null) {
				this.writeInt8(251);
			...
			if (e.length === 0) return;
			let n = o.encode(e, t);
			this.buffer.length && n.copy(this.buffer, this.offset), this.offset += n.length;
		}
		writeLengthCodedString(e, t) {
			let n = o.encode(e, t);
			this.writeLengthCodedNumber(n.length), this.buffer.length && n.copy(this.buffer, this.offset), this.offset += n.length;
		}
		writeLengthCodedBuffer(e) {
			this.writeLengthCodedNumber(e.length), e.copy(this.buffer, this.offset), this.offset += e.length;
		}
		writeLengthCodedNumber(e) {
			return e < 251 ? this.writeInt8(e) : e < 65535 ? (this.writeInt8(252), this.writeInt16(e)) : e < 16777215 ? (this.writeInt8(253), this.writeInt24(e)) : e === null ? this.writeInt8(251) : (this.writeInt8(254), this.buffer.writeUInt32LE(e >>> 0, this.offset), this.offset += 4, this.buffer.writeUInt32LE(Math.floor(e / 4294967296), this.offset), this.offset += 4, this.offset);
		}
		writeDate(e, t) {
			if (this.buffer.writeUInt8(11, this.offset), !t || t === "local") this.buffer.writeUInt16LE(e.getFullYear(), this.offset + 1), this.buffer.writeUInt8(e.getMonth() + 1, this.offset + 3), this.buffer.writeUInt8(e.getDate(), this.offset + 4), this.buffer.writeUInt8(e.getHours(), this.offset + 5), this.buffer.writeUInt8(e.getMinutes(), this.offset + 6), this.buffer.writeUInt8(e.getSeconds(), this.offset + 7), this.buffer.writeUInt32LE(e.getMilliseconds() * 1e3, this.offset + 8);
			else {
				if (t !== "Z") {
					let n = (t[0] === "-" ? -1 : 1) * (parseInt(t.substring(1, 3), 10) * 60 + parseInt(t.substring(4), 10));
					n !== 0 && (e = new Date(e.getTime() + 6e4 * n));
				}
				this.buffer.writeUInt16LE(e.getUTCFullYear(), this.offset + 1), this.buffer.writeUInt8(e.getUTCMonth() + 1, this.offset + 3), this.buffer.writeUInt8(e.getUTCDate(), this.offset + 4), this.buffer.writeUInt8(e.getUTCHours(), this.offset + 5), this.buffer.writeUInt8(e.getUTCMinutes(), this.offset + 6), this.buffer.writeUInt8(e.getUTCSeconds(), this.offset + 7), this.buffer.writeUInt32LE(e.getUTCMilliseconds() * 1e3, this.offset + 8);
			}
			this.offset += 12;
		}
		writeHeader(e) {
			let t = this.offset;
			this.offset = 0, this.writeInt24(this.buffer.length - 4), this.writeInt8(e), this.offset = t;
		}
		clone() {
			return new e(this.sequenceId, this.buffer, this.start, this.end);
		}
		type() {
			return this.isEOF() ? "EOF" : this.isError() ? "Error" : this.buffer[this.offset] === 0 ? "maybeOK" : "";
		}
		static lengthCodedNumberLength(e) {
			return e < 251 ? 1 : e < 65535 ? 3 : e < 16777215 ? 5 : 9;
		}
		static lengthCodedStringLength(t, n) {
			let r = o.encode(t, n).length;
			return e.lengthCodedNumberLength(r) + r;
		}
		static MockBuffer() {
			let e = function() {}, t = Buffer.alloc(0);
			for (let n in i.prototype) typeof t[n] == "function" && (t[n] = e);
			return t;
		}
	};
})), Ce = /* @__PURE__ */ i(((e, t) => {
	var n = j(), r = 16777215;
	function i(e, t) {
		let n = e[t], r = e[t + 1], i = e[t + 2];
		return r + i === 0 ? n : n + (r << 8) + (i << 16);
	}
	t.exports = class e {
		constructor(t, n) {
			n === void 0 && (n = 4), this.buffer = [], this.bufferLength = 0, this.packetHeaderLength = n, this.headerLen = 0, this.length = 0, this.largePacketParts = [], this.firstPacketSequenceId = 0, this.onPacket = t, this.execute = e.prototype.executeStart, this._flushLargePacket = n === 7 ? this._flushLargePacket7 : this._flushLargePacket4;
		}
		_flushLargePacket4() {
			let e = this.largePacketParts.length;
			...
			let t = Buffer.concat(this.largePacketParts), r = new n(this.firstPacketSequenceId, t, 0, t.length);
			this.largePacketParts.length = 0, r.numPackets = e, this.onPacket(r);
		}
		_flushLargePacket7() {
			let e = this.largePacketParts.length;
			this.largePacketParts.unshift(Buffer.from([
			...
			let t = Buffer.concat(this.largePacketParts);
			this.largePacketParts.length = 0;
			let r = new n(this.firstPacketSequenceId, t, 0, t.length);
			r.numPackets = e, this.onPacket(r);
		}
		executeStart(t) {
			let a = 0, o = t.length;
			for (; o - a >= 3;) if (this.length = i(t, a), o - a >= this.length + this.packetHeaderLength) {
				let e = t[a + 3];
				this.length < r && this.largePacketParts.length === 0 ? this.onPacket(new n(e, t, a, a + this.packetHeaderLength + this.length)) : (this.largePacketParts.length === 0 && (this.firstPacketSequenceId = e), this.largePacketParts.push(t.slice(a + this.packetHeaderLength, a + this.packetHeaderLength + this.length)), this.length < r && this._flushLargePacket()), a += this.packetHeaderLength + this.length;
			} else {
				this.buffer = [t.slice(a + 3, o)], this.bufferLength = o - a - 3, this.execute = e.prototype.executePayload;
				return;
			}
			o - a > 0 && (this.headerLen = o - a, this.length = t[a], this.headerLen === 2 ? (this.length = t[a] + (t[a + 1] << 8), this.execute = e.prototype.executeHeader3) : this.execute = e.prototype.executeHeader2);
		}
		executePayload(t) {
			let i = 0, a = t.length, o = this.length - this.bufferLength + this.packetHeaderLength - 3;
			if (a - i >= o) {
				let s = Buffer.allocUnsafe(this.length + this.packetHeaderLength), c = 3;
				for (let e = 0; e < this.buffer.length; ++e) this.buffer[e].copy(s, c), c += this.buffer[e].length;
				t.copy(s, c, i, i + o);
				let l = s[3];
				if (this.length < r && this.largePacketParts.length === 0 ? this.onPacket(new n(l, s, 0, this.length + this.packetHeaderLength)) : (this.largePacketParts.length === 0 && (this.firstPacketSequenceId = l), this.largePacketParts.push(s.slice(this.packetHeaderLength, this.packetHeaderLength + this.length)), this.length < r && this._flushLargePacket()), this.buffer = [], this.bufferLength = 0, this.execute = e.prototype.executeStart, i += o, a - i > 0) return this.execute(t.slice(i, a));
			} else this.buffer.push(t), this.bufferLength += t.length;
			return null;
		}
		executeHeader2(t) {
			return this.length += t[0] << 8, t.length > 1 ? (this.length += t[1] << 16, this.execute = e.prototype.executePayload, this.executePayload(t.slice(2))) : (this.execute = e.prototype.executeHeader3, null);
		}
		executeHeader3(t) {
			return this.length += t[0] << 16, this.execute = e.prototype.executePayload, this.executePayload(t.slice(1));
		}
	};
})), we = /* @__PURE__ */ i(((e, t) => {
	var n = j();
	t.exports = class e {
		constructor(e) {
			this.pluginName = e.pluginName, this.pluginData = e.pluginData;
		}
		toPacket(e) {
			let t = 6 + this.pluginName.length + this.pluginData.length, r = new n(0, Buffer.allocUnsafe(t), 0, t);
			return r.offset = 4, r.writeInt8(2), r.writeNullTerminatedString(this.pluginName, e), r.writeBuffer(this.pluginData), r;
		}
		static fromPacket(t, n) {
			return t.readInt8(), new e({
				pluginName: t.readNullTerminatedString(n),
				pluginData: t.readBuffer()
			});
		}
	};
})), Te = /* @__PURE__ */ i(((e, t) => {
	...
	t.exports = class e {
		...
		toPacket() {
			let e = 6 + this.pluginName.length + this.pluginData.length, t = new n(0, Buffer.allocUnsafe(e), 0, e);
			return t.offset = 4, t.writeInt8(254), t.writeNullTerminatedString(this.pluginName, "cesu8"), t.writeBuffer(this.pluginData), t;
		}
		static fromPacket(t) {
			return t.readInt8(), new e({
				pluginName: t.readNullTerminatedString("cesu8"),
				pluginData: t.readBuffer()
			});
		}
	};
	...
	t.exports = class e {
		...
		toPacket() {
			let e = 5 + this.data.length, t = new n(0, Buffer.allocUnsafe(e), 0, e);
			return t.offset = 4, t.writeInt8(1), t.writeBuffer(this.data), t;
		}
		static fromPacket(t) {
			return t.readInt8(), new e(t.readBuffer());
		}
		static verifyMarker(e) {
			return e.peekByte() === 1;
		}
	};
})), De = /* @__PURE__ */ i(((e, t) => {
	...
	t.exports = class e {
		constructor(e) {
			Buffer.isBuffer(e) || (e = Buffer.from(e)), this.data = e;
		}
		toPacket() {
			let e = 4 + this.data.length, t = new n(0, Buffer.allocUnsafe(e), 0, e);
			return t.offset = 4, t.writeBuffer(this.data), t;
		}
		static fromPacket(t) {
			return new e(t.readBuffer());
		}
	};
})), Oe = /* @__PURE__ */ i(((e, t) => {
	var n = A(), r = j(), i = Array(256), a = class e {
		constructor(e) {
			this.columns = e || [];
		}
		static toPacket(e, t) {
			...
			e.forEach((e) => {
				...
				i += r.lengthCodedStringLength(e.toString(10), t);
			}), i += 2;
			let a = new r(0, Buffer.allocUnsafe(i + 4), 0, i + 4);
			a.offset = 4, a.writeInt8(0);
			let o = 0, s = 1;
			return e.forEach((e) => {
				e.type === n.NULL && (o += s), s *= 2, s === 256 && (a.writeInt8(o), o = 0, s = 1);
			}), s !== 1 && a.writeInt8(o), e.forEach((e) => {
				if (e === null) {
					a.writeNull();
					return;
				}
				...
				a.writeLengthCodedString(e.toString(10), t);
			}), a;
		}
		static fromPacket(t, n) {
			let r = Array(t.length);
			n.readInt8();
			let a = Math.floor((t.length + 7 + 2) / 8);
			n.skip(a);
			for (let e = 0; e < r.length; ++e) r[e] = i[t[e].columnType].apply(n);
			return new e(r);
		}
	};
	i[n.DECIMAL] = r.prototype.readLengthCodedString, i[1] = r.prototype.readInt8, i[2] = r.prototype.readInt16, i[3] = r.prototype.readInt32, i[4] = r.prototype.readFloat, i[5] = r.prototype.readDouble, i[6] = r.prototype.assertInvalid, i[7] = r.prototype.readTimestamp, i[8] = r.prototype.readInt64, i[9] = r.prototype.readInt32, i[10] = r.prototype.readTimestamp, i[11] = r.prototype.readTime, i[12] = r.prototype.readDateTime, i[13] = r.prototype.readInt16, i[n.VAR_STRING] = r.prototype.readLengthCodedString, t.exports = a;
})), M = /* @__PURE__ */ i(((e, t) => {
	t.exports = {
		SLEEP: 0,
		QUIT: 1,
	...
	t.exports = class {
		constructor(e) {
			this.binlogPos = e.binlogPos || 0, this.serverId = e.serverId || 0, this.flags = e.flags || 0, this.filename = e.filename || "";
		}
		toPacket() {
			let e = 15 + Buffer.byteLength(this.filename, "utf8"), t = new n(0, Buffer.allocUnsafe(e), 0, e);
			return t.offset = 4, t.writeInt8(r.BINLOG_DUMP), t.writeInt32(this.binlogPos), t.writeInt16(this.flags), t.writeInt32(this.serverId), t.writeString(this.filename), t;
		}
	};
})), N = /* @__PURE__ */ i(((e) => {
	e.LONG_PASSWORD = 1, e.FOUND_ROWS = 2, e.LONG_FLAG = 4, e.CONNECT_WITH_DB = 8, e.NO_SCHEMA = 16, e.COMPRESS = 32, e.ODBC = 64, e.LOCAL_FILES = 128, e.IGNORE_SPACE = 256, e.PROTOCOL_41 = 512, e.INTERACTIVE = 1024, e.SSL = 2048, e.IGNORE_SIGPIPE = 4096, e.TRANSACTIONS = 8192, e.RESERVED = 16384, e.SECURE_CONNECTION = 32768, e.MULTI_STATEMENTS = 65536, e.MULTI_RESULTS = 131072, e.PS_MULTI_RESULTS = 262144, e.PLUGIN_AUTH = 524288, e.CONNECT_ATTRS = 1048576, e.PLUGIN_AUTH_LENENC_CLIENT_DATA = 2097152, e.CAN_HANDLE_EXPIRED_PASSWORDS = 4194304, e.SESSION_TRACK = 8388608, e.CLIENT_QUERY_ATTRIBUTES = 134217728, e.SSL_VERIFY_SERVER_CERT = 1073741824, e.REMEMBER_OPTIONS = 2147483648, e.MULTI_FACTOR_AUTHENTICATION = 268435456;
})), P = /* @__PURE__ */ i(((e) => {
	var n = t("crypto");
	function r(e, t, r) {
		let i = n.createHash("sha1");
		return i.update(e), t && i.update(t), r && i.update(r), i.digest();
	}
	function i(e, t) {
		let n = Buffer.allocUnsafe(e.length);
	...
	function a(t, n, i) {
		...
		let a = r(t);
		return e.calculateTokenFromPasswordSha(a, n, i);
	}
	e.calculateTokenFromPasswordSha = function(e, t, n) {
		return i(r(t.slice(0, 8), n.slice(0, 12), r(e)), e);
	}, e.calculateToken = a, e.verifyToken = function(e, t, n, a) {
		return r(i(n, r(e, t, a))).compare(a) === 0;
	}, e.doubleSha1 = function(e) {
		return r(r(e));
	};
	function o(e, t) {
		let n = Buffer.allocUnsafe(e.length), r = t.length;
		for (let i = 0; i < e.length; i++) n[i] = e[i] ^ t[i % r];
		return n;
	}
	e.xorRotating = o;
})), F = /* @__PURE__ */ i(((e, t) => {
	var n = /* @__PURE__ */ "utf8.big5.latin2.dec8.cp850.latin1.hp8.koi8r.latin1.latin2.swe7.ascii.eucjp.sjis.cp1251.latin1.hebrew.utf8.tis620.euckr.latin7.latin2.koi8u.cp1251.gb2312.greek.cp1250.latin2.gbk.cp1257.latin5.latin1.armscii8.cesu8.cp1250.ucs2.cp866.keybcs2.macintosh.macroman.cp852.latin7.latin7.macintosh.cp1250.utf8.utf8.latin1.latin1.latin1.cp1251.cp1251.cp1251.macroman.utf16.utf16.utf16-le.cp1256.cp1257.cp1257.utf32.utf32.utf16-le.binary.armscii8.ascii.cp1250.cp1256.cp866.dec8.greek.hebrew.hp8.keybcs2.koi8r.koi8u.cesu8.latin2.latin5.latin7.cp850.cp852.swe7.cesu8.big5.euckr.gb2312.gbk.sjis.tis620.ucs2.eucjp.geostd8.geostd8.latin1.cp932.cp932.eucjpms.eucjpms.cp1250.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf8.utf8.utf8.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.utf8.utf8.utf8.utf8.utf8.utf8.utf8.ucs2.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.cesu8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.gb18030.gb18030.gb18030.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8".split("."), r = n.length;
	for (let e = 1025; e < 1024 + r; e++) n[e] = n[e - 1024];
	for (let [e, t] of [
		[2048, "cesu8"],
		[2304, "utf8"],
		[2560, "ucs2"],
		[2816, "utf16"],
		[3072, "utf32"]
	]) for (let r = e; r < e + 256; r++) n[r] = t;
	t.exports = n;
})), Ae = /* @__PURE__ */ i(((e, t) => {
	var n = M(), r = N(), i = j(), a = P(), o = F();
	t.exports = class {
		constructor(e) {
			this.flags = e.flags, this.user = e.user || "", this.database = e.database || "", this.password = e.password || "", this.passwordSha1 = e.passwordSha1, this.authPluginData1 = e.authPluginData1, this.authPluginData2 = e.authPluginData2, this.connectAttributes = e.connectAttrinutes || {};
			let t;
			t = this.passwordSha1 ? a.calculateTokenFromPasswordSha(this.passwordSha1, this.authPluginData1, this.authPluginData2) : a.calculateToken(this.password, this.authPluginData1, this.authPluginData2), this.authToken = t, this.charsetNumber = e.charsetNumber;
		}
		serializeToBuffer(e) {
			let t = (e) => this.flags & r[e], a = new i(0, e, 0, e.length);
			a.offset = 4;
			let s = o[this.charsetNumber];
			if (a.writeInt8(n.CHANGE_USER), a.writeNullTerminatedString(this.user, s), t("SECURE_CONNECTION") ? (a.writeInt8(this.authToken.length), a.writeBuffer(this.authToken)) : (a.writeBuffer(this.authToken), a.writeInt8(0)), a.writeNullTerminatedString(this.database, s), a.writeInt16(this.charsetNumber), t("PLUGIN_AUTH") && a.writeNullTerminatedString("mysql_native_password", "latin1"), t("CONNECT_ATTRS")) {
				let e = this.connectAttributes, t = Object.keys(e), n = 0;
				for (let r = 0; r < t.length; ++r) n += i.lengthCodedStringLength(t[r], s), n += i.lengthCodedStringLength(e[t[r]], s);
				a.writeLengthCodedNumber(n);
				for (let n = 0; n < t.length; ++n) a.writeLengthCodedString(t[n], s), a.writeLengthCodedString(e[t[n]], s);
			}
			return a;
		}
		toPacket() {
			if (typeof this.user != "string") throw Error("\"user\" connection config property must be a string");
			if (typeof this.database != "string") throw Error("\"database\" connection config property must be a string");
			let e = this.serializeToBuffer(i.MockBuffer());
			return this.serializeToBuffer(Buffer.allocUnsafe(e.offset));
		}
	};
})), je = /* @__PURE__ */ i(((e, t) => {
	var n = j(), r = M();
	t.exports = class {
		...
		toPacket() {
			let e = new n(0, Buffer.allocUnsafe(9), 0, 9);
			return e.offset = 4, e.writeInt8(r.STMT_CLOSE), e.writeInt32(this.id), e;
		}
	};
})), Me = /* @__PURE__ */ i(((e) => {
	e.NOT_NULL = 1, e.PRI_KEY = 2, e.UNIQUE_KEY = 4, e.MULTIPLE_KEY = 8, e.BLOB = 16, e.UNSIGNED = 32, e.ZEROFILL = 64, e.BINARY = 128, e.ENUM = 256, e.AUTO_INCREMENT = 512, e.TIMESTAMP = 1024, e.SET = 2048, e.NO_DEFAULT_VALUE = 4096, e.ON_UPDATE_NOW = 8192, e.NUM = 32768;
})), Ne = /* @__PURE__ */ i(((e, t) => {
	var n = j(), r = k(), i = F(), a = [
		"catalog",
		"schema",
		...
		constructor(e, t, n) {
			this._buf = e.buffer, this._clientEncoding = t, this._catalogLength = e.readLengthCodedNumber(), this._catalogStart = e.offset, e.offset += this._catalogLength, this._schemaLength = e.readLengthCodedNumber(), this._schemaStart = e.offset, e.offset += this._schemaLength, this._tableLength = e.readLengthCodedNumber(), this._tableStart = e.offset, e.offset += this._tableLength, this._orgTableLength = e.readLengthCodedNumber(), this._orgTableStart = e.offset, e.offset += this._orgTableLength;
			let a = e.readLengthCodedNumber(), o = e.offset;
			e.offset += a, this._orgNameLength = e.readLengthCodedNumber(), this._orgNameStart = e.offset, e.offset += this._orgNameLength, n && this._parseMariadbExtendedMetadata(e), e.skip(1), this.characterSet = e.readInt16(), this.encoding = i[this.characterSet], this.name = r.decode(this._buf, this.encoding === "binary" ? this._clientEncoding : this.encoding, o, o + a), this.columnLength = e.readInt32(), this.columnType = e.readInt8(), this.type = this.columnType, this.flags = e.readInt16(), this.decimals = e.readInt8();
		}
		_parseMariadbExtendedMetadata(e) {
			let t = e.readLengthCodedNumber() || 0, n = Math.min(e.offset + t, e.end);
			for (; e.offset < n;) {
				let t = e.readInt8(), n = e.readLengthCodedString("ascii");
				t === 0 ? this.extendedTypeName = n : t === 1 && (this.extendedFormat = n);
			}
			e.offset = n;
		}
		inspect() {
		...
		[Symbol.for("nodejs.util.inspect.custom")](e, t, n) {
			let r = A(), i = [];
			for (let e in r) i[r[e]] = e;
			let a = Me(), o = [], s = this.flags;
			for (let e in a) s & a[e] && (e === "PRI_KEY" ? o.push("PRIMARY KEY") : e === "NOT_NULL" ? o.push("NOT NULL") : e === "BINARY" || e === "MULTIPLE_KEY" || e === "NO_DEFAULT_VALUE" || e === "BLOB" || e === "UNSIGNED" || e === "TIMESTAMP" || (e === "ON_UPDATE_NOW" ? o.push("ON UPDATE CURRENT_TIMESTAMP") : o.push(e)));
			if (e > 1) return n({
				...this.inspect(),
				typeName: i[this.columnType],
				flags: o
			});
			let c = this.flags & a.UNSIGNED, l = i[this.columnType];
			return l = l === "BLOB" ? this.columnLength === 4294967295 ? "LONGTEXT" : this.columnLength === 67108860 ? "MEDIUMTEXT" : this.columnLength === 262140 ? "TEXT" : this.columnLength === 1020 ? "TINYTEXT" : `BLOB(${this.columnLength})` : l === "VAR_STRING" ? `VARCHAR(${Math.ceil(this.columnLength / 4)})` : l === "TINY" ? this.columnLength === 3 && c || this.columnLength === 4 && !c ? "TINYINT" : `TINYINT(${this.columnLength})` : l === "LONGLONG" ? this.columnLength === 20 ? "BIGINT" : `BIGINT(${this.columnLength})` : l === "SHORT" ? c && this.columnLength === 5 || !c && this.columnLength === 6 ? "SMALLINT" : `SMALLINT(${this.columnLength})` : l === "LONG" ? c && this.columnLength === 10 || !c && this.columnLength === 11 ? "INT" : `INT(${this.columnLength})` : l === "INT24" ? c && this.columnLength === 8 || !c && this.columnLength === 9 ? "MEDIUMINT" : `MEDIUMINT(${this.columnLength})` : l === "DOUBLE" ? this.columnLength === 22 && this.decimals === 31 ? "DOUBLE" : `DOUBLE(${this.columnLength},${this.decimals})` : l === "FLOAT" ? this.columnLength === 12 && this.decimals === 31 ? "FLOAT" : `FLOAT(${this.columnLength},${this.decimals})` : l === "NEWDECIMAL" ? this.columnLength === 11 && this.decimals === 0 ? "DECIMAL" : this.decimals === 0 ? c ? `DECIMAL(${this.columnLength})` : `DECIMAL(${this.columnLength - 1})` : `DECIMAL(${this.columnLength - 2},${this.decimals})` : `${i[this.columnType]}(${this.columnLength})`, c && (l += " UNSIGNED"), `\`${this.name}\` ${[l, ...o].join(" ")}`;
		}
		static toPacket(e, t) {
			let r = 17;
			a.forEach((t) => {
				r += n.lengthCodedStringLength(e[t], i[e.characterSet]);
			});
			let o = new n(t, Buffer.allocUnsafe(r), 0, r);
			function s(t) {
				o.writeLengthCodedString(e[t], i[e.characterSet]);
			}
			return o.offset = 4, a.forEach(s), o.writeInt8(12), o.writeInt16(e.characterSet), o.writeInt32(e.columnLength), o.writeInt8(e.columnType), o.writeInt16(e.flags), o.writeInt8(e.decimals), o.writeInt16(0), o;
		}
		get db() {
			return this.schema;
		}
		...
		Object.defineProperty(o.prototype, e, { get: function() {
			let t = this[`_${e}Start`], n = t + this[`_${e}Length`], i = r.decode(this._buf, this.encoding === "binary" ? this._clientEncoding : this.encoding, t, n);
	...
	s("catalog"), s("schema"), s("table"), s("orgTable"), s("orgName"), o.prototype.extendedTypeName = void 0, o.prototype.extendedFormat = void 0, t.exports = o;
})), Pe = /* @__PURE__ */ i(((e, t) => {
	t.exports = {
		NO_CURSOR: 0,
		READ_ONLY: 1,
	...
	function a(e, t, a, o) {
		let s = n.VAR_STRING, c, l = function(e) {
			return r.prototype.writeLengthCodedString.call(this, e, t);
		};
		if (e !== null) switch (typeof e) {
			case "undefined": throw TypeError("Bind parameters must not contain undefined");
			case "number":
				s = n.DOUBLE, c = 8, l = r.prototype.writeDouble;
				break;
			case "boolean":
				e |= 0, s = n.TINY, c = 1, l = r.prototype.writeInt8;
				break;
			case "object":
				Object.prototype.toString.call(e) === "[object Date]" ? (s = n.DATETIME, c = 12, l = function(e) {
					return r.prototype.writeDate.call(this, e, a);
				}) : i(e) ? (e = JSON.stringify(e), o || (s = n.JSON)) : Buffer.isBuffer(e) && (s = n.BLOB, c = r.lengthCodedNumberLength(e.length) + e.length, l = r.prototype.writeLengthCodedBuffer);
				break;
			default: e = e.toString();
		}
		else e = "", s = n.NULL;
		return c ||= r.lengthCodedStringLength(e, t), {
			value: e,
			type: s,
			length: c,
			writer: l
	...
	var n = Pe(), r = M(), i = N(), a = A(), o = j(), s = F(), { toParameter: c } = Fe();
	t.exports = class {
		constructor(e, t, n, r, i, a, o) {
			this.id = e, this.parameters = t, this.encoding = s[n], this.timezone = r, this.attributes = i, this.clientFlags = a || 0, this.jsonAsString = o || !1;
		}
		static fromPacket(e, t) {
			let n = e.readInt32(), r = e.readInt8(), i = e.readInt32(), o = e.offset;
			for (; o < e.end - 1 && !((e.buffer[o + 1] === a.VAR_STRING || e.buffer[o + 1] === a.BLOB || e.buffer[o + 1] === a.NULL || e.buffer[o + 1] === a.DOUBLE || e.buffer[o + 1] === a.TINY || e.buffer[o + 1] === a.DATETIME || e.buffer[o + 1] === a.JSON) && e.buffer[o] === 1 && e.buffer[o + 2] === 0);) e.readInt8(), o++;
			let s = [];
			for (let t = e.offset + 1; t < e.end - 1; t++) (e.buffer[t] === a.VAR_STRING || e.buffer[t] === a.BLOB || e.buffer[t] === a.NULL || e.buffer[t] === a.DOUBLE || e.buffer[t] === a.TINY || e.buffer[t] === a.DATETIME || e.buffer[t] === a.JSON) && e.buffer[t + 1] === 0 && (s.push(e.buffer[t]), e.skip(2));
			e.skip(1);
			let c = [];
			for (let n = 0; n < s.length; n++) s[n] === a.VAR_STRING ? c.push(e.readLengthCodedString(t)) : s[n] === a.BLOB ? c.push(e.readLengthCodedBuffer()) : s[n] === a.DOUBLE ? c.push(e.readDouble()) : s[n] === a.TINY ? c.push(e.readInt8()) : s[n] === a.DATETIME ? c.push(e.readDateTime()) : s[n] === a.JSON && c.push(JSON.parse(e.readLengthCodedString(t))), s[n] === a.NULL && c.push(null);
			return {
				stmtId: n,
				flags: r,
				iterationCount: i,
		...
		_serializeToBuffer(e) {
			let t = this.clientFlags & i.CLIENT_QUERY_ATTRIBUTES, s = t && this.attributes ? Object.keys(this.attributes) : [], l = this.parameters ? this.parameters.length : 0, u = l + s.length, d = new o(0, e, 0, e.length);
			d.offset = 4, d.writeInt8(r.STMT_EXECUTE), d.writeInt32(this.id);
			let f = n.NO_CURSOR;
			if (t && (f |= n.PARAMETER_COUNT_AVAILABLE), d.writeInt8(f), d.writeInt32(1), t && d.writeLengthCodedNumber(u), u > 0) {
				let e = l > 0 ? this.parameters.map((e) => c(e, this.encoding, this.timezone, this.jsonAsString)) : [], n = s.map((e) => c(this.attributes[e], this.encoding, this.timezone)), r = e.concat(n), i = 0, o = 1;
				r.forEach((e) => {
					e.type === a.NULL && (i += o), o *= 2, o === 256 && (d.writeInt8(i), i = 0, o = 1);
				}), o !== 1 && d.writeInt8(i), d.writeInt8(1);
				for (let e = 0; e < r.length; e++) if (d.writeInt8(r[e].type), d.writeInt8(0), t) {
					let t = e < l ? "" : s[e - l];
					d.writeLengthCodedString(t, this.encoding);
				}
				r.forEach((e) => {
					e.type !== a.NULL && e.writer.call(d, e.value);
				});
			}
			return d;
		}
		toPacket() {
			let e = this._serializeToBuffer(o.MockBuffer());
			return this._serializeToBuffer(Buffer.allocUnsafe(e.offset));
		}
	};
})), Le = /* @__PURE__ */ i(((e, n) => {
	var r = j(), i = N();
	n.exports = class e {
		constructor(e) {
			this.protocolVersion = e.protocolVersion, this.serverVersion = e.serverVersion, this.capabilityFlags = e.capabilityFlags, this.connectionId = e.connectionId, this.authPluginData1 = e.authPluginData1, this.authPluginData2 = e.authPluginData2, this.characterSet = e.characterSet, this.statusFlags = e.statusFlags, this.authPluginName = e.authPluginName, this.mariadbExtendedCapabilityFlags = e.mariadbExtendedCapabilityFlags;
		}
		setScrambleData(e) {
			t("crypto").randomBytes(20, (t, n) => {
				if (t) {
					e(t);
					return;
				}
				this.authPluginData1 = n.slice(0, 8), this.authPluginData2 = n.slice(8, 20), e();
			});
		}
		toPacket(e) {
			let t = 68 + Buffer.byteLength(this.serverVersion, "utf8"), n = new r(e, Buffer.alloc(t + 4, 0), 0, t + 4);
			...
			let i = Buffer.allocUnsafe(4);
			return i.writeUInt32LE(this.capabilityFlags, 0), n.writeBuffer(i.slice(0, 2)), n.writeInt8(this.characterSet), n.writeInt16(this.statusFlags), n.writeBuffer(i.slice(2, 4)), n.writeInt8(21), n.skip(10), n.writeBuffer(this.authPluginData2), n.writeInt8(0), n.writeString("mysql_native_password", "latin1"), n.writeInt8(0), n;
		}
		static fromPacket(t) {
			let n = {};
			n.protocolVersion = t.readInt8(), n.serverVersion = t.readNullTerminatedString("cesu8"), n.connectionId = t.readInt32(), n.authPluginData1 = t.readBuffer(8), t.skip(1);
			let r = Buffer.allocUnsafe(4);
			if (r[0] = t.readInt8(), r[1] = t.readInt8(), t.haveMoreData() ? (n.characterSet = t.readInt8(), n.statusFlags = t.readInt16(), r[2] = t.readInt8(), r[3] = t.readInt8(), n.capabilityFlags = r.readUInt32LE(0), n.capabilityFlags & i.PLUGIN_AUTH ? n.authPluginDataLength = t.readInt8() : (n.authPluginDataLength = 0, t.skip(1)), t.skip(6), n.capabilityFlags & i.LONG_PASSWORD ? (t.skip(4), n.mariadbExtendedCapabilityFlags = 0) : n.mariadbExtendedCapabilityFlags = t.readInt32()) : (n.capabilityFlags = r.readUInt16LE(0), n.mariadbExtendedCapabilityFlags = 0), n.capabilityFlags & i.SECURE_CONNECTION) {
				let e = n.authPluginDataLength;
				if (e === 0) n.authPluginDataLength = 20, n.authPluginData2 = t.readBuffer(12), t.skip(1);
				else {
					let r = Math.max(13, e - 8);
					n.authPluginData2 = t.readBuffer(r);
				}
			}
			return n.capabilityFlags & i.PLUGIN_AUTH && (n.authPluginName = t.readNullTerminatedString("ascii")), new e(n);
		}
	};
})), Re = /* @__PURE__ */ i(((e, t) => {
	var n = N(), r = F(), i = j(), a = P();
	t.exports = class {
		constructor(e) {
			if (this.user = e.user || "", this.database = e.database || "", this.password = e.password || "", this.passwordSha1 = e.passwordSha1, this.authPluginData1 = e.authPluginData1, this.authPluginData2 = e.authPluginData2, this.compress = e.compress, this.clientFlags = e.flags, this.mariadbExtendedClientFlags = e.mariadbExtendedClientFlags || 0, e.authToken !== void 0 && e.authPluginName !== void 0) {
				if (!Buffer.isBuffer(e.authToken)) throw TypeError("HandshakeResponse authToken must be a Buffer when provided");
				if (typeof e.authPluginName != "string") throw TypeError("HandshakeResponse authPluginName must be a string when provided");
				this.authToken = e.authToken, this.authPluginName = e.authPluginName;
			} else {
				let e;
				e = this.passwordSha1 ? a.calculateTokenFromPasswordSha(this.passwordSha1, this.authPluginData1, this.authPluginData2) : a.calculateToken(this.password, this.authPluginData1, this.authPluginData2), this.authToken = e, this.authPluginName = "mysql_native_password";
			}
			this.charsetNumber = e.charsetNumber, this.encoding = r[e.charsetNumber], this.connectAttributes = e.connectAttributes;
		}
		serializeResponse(e) {
			let t = (e) => this.clientFlags & n[e], r = new i(0, e, 0, e.length);
			r.offset = 4, r.writeInt32(this.clientFlags), r.writeInt32(0), r.writeInt8(this.charsetNumber), r.skip(19), r.writeInt32(this.mariadbExtendedClientFlags);
			let a = this.encoding;
			r.writeNullTerminatedString(this.user, a);
			let o;
			if (t("PLUGIN_AUTH_LENENC_CLIENT_DATA") ? (r.writeLengthCodedNumber(this.authToken.length), r.writeBuffer(this.authToken)) : t("SECURE_CONNECTION") ? (r.writeInt8(this.authToken.length), r.writeBuffer(this.authToken)) : (r.writeBuffer(this.authToken), r.writeInt8(0)), t("CONNECT_WITH_DB") && r.writeNullTerminatedString(this.database, a), t("PLUGIN_AUTH") && r.writeNullTerminatedString(this.authPluginName || "mysql_native_password", "latin1"), t("CONNECT_ATTRS")) {
				let e = this.connectAttributes || {}, t = Object.keys(e), n = 0;
				for (o = 0; o < t.length; ++o) n += i.lengthCodedStringLength(t[o], a), n += i.lengthCodedStringLength(e[t[o]], a);
				for (r.writeLengthCodedNumber(n), o = 0; o < t.length; ++o) r.writeLengthCodedString(t[o], a), r.writeLengthCodedString(e[t[o]], a);
			}
			return r;
		}
		toPacket() {
			if (typeof this.user != "string") throw Error("\"user\" connection config property must be a string");
			if (typeof this.database != "string") throw Error("\"database\" connection config property must be a string");
			let e = this.serializeResponse(i.MockBuffer());
			return this.serializeResponse(Buffer.alloc(e.offset));
		}
		static fromPacket(e, t = 4294967295) {
			let i = {};
			i.clientFlags = e.readInt32();
			function a(e) {
				return i.clientFlags & t & n[e];
			}
			i.maxPacketSize = e.readInt32(), i.charsetNumber = e.readInt8();
			let o = r[i.charsetNumber];
			i.encoding = o, e.skip(23), i.user = e.readNullTerminatedString(o);
			let s;
			if (a("PLUGIN_AUTH_LENENC_CLIENT_DATA") ? (s = e.readLengthCodedNumber(o), i.authToken = e.readBuffer(s)) : a("SECURE_CONNECTION") ? (s = e.readInt8(), i.authToken = e.readBuffer(s)) : i.authToken = e.readNullTerminatedString(o), a("CONNECT_WITH_DB") && (i.database = e.readNullTerminatedString(o)), a("PLUGIN_AUTH") && (i.authPluginName = e.readNullTerminatedString(o)), a("CONNECT_ATTRS")) {
				let t = e.readLengthCodedNumber(o), n = e.offset + t, r = {};
				for (; e.offset < n;) r[e.readLengthCodedString(o)] = e.readLengthCodedString(o);
				i.connectAttributes = r;
			}
			return i;
		}
	};
	...
	t.exports = class {
		constructor(e, t) {
			this.query = e, this.charsetNumber = t, this.encoding = a[t];
		}
		toPacket() {
			let e = i.encode(this.query, this.encoding), t = 5 + e.length, a = new n(0, Buffer.allocUnsafe(t), 0, t);
			return a.offset = 4, a.writeInt8(r.STMT_PREPARE), a.writeBuffer(e), a;
		}
	};
})), Be = /* @__PURE__ */ i(((e, t) => {
	t.exports = class {
	...
	var n = j(), r = M(), i = k(), a = F(), o = N(), s = A(), { toParameter: c } = Fe();
	t.exports = class {
		constructor(e, t, n, r) {
			this.query = e, this.charsetNumber = t, this.encoding = a[t], this.attributes = n, this.clientFlags = r || 0;
		}
		serializeToBuffer(e) {
			let t = this.clientFlags & o.CLIENT_QUERY_ATTRIBUTES, a = i.encode(this.query, this.encoding), l = new n(0, e, 0, e.length);
			if (l.offset = 4, l.writeInt8(r.QUERY), t) {
				let e = this.attributes, t = e ? Object.keys(e) : [], n = t.length;
				if (l.writeLengthCodedNumber(n), l.writeLengthCodedNumber(1), n > 0) {
					let r = t.map((t) => c(e[t], this.encoding, "local")), i = 0, a = 1;
					r.forEach((e) => {
						e.type === s.NULL && (i += a), a *= 2, a === 256 && (l.writeInt8(i), i = 0, a = 1);
					}), a !== 1 && l.writeInt8(i), l.writeInt8(1);
					for (let e = 0; e < n; e++) l.writeInt8(r[e].type), l.writeInt8(0), l.writeLengthCodedString(t[e], this.encoding);
					r.forEach((e) => {
						e.type !== s.NULL && e.writer.call(l, e.value);
					});
				}
			}
			return l.writeBuffer(a), l;
		}
		toPacket() {
			if (!(this.clientFlags & o.CLIENT_QUERY_ATTRIBUTES)) {
				let e = i.encode(this.query, this.encoding), t = 5 + e.length, a = new n(0, Buffer.allocUnsafe(t), 0, t);
				return a.offset = 4, a.writeInt8(r.QUERY), a.writeBuffer(e), a;
			}
			let e = this.serializeToBuffer(n.MockBuffer());
			return this.serializeToBuffer(Buffer.allocUnsafe(e.offset));
		}
	};
})), He = /* @__PURE__ */ i(((e, t) => {
	...
	t.exports = class {
		constructor(e) {
			this.serverId = e.serverId || 0, this.slaveHostname = e.slaveHostname || "", this.slaveUser = e.slaveUser || "", this.slavePassword = e.slavePassword || "", this.slavePort = e.slavePort || 0, this.replicationRank = e.replicationRank || 0, this.masterId = e.masterId || 0;
		}
		toPacket() {
			let e = 15 + Buffer.byteLength(this.slaveHostname, "utf8") + Buffer.byteLength(this.slaveUser, "utf8") + Buffer.byteLength(this.slavePassword, "utf8") + 3 + 4, t = new n(0, Buffer.allocUnsafe(e), 0, e);
			return t.offset = 4, t.writeInt8(r.REGISTER_SLAVE), t.writeInt32(this.serverId), t.writeInt8(Buffer.byteLength(this.slaveHostname, "utf8")), t.writeString(this.slaveHostname), t.writeInt8(Buffer.byteLength(this.slaveUser, "utf8")), t.writeString(this.slaveUser), t.writeInt8(Buffer.byteLength(this.slavePassword, "utf8")), t.writeString(this.slavePassword), t.writeInt16(this.slavePort), t.writeInt32(this.replicationRank), t.writeInt32(this.masterId), t;
		}
	};
})), Ue = /* @__PURE__ */ i(((e, t) => {
	var n = j(), r = M();
	t.exports = class {
		constructor() {}
		toPacket() {
			let e = new n(0, Buffer.alloc(5), 0, 5);
			return e.offset = 4, e.writeInt8(r.RESET_CONNECTION), e;
		}
	};
})), We = /* @__PURE__ */ i(((e) => {
	e.SERVER_STATUS_IN_TRANS = 1, e.SERVER_STATUS_AUTOCOMMIT = 2, e.SERVER_MORE_RESULTS_EXISTS = 8, e.SERVER_QUERY_NO_GOOD_INDEX_USED = 16, e.SERVER_QUERY_NO_INDEX_USED = 32, e.SERVER_STATUS_CURSOR_EXISTS = 64, e.SERVER_STATUS_LAST_ROW_SENT = 128, e.SERVER_STATUS_DB_DROPPED = 256, e.SERVER_STATUS_NO_BACKSLASH_ESCAPES = 512, e.SERVER_STATUS_METADATA_CHANGED = 1024, e.SERVER_QUERY_WAS_SLOW = 2048, e.SERVER_PS_OUT_PARAMS = 4096, e.SERVER_STATUS_IN_TRANS_READONLY = 8192, e.SERVER_SESSION_STATE_CHANGED = 16384;
})), Ge = /* @__PURE__ */ i(((e, t) => {
	t.exports = {
		big5: 1,
		latin2: 2,
	...
	var n = j(), r = N(), i = We(), a = Ge(), o = Ke();
	t.exports = class {
		constructor(e, t) {
			let n = t.config.bigNumberStrings, s = t.serverEncoding, c = t._handshakePacket.capabilityFlags, l = function(e) {
				return c & r[e];
			};
			if (e.buffer[e.offset] !== 0) {
				this.fieldCount = e.readLengthCodedNumber(), this.fieldCount === null && (this.infileName = e.readString(void 0, s));
				return;
			}
			this.fieldCount = e.readInt8(), this.affectedRows = e.readLengthCodedNumber(n), this.insertId = e.readLengthCodedNumberSigned(n), this.info = "", l("PROTOCOL_41") ? (this.serverStatus = e.readInt16(), this.warningStatus = e.readInt16()) : l("TRANSACTIONS") && (this.serverStatus = e.readInt16());
			let u = null;
			if (l("SESSION_TRACK") && e.offset < e.end) {
				if (this.info = e.readLengthCodedString(s), this.serverStatus & i.SERVER_SESSION_STATE_CHANGED) {
					let n = e.offset < e.end ? e.readLengthCodedNumber() : 0, r = e.offset + n, i, c, l;
					for (n > 0 && (u = {
						systemVariables: {},
						schema: null,
						gtids: [],
						...
						if (i = e.readInt8(), n = e.readLengthCodedNumber(), l = e.offset + n, i === o.SYSTEM_VARIABLES) {
							c = e.readLengthCodedString(s);
							let n = e.readLengthCodedString(s);
							if (u.systemVariables[c] = n, c === "character_set_client") {
								let e = a[n];
								e !== void 0 && (t.config.charsetNumber = e);
							}
						} else if (i === o.SCHEMA) c = e.readLengthCodedString(s), u.schema = c;
						else if (i === o.STATE_CHANGE) u.trackStateChange = e.readLengthCodedString(s);
						else if (i === o.STATE_GTIDS) {
							e.readLengthCodedString(s);
							let t = e.readLengthCodedString(s);
							u.gtids = t.split(",");
						}
						e.offset = l;
					}
				}
			} else this.info = e.readString(void 0, s);
			u && (this.stateChanges = u);
			let d = this.info.match(/\schanged:\s*(\d+)/i);
			d === null ? this.changedRows = 0 : this.changedRows = parseInt(d[1], 10);
		}
		static toPacket(e, t) {
			let r = 4 + n.lengthCodedNumberLength(e);
			t !== void 0 && (r += n.lengthCodedNumberLength(t));
			let i = new n(0, Buffer.allocUnsafe(r), 0, r);
			return i.offset = 4, i.writeLengthCodedNumber(e), t !== void 0 && i.writeLengthCodedNumber(t), i;
		}
	};
})), Je = /* @__PURE__ */ i(((e, t) => {
	var n = N(), r = j();
	t.exports = class {
		constructor(e, t, r) {
			this.clientFlags = e | n.SSL, this.charset = t, this.mariadbExtendedClientFlags = r || 0;
		}
		toPacket() {
			let e = Buffer.allocUnsafe(36), t = new r(0, e, 0, 36);
			return e.fill(0), t.offset = 4, t.writeInt32(this.clientFlags), t.writeInt32(0), t.writeInt8(this.charset), t.skip(19), t.writeInt32(this.mariadbExtendedClientFlags), t;
		}
	};
})), Ye = /* @__PURE__ */ i(((e, t) => {
	var n = j();
	t.exports = class e {
		...
		static fromPacket(t) {
			let n = [];
			for (; t.haveMoreData();) n.push(t.readLengthCodedString());
			return new e(n);
		}
		static toPacket(e, t) {
			let r = 0;
			e.forEach((e) => {
				...
				r += n.lengthCodedStringLength(e.toString(10), t);
			});
			let i = new n(0, Buffer.allocUnsafe(r + 4), 0, r + 4);
			return i.offset = 4, e.forEach((e) => {
				if (e === null) {
					i.writeNull();
					return;
				}
				...
				i.writeLengthCodedString(e.toString(10), t);
			}), i;
		}
	};
})), I = /* @__PURE__ */ i(((e, n) => {
	var r = t("process"), i = {
		AuthNextFactor: we(),
		AuthSwitchRequest: Te(),
		AuthSwitchRequestMoreData: Ee(),
		AuthSwitchResponse: De(),
		BinaryRow: Oe(),
		BinlogDump: ke(),
		ChangeUser: Ae(),
		CloseStatement: je(),
		...
		Execute: Ie(),
		Handshake: Le(),
		HandshakeResponse: Re(),
		PrepareStatement: ze(),
		PreparedStatementHeader: Be(),
		Query: Ve(),
		RegisterSlave: He(),
		ResetConnection: Ue(),
		ResultSetHeader: qe(),
	...
	Object.entries(i).forEach(([e, t]) => {
		if (n.exports[e] = t, r.env.NODE_DEBUG && t.prototype.toPacket) {
			let n = t.prototype.toPacket;
			t.prototype.toPacket = function() {
				let t = n.call(this);
				return t._name = e, t;
			};
		}
	...
	var a = j();
	e.Packet = a, e.OK = class {
		static toPacket(e, t) {
			e ||= {};
			let n = e.affectedRows || 0, r = e.insertId || 0, i = e.serverStatus || 0, o = e.warningCount || 0, s = e.message || "", c = 9 + a.lengthCodedNumberLength(n);
			c += a.lengthCodedNumberLength(r);
			let l = new a(0, Buffer.allocUnsafe(c), 0, c);
			return l.offset = 4, l.writeInt8(0), l.writeLengthCodedNumber(n), l.writeLengthCodedNumber(r), l.writeInt16(i), l.writeInt16(o), l.writeString(s, t), l._name = "OK", l;
		}
	}, e.EOF = class {
		static toPacket(e, t) {
			e === void 0 && (e = 0), t === void 0 && (t = 0);
			let n = new a(0, Buffer.allocUnsafe(9), 0, 9);
			return n.offset = 4, n.writeInt8(254), n.writeInt16(e), n.writeInt16(t), n._name = "EOF", n;
		}
	}, e.Error = class e {
		static toPacket(e, t) {
			let n = 13 + Buffer.byteLength(e.message, "utf8"), r = new a(0, Buffer.allocUnsafe(n), 0, n);
			return r.offset = 4, r.writeInt8(255), r.writeInt16(e.code), r.writeString("#_____", t), r.writeString(e.message, t), r._name = "Error", r;
		}
		static fromPacket(t) {
			t.readInt8();
			let n = t.readInt16();
			t.readString(1, "ascii"), t.readString(5, "ascii");
			let r = t.readNullTerminatedString("utf8"), i = new e();
			return i.message = r, i.code = n, i;
		}
	};
})), L = /* @__PURE__ */ i(((e, n) => {
	var r = t("events").EventEmitter, i = t("timers");
	n.exports = class extends r {
		...
		stateName() {
			let e = this.next;
			for (let t in this) if (this[t] === e && t !== "next") return t;
			return "unknown name";
		}
		execute(e, t) {
			if (this.next || (this.next = this.start, t._resetSequenceId()), e && e.isError()) {
				let n = e.asError(t.clientEncoding);
				return n.sql = this.sql || this.query, this.queryTimeout &&= (i.clearTimeout(this.queryTimeout), null), this.onResult ? (this.onResult(n), this.emit("end")) : (this.emit("error", n), this.emit("end")), !0;
			}
			return this.next = this.next(e, t), this.next ? !1 : (this.emit("end"), !0);
		}
	};
})), Xe = /* @__PURE__ */ i(((e) => {
	e.MARIADB_CLIENT_PROGRESS = 1, e.MARIADB_CLIENT_COM_MULTI = 2, e.MARIADB_CLIENT_STMT_BULK_OPERATIONS = 4, e.MARIADB_CLIENT_EXTENDED_METADATA = 8, e.MARIADB_CLIENT_CACHE_METADATA = 16, e.MARIADB_CLIENT_BULK_UNIT_RESULTS = 32;
})), Ze = /* @__PURE__ */ i(((e, n) => {
	var r = "sha256_password", i = t("crypto"), { xorRotating: a } = P(), o = t("tls"), s = Buffer.from([1]), c = 0, l = 1, u = -1;
	function d(e, t, n) {
		let r = a(Buffer.from(`${e}\0`, "utf8"), t);
		return i.publicEncrypt({
			key: n,
			oaepHash: "sha1"
		}, r);
	}
	n.exports = (e = {}) => ({ connection: t }) => {
		let n = 0, i = null, a = t.config.password, f = (e) => {
			let t = d(a, i, e);
			return n = u, t;
		};
		return (d) => {
			switch (n) {
				case c: return t.stream instanceof o.TLSSocket && t.stream.encrypted === !0 ? Buffer.from(`${a}\0`, "utf8") : (i = d.slice(0, 20), e.serverPublicKey ? f(e.serverPublicKey) : (n = l, s));
				case l: return e.onServerPublicKey && e.onServerPublicKey(d), f(d);
				case u: throw Error(`Unexpected data in AuthMoreData packet received by ${r} plugin in STATE_FINAL state.`);
			}
			throw Error(`Unexpected data in AuthMoreData packet received by ${r} plugin in state ${n}`);
		};
	};
})), Qe = /* @__PURE__ */ i(((e, n) => {
	var r = "caching_sha2_password", i = t("crypto"), { xor: a, xorRotating: o } = P(), s = Buffer.from([2]), c = Buffer.from([3]), l = Buffer.from([4]), u = 0, d = 1, f = 2, p = -1;
	function m(e) {
		let t = i.createHash("sha256");
		return t.update(e), t.digest();
	}
	function h(e, t) {
		if (!e) return Buffer.alloc(0);
		let n = m(Buffer.from(e)), r = m(n);
		return a(n, m(Buffer.concat([r, t])));
	}
	function g(e, t, n) {
		let r = o(Buffer.from(`${e}\0`, "utf8"), t);
		return i.publicEncrypt({
			key: n,
			oaepHash: "sha1",
	...
	n.exports = (e = {}) => ({ connection: t }) => {
		let n = 0, i = null, a = t.config.password, o = (e) => {
			let t = g(a, i, e);
			return n = p, t;
		};
		return (m) => {
			switch (n) {
				case u: return i = m.slice(0, 20), n = d, h(a, i);
				case d:
					if (c.equals(m)) return n = p, null;
					if (l.equals(m)) return (e.overrideIsSecure === void 0 ? t.config.ssl || t.config.socketPath : e.overrideIsSecure) ? (n = p, Buffer.from(`${a}\0`, "utf8")) : e.serverPublicKey ? o(e.serverPublicKey) : (n = f, s);
					throw Error(`Invalid AuthMoreData packet received by ${r} plugin in STATE_TOKEN_SENT state.`);
				case f: return e.onServerPublicKey && e.onServerPublicKey(m), o(m);
				case p: throw Error(`Unexpected data in AuthMoreData packet received by ${r} plugin in STATE_FINAL state.`);
			}
			throw Error(`Unexpected data in AuthMoreData packet received by ${r} plugin in state ${n}`);
		};
	}, n.exports.calculateToken = h;
})), $e = /* @__PURE__ */ i(((e, t) => {
	var n = P();
	t.exports = (e) => ({ connection: t, command: r }) => {
		let i = r.password || e.password || t.config.password, a = r.passwordSha1 || e.passwordSha1 || t.config.passwordSha1;
		return (e) => {
			let t = e.slice(0, 8), r = e.slice(8, 20), o;
			return o = a ? n.calculateTokenFromPasswordSha(a, t, r) : n.calculateToken(i, t, r), o;
		};
	};
})), et = /* @__PURE__ */ i(((e, t) => {
	function n(e) {
	...
	t.exports = (e) => function({ connection: t, command: r }) {
		let i = r.password || e.password || t.config.password;
		return function() {
			return n(i);
		};
	};
})), tt = /* @__PURE__ */ i(((e, t) => {
	var n = I(), r = Ze(), i = Qe(), a = $e(), o = et(), s = Object.assign(Object.create(null), {
		sha256_password: r({}),
		caching_sha2_password: i({}),
		mysql_native_password: a({}),
		mysql_clear_password: o({})
	});
	function c(e, t) {
		let n = t.config.authPlugins;
		return n && Object.prototype.hasOwnProperty.call(n, e) ? n[e] : s[e];
	}
	function l() {
		console.warn("WARNING! authSwitchHandler api is deprecated, please use new authPlugins api");
	}
	function u(e, t) {
		e.code = "AUTH_SWITCH_PLUGIN_ERROR", e.fatal = !0, t.emit("error", e);
	}
	function d(e, t, r) {
		let { pluginName: i, pluginData: a } = n.AuthSwitchRequest.fromPacket(e);
		if (t.config.authSwitchHandler && i !== "mysql_native_password") {
			let e = t.config.authSwitchHandler;
			l(), e({
				pluginName: i,
				pluginData: a
			}, (e, i) => {
				if (e) return u(e, r);
				t.writePacket(new n.AuthSwitchResponse(i).toPacket());
			});
			return;
		}
		if (i === "mysql_clear_password" && !(t.config.authPlugins && Object.prototype.hasOwnProperty.call(t.config.authPlugins, "mysql_clear_password")) && !t.config.enableCleartextPlugin) {
			let e = /* @__PURE__ */ Error("Server requested authentication using mysql_clear_password, which sends the password in plaintext over the network and is disabled by default. To enable it, set the `enableCleartextPlugin` option to `true` in your connection configuration, or provide a custom `mysql_clear_password` auth plugin via the `authPlugins` option. Only use this over a secure connection (TLS/SSL).");
			throw e.code = "MYSQL_CLEAR_PASSWORD_NOT_ENABLED", e.fatal = !0, e;
		}
		let o = c(i, t);
		if (!o) throw Error(`Server requests authentication using unknown plugin ${i}. See TODO: add plugins doco here on how to configure or author authentication plugins.`);
		t._authPlugin = o({
			connection: t,
			command: r
		}), Promise.resolve(t._authPlugin(a)).then((e) => {
			e && t.writePacket(new n.AuthSwitchResponse(e).toPacket());
		}).catch((e) => {
			u(e, r);
		});
	}
	function f(e, t, r) {
		let { data: i } = n.AuthSwitchRequestMoreData.fromPacket(e);
		if (t.config.authSwitchHandler) {
			let e = t.config.authSwitchHandler;
			l(), e({ pluginData: i }, (e, i) => {
				if (e) return u(e, r);
				t.writePacket(new n.AuthSwitchResponse(i).toPacket());
			});
			return;
		}
		if (!t._authPlugin) throw Error("AuthPluginMoreData received but no auth plugin instance found");
		Promise.resolve(t._authPlugin(i)).then((e) => {
			e && t.writePacket(new n.AuthSwitchResponse(e).toPacket());
		}).catch((e) => {
			u(e, r);
		});
	...
	t.exports = {
		authSwitchRequest: d,
		authSwitchRequestMoreData: f,
		getAuthPlugin: c,
		standardAuthPlugins: s
	};
})), nt = /* @__PURE__ */ i(((e, n) => {
	var r = t("zlib"), i = Ce(), a = class {
		constructor() {
			this._queue = [], this._running = !1;
		}
		push(e) {
			this._queue.push(e), this._running || (this._running = !0, process.nextTick(() => this._next()));
		}
		_next() {
			...
			e({ done: () => process.nextTick(() => this._next()) });
		}
	};
	function o(e) {
		let t = this, n = e.readInt24(), i = e.readBuffer();
		n === 0 ? t.inflateQueue.push((n) => {
			t._bumpCompressedSequenceId(e.numPackets), t._inflatedPacketsParser.execute(i), n.done();
		}) : t.inflateQueue.push((n) => {
			r.inflate(i, (r, i) => {
				if (r) {
					t._handleNetworkError(r);
					return;
				}
				t._bumpCompressedSequenceId(e.numPackets), t._inflatedPacketsParser.execute(i), n.done();
			});
	...
	function s(e) {
		let t = 16777210, n;
		if (e.length > t) {
			for (n = 0; n < e.length; n += t) s.call(this, e.slice(n, n + t));
			return;
		}
		let i = this, a = e.length, o = Buffer.allocUnsafe(7);
		(function(t) {
			i.deflateQueue.push((n) => {
				r.deflate(e, (r, s) => {
					if (r) {
						i._handleFatalError(r);
						return;
					}
					let c = s.length;
					c < a ? (o.writeUInt8(c & 255, 0), o.writeUInt16LE(c >> 8, 1), o.writeUInt8(t, 3), o.writeUInt8(a & 255, 4), o.writeUInt16LE(a >> 8, 5), i.writeUncompressed(o), i.writeUncompressed(s)) : (c = a, a = 0, o.writeUInt8(c & 255, 0), o.writeUInt16LE(c >> 8, 1), o.writeUInt8(t, 3), o.writeUInt8(a & 255, 4), o.writeUInt16LE(a >> 8, 5), i.writeUncompressed(o), i.writeUncompressed(e)), n.done();
				});
			});
		})(i.compressedSequenceId), i._bumpCompressedSequenceId(1);
	}
	function c(e) {
		e._lastWrittenPacketId = 0, e._lastReceivedPacketId = 0, e._handleCompressedPacket = o, e._inflatedPacketsParser = new i((t) => {
			e.handlePacket(t);
		}, 4), e._inflatedPacketsParser._lastPacket = 0, e.packetParser = new i((t) => {
			e._handleCompressedPacket(t);
		}, 7), e.writeUncompressed = e.write, e.write = s, e.inflateQueue = new a(), e.deflateQueue = new a();
	}
	n.exports = {
		enableCompression: c,
		Queue: a
	...
	var n = L(), r = I(), i = N(), a = Xe(), o = F(), s = P(), { getAuthPlugin: c } = tt(), { calculateToken: l } = Qe();
	function u(e) {
		let t = [];
		for (let n in i) e & i[n] && t.push(n.replace(/_/g, " ").toLowerCase());
		return t;
	}
	t.exports = class e extends n {
		constructor(e) {
			super(), this.handshake = null, this.clientFlags = e, this.mariadbExtendedClientFlags = 0, this.authenticationFactor = 0;
		}
		start() {
			return e.prototype.handshakeInit;
		}
		sendSSLRequest(e) {
			let t = new r.SSLRequest(this.clientFlags, e.config.charsetNumber, this.mariadbExtendedClientFlags);
			e.writePacket(t.toPacket());
		}
		sendCredentials(e) {
			e.config.debug && console.log("Sending handshake packet: flags:%d=(%s)", this.clientFlags, u(this.clientFlags).join(", ")), this.user = e.config.user, this.password = e.config.password, this.password1 = e.config.password, this.password2 = e.config.password2, this.password3 = e.config.password3, this.passwordSha1 = e.config.passwordSha1, this.database = e.config.database, this.authPluginName = this.handshake.authPluginName;
			let t = this.handshake.authPluginName, n = e.config.ssl || e.config.socketPath, i = this.handshake.authPluginData1 && this.handshake.authPluginData2 ? Buffer.concat([this.handshake.authPluginData1, this.handshake.authPluginData2]).slice(0, 20) : Buffer.alloc(20), a = e.config.authPlugins && Object.prototype.hasOwnProperty.call(e.config.authPlugins, t), o = typeof e.config.authSwitchHandler == "function", s = !a && !o && this.canUseAuthMethodDirectly(t, n) && (t !== "mysql_clear_password" || e.config.enableCleartextPlugin) ? t : "mysql_native_password", c = this.calculateAuthToken(s, this.password, i);
			e.config.debug && console.log("Server auth method: %s, Using auth method: %s", t, s);
			let l = new r.HandshakeResponse({
				...
				charsetNumber: e.config.charsetNumber,
				authPluginData1: this.handshake.authPluginData1,
				authPluginData2: this.handshake.authPluginData2,
				compress: e.config.compress,
				connectAttributes: e.config.connectAttributes,
				authToken: c,
				authPluginName: s
			});
			e.writePacket(l.toPacket()), s !== "mysql_native_password" && this.initializeAuthPlugin(s, i, e);
		}
		calculateNativePasswordAuthToken(e) {
			let t = e.slice(0, 8), n = e.slice(8, 20), r;
			return r = this.passwordSha1 ? s.calculateTokenFromPasswordSha(this.passwordSha1, t, n) : s.calculateToken(this.password, t, n), r;
		}
		calculateSha256Token(e, t) {
			return l(e, t);
		}
		calculateAuthToken(e, t, n) {
			switch (e) {
				case "mysql_native_password": return this.calculateNativePasswordAuthToken(n);
				case "caching_sha2_password": return this.calculateSha256Token(t, n);
				case "sha256_password":
				case "mysql_clear_password": return t ? Buffer.from(`${t}\0`, "utf8") : Buffer.alloc(0);
				default: return this.calculateNativePasswordAuthToken(n);
			}
		}
		canUseAuthMethodDirectly(e, t) {
			switch (e) {
				case "mysql_native_password":
				case "caching_sha2_password": return !0;
				case "sha256_password":
				case "mysql_clear_password": return t;
				default: return !1;
			}
		}
		initializeAuthPlugin(e, t, n) {
			let r = c(e, n);
			if (!r) return;
			let i = r({
				connection: n,
			...
			n._authPlugin = i;
			try {
				Promise.resolve(i(t)).catch((e) => {
					n.config.debug && console.log("Auth plugin initialization:", e.message);
				});
			} catch (e) {
				n.config.debug && console.log("Auth plugin initialization error:", e.message);
			}
		}
		handshakeInit(t, n) {
			this.on("error", (e) => {
				n._fatalError = e, n._protocolError = e;
			}), this.handshake = r.Handshake.fromPacket(t), n.config.debug && console.log("Server hello packet: capability flags:%d=(%s)", this.handshake.capabilityFlags, u(this.handshake.capabilityFlags).join(", ")), n.serverCapabilityFlags = this.handshake.capabilityFlags, n.serverEncoding = o[this.handshake.characterSet], n.connectionId = this.handshake.connectionId, n._isMariaDB = /mariadb/i.test(this.handshake.serverVersion), this.handshake.mariadbExtendedCapabilityFlags & a.MARIADB_CLIENT_EXTENDED_METADATA && (this.clientFlags &= ~i.LONG_PASSWORD, this.mariadbExtendedClientFlags |= a.MARIADB_CLIENT_EXTENDED_METADATA), n._mariadbExtendedMetadata = !!(this.mariadbExtendedClientFlags & a.MARIADB_CLIENT_EXTENDED_METADATA);
			let s = this.handshake.capabilityFlags & i.SSL, c = this.handshake.capabilityFlags & i.MULTI_FACTOR_AUTHENTICATION;
			if (this.clientFlags |= c, n.config.compress = n.config.compress && this.handshake.capabilityFlags & i.COMPRESS, this.clientFlags |= n.config.compress, n.config.ssl) {
				if (!s) {
					let e = /* @__PURE__ */ Error("Server does not support secure connection");
					return e.code = "HANDSHAKE_NO_SSL_SUPPORT", e.fatal = !0, this.emit("error", e), !1;
				}
				this.clientFlags |= i.SSL, this.sendSSLRequest(n), n.startTLS((e) => {
					if (e) {
						e.code = "HANDSHAKE_SSL_ERROR", e.fatal = !0, this.emit("error", e);
						return;
					}
					this.sendCredentials(n);
				});
			} else this.sendCredentials(n);
			return c && (this.authenticationFactor = 1), e.prototype.handshakeResult;
		}
		handshakeResult(t, n) {
			let r = t.peekByte();
			if (r === 254 || r === 1 || r === 2) {
				let i = tt();
				try {
					return r === 1 ? i.authSwitchRequestMoreData(t, n, this) : (this.authenticationFactor !== 0 && (n.config.password = this[`password${this.authenticationFactor}`], this.authenticationFactor += 1), i.authSwitchRequest(t, n, this)), e.prototype.handshakeResult;
				} catch (e) {
					return e.code ||= "AUTH_SWITCH_PLUGIN_ERROR", e.fatal = !0, this.onResult ? this.onResult(e) : this.emit("error", e), null;
				}
			}
			if (r !== 0) {
				let e = /* @__PURE__ */ Error("Unexpected packet during handshake phase");
	...
	t.exports = class e extends i {
		...
		start(t, n) {
			let r = new a.Handshake(this.args);
			return this.serverHello = r, r.setScrambleData((e) => {
				if (e) {
					n.emit("error", /* @__PURE__ */ Error("Error generating random bytes"));
					return;
				}
				n.writePacket(r.toPacket(0));
			}), e.prototype.readClientReply;
		}
		readClientReply(t, n) {
			let r = a.HandshakeResponse.fromPacket(t, this.args.capabilityFlags);
			return n.clientHelloReply = r, this.args.authCallback ? this.args.authCallback({
				user: r.user,
				database: r.database,
			...
			}) : n.writeOk(), e.prototype.dispatchCommands;
		}
		_isStatement(e, t) {
			return e.split(" ")[0].toUpperCase() === t;
		}
		dispatchCommands(t, i) {
			let o = !0, s = i.clientHelloReply.encoding, c = t.readInt8();
			switch (c) {
				case n.STMT_PREPARE:
					if (i.listeners("stmt_prepare").length) {
						let e = t.readString(void 0, s);
						i.emit("stmt_prepare", e);
					} else i.writeError({
						code: r.HA_ERR_INTERNAL_ERROR,
						message: "No query handler for prepared statements."
					});
					break;
				case n.STMT_EXECUTE:
					if (i.listeners("stmt_execute").length) {
						let { stmtId: e, flags: n, iterationCount: r, values: o } = a.Execute.fromPacket(t, s);
						i.emit("stmt_execute", e, n, r, o);
					} else i.writeError({
						code: r.HA_ERR_INTERNAL_ERROR,
					...
					break;
				case n.QUIT:
					i.listeners("quit").length ? i.emit("quit") : i.stream.end();
					break;
				case n.INIT_DB:
					if (i.listeners("init_db").length) {
						let e = t.readString(void 0, s);
						i.emit("init_db", e);
					} else i.writeOk();
					break;
				case n.QUERY:
					if (i.listeners("query").length) {
						let e = t.readString(void 0, s);
						this._isStatement(e, "PREPARE") || this._isStatement(e, "SET") ? i.emit("stmt_prepare", e) : this._isStatement(e, "EXECUTE") ? i.emit("stmt_execute", null, null, null, null, e) : i.emit("query", e);
					} else i.writeError({
						code: r.HA_ERR_INTERNAL_ERROR,
					...
					break;
				case n.FIELD_LIST:
					if (i.listeners("field_list").length) {
						let e = t.readNullTerminatedString(s), n = t.readString(void 0, s);
						i.emit("field_list", e, n);
					} else i.writeError({
					...
					break;
				case n.PING:
					i.listeners("ping").length ? i.emit("ping") : i.writeOk();
					break;
				default: o = !1;
			}
			return i.listeners("packet").length ? i.emit("packet", t.clone(), o, c) : o || console.log("Unknown command:", c), e.prototype.dispatchCommands;
		}
	};
})), R = /* @__PURE__ */ i(((e) => {
	...
	function n(e) {
		return JSON.stringify({ [e]: 1 }).slice(1, -3);
	}
	e.srcEscape = n;
	var r, i = !1;
	try {
		r = t("cardinal").highlight;
	} catch {
		r = (e) => (i ||= (console.log("For nicer debug output consider install cardinal@^2.0.0"), !0), e);
	}
	function a(e, t) {
		console.log(`\n\n${e}:\n`), console.log(`${r(t)}\n`);
	}
	e.printDebugWithCode = a;
	function o(e, t, n) {
		return Array.isArray(t) ? t.some((t) => e === n[t]) : !!t;
	}
	e.typeMatch = o;
	var s = new Set([
		"__defineGetter__",
	...
	e.privateObjectProps = s, e.fieldEscape = (e, t = !0) => {
		if (s.has(e)) throw Error(`The field name (${e}) can't be the same as an object's private property.`);
		return t ? n(e) : e;
	};
})), at = /* @__PURE__ */ i(((e, t) => {
	function n(e) {
	...
	for (var r = t("util"), i = at(), a = /[\{\[]/, o = /[\}\]]/, s = /* @__PURE__ */ "do.if.in.for.let.new.try.var.case.else.enum.eval.null.this.true.void.with.await.break.catch.class.const.false.super.throw.while.yield.delete.export.import.public.return.static.switch.typeof.default.extends.finally.package.private.continue.debugger.function.arguments.interface.protected.implements.instanceof.NaN.undefined".split("."), c = {}, l = 0; l < s.length; l++) c[s[l]] = !0;
	var u = function(e) {
		return i(e) && !c.hasOwnProperty(e);
	}, d = {
		s: function(e) {
			return "" + e;
		},
		...
		var e = [], t = 0, n = {}, s = function(n) {
			for (var r = ""; r.length < t * 2;) r += "  ";
			e.push(r + n);
		}, c = function(e) {
			if (o.test(e.trim()[0]) && a.test(e[e.length - 1])) {
				t--, s(e), t++;
				return;
			}
			if (a.test(e[e.length - 1])) {
				s(e), t++;
				return;
			}
			if (o.test(e.trim()[0])) {
			...
			if (!e) return l;
			if (arguments.length === 1 && e.indexOf("\n") > -1) for (var t = e.trim().split("\n"), n = 0; n < t.length; n++) c(t[n].trim());
			else c(r.format.apply(r, arguments));
			return l;
		};
		return l.scope = {}, l.formats = d, l.sym = function(e) {
			return (!e || !u(e)) && (e = "tmp"), n[e] || (n[e] = 0), e + (n[e]++ || "");
		}, l.property = function(e, t) {
			return arguments.length === 1 && (t = e, e = ""), t += "", i(t) ? e ? e + "." + t : t : e ? e + "[" + JSON.stringify(t) + "]" : JSON.stringify(t);
		}, l.toString = function() {
			return e.join("\n");
		}, l.toFunction = function(e) {
			e ||= {};
			var t = "return (" + l.toString() + ")";
			Object.keys(l.scope).forEach(function(t) {
				e[t] || (e[t] = l.scope[t]);
			});
		...
		}, arguments.length && l.apply(null, arguments), l;
	};
	f.formats = d, n.exports = f;
})), st = /* @__PURE__ */ i(((e, t) => {
	var n = A(), r = R(), i = z(), a = ot(), o = s(), c = [];
	for (let e in n) c[n[e]] = e;
	function l(e, t, a, o) {
		let s = e.columnType, c = e.characterSet, l = !!(o.supportBigNumbers || a.supportBigNumbers), u = !!(o.bigNumberStrings || a.bigNumberStrings), d = o.timezone || a.timezone, f = o.dateStrings || a.dateStrings;
		if (e.extendedFormat === "json") return a.jsonStrings ? `packet.readLengthCodedString(${t})` : `packet.parseJson(${t}, ${l})`;
		switch (s) {
			case n.TINY:
			case n.SHORT:
			case n.LONG:
			case n.INT24:
			case n.YEAR: return "packet.parseLengthCodedIntNoBigCheck()";
			case n.LONGLONG: return l && u ? "packet.parseLengthCodedIntString()" : `packet.parseLengthCodedInt(${l})`;
			case n.FLOAT:
			case n.DOUBLE: return "packet.parseLengthCodedFloat()";
			case n.NULL: return "packet.readLengthCodedNumber()";
			case n.DECIMAL:
			case n.NEWDECIMAL: return a.decimalNumbers ? "packet.parseLengthCodedFloat()" : "packet.readLengthCodedString(\"ascii\")";
			case n.DATE: return i.typeMatch(s, f, n) ? "packet.readLengthCodedString(\"ascii\")" : `packet.parseDate(${i.srcEscape(d)})`;
			case n.DATETIME:
			case n.TIMESTAMP: return i.typeMatch(s, f, n) ? "packet.readLengthCodedString(\"ascii\")" : `packet.parseDateTime(${i.srcEscape(d)})`;
			case n.TIME: return "packet.readLengthCodedString(\"ascii\")";
			case n.GEOMETRY: return "packet.parseGeometryValue()";
			case n.VECTOR: return "packet.parseVector()";
			case n.JSON: return a.jsonStrings ? "packet.readLengthCodedString(\"utf8\")" : `packet.parseJson("utf8", ${l})`;
			default: return c === r.BINARY ? "packet.readLengthCodedBuffer()" : `packet.readLengthCodedString(${t})`;
		}
	}
	function u(e, t, r) {
		typeof r.typeCast == "function" && typeof t.typeCast != "function" && (t.typeCast = r.typeCast);
		function o(e, t) {
			return {
				type: c[e.columnType],
				extendedTypeName: e.extendedTypeName,
				extendedFormat: e.extendedFormat,
				length: e.columnLength,
				db: e.schema,
				table: e.table,
				name: e.name,
				string: function(r = e.encoding) {
					return e.columnType === n.JSON && r === e.encoding && console.warn(`typeCast: JSON column "${e.name}" is interpreted as BINARY by default, recommended to manually set utf8 encoding: \`field.string("utf8")\``), t.packet.readLengthCodedString(r);
				},
				buffer: function() {
					return t.packet.readLengthCodedBuffer();
				},
				geometry: function() {
					return t.packet.parseGeometryValue();
				}
			};
		}
		let s = a();
		s("(function () {")("return class TextRow {"), s("constructor(fields) {"), typeof t.typeCast == "function" && (s("const _this = this;"), s("for(let i=0; i<fields.length; ++i) {"), s("this[`wrap${i}`] = wrap(fields[i], _this);"), s("}")), s("}"), s("next(packet, fields, options) {"), s("this.packet = packet;"), t.rowsAsArray ? s(`const result = new Array(${e.length});`) : s("const result = {};");
		let u = {}, d = [];
		if (t.nestTables === !0) {
			for (let t = 0; t < e.length; t++) u[e[t].table] = 1;
			d = Object.keys(u);
			for (let e = 0; e < d.length; e++) s(`result[${i.fieldEscape(d[e])}] = {};`);
		}
		let f = "", p = "", m = "";
		for (let n = 0; n < e.length; n++) if (p = i.fieldEscape(e[n].name), typeof t.nestTables == "string" ? f = `result[${i.fieldEscape(e[n].table + t.nestTables + e[n].name)}]` : t.nestTables === !0 ? (m = i.fieldEscape(e[n].table), s(`if (!result[${m}]) result[${m}] = {};`), f = `result[${m}][${p}]`) : f = t.rowsAsArray ? `result[${n.toString(10)}]` : `result[${p}]`, t.typeCast === !1) s(`${f} = packet.readLengthCodedBuffer();`);
		else {
			let i = `fields[${n}].encoding`, a = l(e[n], i, r, t);
			typeof t.typeCast == "function" ? s(`${f} = options.typeCast(this.wrap${n}, function() { return ${a} });`) : s(`${f} = ${a};`);
		}
		return s("return result;"), s("}"), s("};")("})()"), r.debug && i.printDebugWithCode("Compiled text protocol row parser", s.toString()), typeof t.typeCast == "function" ? s.toFunction({ wrap: o }) : s.toFunction();
	}
	function d(e, t, n) {
		return o.getParser("text", e, t, n, u);
	}
	t.exports = d;
})), ct = /* @__PURE__ */ i(((e, t) => {
	var n = A(), r = R(), i = z(), a = [];
	for (let e in n) a[n[e]] = e;
	function o({ packet: e, field: t, type: a, charset: o, encoding: s, config: c, options: l }) {
		let u = !!(l.supportBigNumbers || c.supportBigNumbers), d = !!(l.bigNumberStrings || c.bigNumberStrings), f = l.timezone || c.timezone, p = l.dateStrings || c.dateStrings;
		if (t.extendedFormat === "json") return c.jsonStrings ? e.readLengthCodedString(s) : e.parseJson(s, u);
		switch (a) {
			case n.TINY:
			case n.SHORT:
			case n.LONG:
			case n.INT24:
			case n.YEAR: return e.parseLengthCodedIntNoBigCheck();
			case n.LONGLONG: return u && d ? e.parseLengthCodedIntString() : e.parseLengthCodedInt(u);
			case n.FLOAT:
			case n.DOUBLE: return e.parseLengthCodedFloat();
			case n.NULL:
			case n.DECIMAL:
			case n.NEWDECIMAL: return c.decimalNumbers ? e.parseLengthCodedFloat() : e.readLengthCodedString("ascii");
			case n.DATE: return i.typeMatch(a, p, n) ? e.readLengthCodedString("ascii") : e.parseDate(f);
			case n.DATETIME:
			case n.TIMESTAMP: return i.typeMatch(a, p, n) ? e.readLengthCodedString("ascii") : e.parseDateTime(f);
			case n.TIME: return e.readLengthCodedString("ascii");
			case n.GEOMETRY: return e.parseGeometryValue();
			case n.VECTOR: return e.parseVector();
			case n.JSON: return c.jsonStrings ? e.readLengthCodedString("utf8") : e.parseJson("utf8", u);
			default: return o === r.BINARY ? e.readLengthCodedBuffer() : e.readLengthCodedString(s);
		}
	}
	function s(e, t) {
		return {
			...
			name: e.name,
			string: function(r = e.encoding) {
				return e.columnType === n.JSON && r === e.encoding && console.warn(`typeCast: JSON column "${e.name}" is interpreted as BINARY by default, recommended to manually set utf8 encoding: \`field.string("utf8")\``), t.readLengthCodedString(r);
			},
			buffer: function() {
	...
	function c(e, t, n) {
		return { next(e, t, r) {
			...
			for (let c = 0; c < t.length; c++) {
				let l = t[c], u = r.typeCast ? r.typeCast : n.typeCast, d = () => o({
					packet: e,
					field: l,
					type: l.columnType,
					encoding: l.encoding,
				...
				if (f = r.typeCast === !1 ? e.readLengthCodedBuffer() : typeof u == "function" ? u(s(l, e), d) : d(), r.rowsAsArray) a.push(f);
				else if (typeof r.nestTables == "string") a[`${i.fieldEscape(l.table, !1)}${r.nestTables}${i.fieldEscape(l.name, !1)}`] = f;
				else if (r.nestTables) {
					let e = i.fieldEscape(l.table, !1);
					a[e] || (a[e] = {}), a[e][i.fieldEscape(l.name, !1)] = f;
				} else a[i.fieldEscape(l.name, !1)] = f;
			}
			return a;
		} };
	}
	...
	var r = t("process"), i = t("timers"), a = t("stream").Readable, o = L(), s = I(), c = st(), l = ct(), u = We(), d = new s.Packet(0, Buffer.allocUnsafe(4), 0, 4), f = class e extends o {
		constructor(e, t) {
			super(), this.sql = e.sql, this.values = e.values, this._queryOptions = e, this.namedPlaceholders = e.namedPlaceholders || !1, this.onResult = t, this.timeout = e.timeout, this.queryTimeout = null, this._fieldCount = 0, this._rowParser = null, this._fields = [], this._rows = [], this._receivedFieldsCount = 0, this._resultIndex = 0, this._localStream = null, this._unpipeStream = function() {}, this._streamFactory = e.infileStreamFactory, this._connection = null;
		}
		then() {
			let e = "You have tried to call .then(), .catch(), or invoked await on the result of query that is not a promise, which is a programming error. Try calling con.promise().query(), or require('mysql2/promise') instead of 'mysql2' for a promise-compatible version of the query interface. To learn how to use async/await or Promises check out documentation at https://sidorares.github.io/node-mysql2/docs#using-promise-wrapper, or the mysql2 documentation at https://sidorares.github.io/node-mysql2/docs/documentation/promise-wrapper";
			throw console.log(e), Error(e);
		}
		start(t, n) {
			...
			let r = n.config.clientFlags & (n.serverCapabilityFlags || 0), i = new s.Query(this.sql, n.config.charsetNumber, this._queryOptions.attributes, r);
			return n.writePacket(i.toPacket(1)), e.prototype.resultsetHeader;
		}
		done() {
			if (this._unpipeStream(), this.timeout && !this.queryTimeout) return null;
			if (this.queryTimeout &&= (i.clearTimeout(this.queryTimeout), null), this.onResult) {
				let e, t;
				this._resultIndex === 0 ? (e = this._rows[0], t = this._fields[0]) : (e = this._rows, t = this._fields), t ? r.nextTick(() => {
		...
		doneInsert(e) {
			return this._localStreamError ? (this.onResult ? this.onResult(this._localStreamError, e) : this.emit("error", this._localStreamError), null) : (this._rows.push(e), this._fields.push(void 0), this.emit("fields", void 0), this.emit("result", e), e.serverStatus & u.SERVER_MORE_RESULTS_EXISTS ? (this._resultIndex++, this.resultsetHeader) : this.done());
		}
		resultsetHeader(e, t) {
			let n = new s.ResultSetHeader(e, t);
			return this._fieldCount = n.fieldCount, t.config.debug && console.log(`        Resultset header received, expecting ${n.fieldCount} column definition packets`), this._fieldCount === 0 ? this.doneInsert(n) : this._fieldCount === null ? this._streamLocalInfile(t, n.infileName) : (this._receivedFieldsCount = 0, this._rows.push([]), this._fields.push([]), this.readField);
		}
		_streamLocalInfile(e, t) {
			if (this._streamFactory) this._localStream = this._streamFactory(t);
			else return this._localStreamError = /* @__PURE__ */ Error(`As a result of LOCAL INFILE command server wants to read ${t} file, but as of v2.0 you must provide streamFactory option returning ReadStream.`), e.writePacket(d), this.infileOk;
			let n = () => {
				this._unpipeStream();
			}, r = () => {
				...
				let n = Buffer.allocUnsafe(t.length + 4);
				t.copy(n, 4), e.writePacket(new s.Packet(0, n, 0, n.length));
			}, o = () => {
				e.removeListener("error", n), e.writePacket(d);
			}, c = (t) => {
				this._localStreamError = t, e.removeListener("error", n), e.writePacket(d);
			};
			return this._unpipeStream = () => {
				e.stream.removeListener("pause", i), e.stream.removeListener("drain", r), this._localStream.removeListener("data", a), this._localStream.removeListener("end", o), this._localStream.removeListener("error", c);
			}, e.stream.on("pause", i), e.stream.on("drain", r), this._localStream.on("data", a), this._localStream.on("end", o), this._localStream.on("error", c), e.once("error", n), this.infileOk;
		}
		readField(t, n) {
			if (this._receivedFieldsCount++, this._fields[this._resultIndex].length !== this._fieldCount) {
				let e = new s.ColumnDefinition(t, n.clientEncoding, n._mariadbExtendedMetadata);
			...
			if (this._receivedFieldsCount === this._fieldCount) {
				let t = this._fields[this._resultIndex];
				return this.emit("fields", t), this.options.disableEval ? this._rowParser = l(t, this.options, n.config) : this._rowParser = new (c(t, this.options, n.config))(t), e.prototype.fieldsEOF;
			}
			return e.prototype.readField;
		}
		fieldsEOF(e, t) {
			return e.isEOF() ? this.row : t.protocolError("Expected EOF packet");
		}
		row(t, n) {
			if (t.isEOF()) return t.eofStatusFlags() & u.SERVER_MORE_RESULTS_EXISTS ? (this._resultIndex++, e.prototype.resultsetHeader) : this.done();
			let r;
			try {
				r = this._rowParser.next(t, this._fields[this._resultIndex], this.options);
			} catch (e) {
				return this._localStreamError = e, this.doneInsert(null);
			}
			return this.onResult ? this._rows[this._resultIndex].push(r) : this.emit("result", r, this._resultIndex), e.prototype.row;
		}
		infileOk(e, t) {
			let n = new s.ResultSetHeader(e, t);
			return this.doneInsert(n);
		}
		stream(e) {
			e ||= Object.create(null), e.objectMode = !0;
			let t = new a({
				...e,
				emitClose: !0,
				autoDestroy: !0,
			...
			t.once("close", () => {
				t.readableEnded || t.emit("end");
			});
			let n = (e, n) => {
				t.destroyed || (t.push(e) || this._connection && this._connection.pause(), t.emit("result", e, n));
			}, r = (e) => {
				t.destroyed || t.emit("fields", e);
			}, i = () => {
				t.destroyed || t.push(null);
			}, o = (e) => {
				t.destroy(e);
			};
			return t._destroy = (e, t) => {
				this._connection && this._connection.resume(), this.removeListener("result", n), this.removeListener("fields", r), this.removeListener("end", i), this.removeListener("error", o), t(e);
			}, this.on("result", n), this.on("fields", r), this.on("end", i), this.on("error", o), t;
		}
		_setTimeout() {
			if (this.timeout) {
				let e = this._handleTimeoutError.bind(this);
				this.queryTimeout = i.setTimeout(e, this.timeout);
			}
		}
		_handleTimeoutError() {
			this.queryTimeout &&= (i.clearTimeout(this.queryTimeout), null);
			let e = /* @__PURE__ */ Error("Query inactivity timeout");
	...
	f.prototype.catch = f.prototype.then, n.exports = f;
})), ut = /* @__PURE__ */ i(((e, t) => {
	var n = L(), r = I();
	t.exports = class extends n {
		...
		start(e, t) {
			return t.writePacket(new r.CloseStatement(this.id).toPacket(1)), null;
		}
	};
})), dt = /* @__PURE__ */ i(((e, t) => {
	var n = Me(), r = R(), i = A(), a = z(), o = ot(), c = s(), l = [];
	for (let e in i) l[i[e]] = e;
	function u(e, t, o, s) {
		let c = !!(o.supportBigNumbers || t.supportBigNumbers), l = !!(o.bigNumberStrings || t.bigNumberStrings), u = o.timezone || t.timezone, d = o.dateStrings || t.dateStrings, f = e.flags & n.UNSIGNED;
		if (e.extendedFormat === "json") return t.jsonStrings ? `packet.readLengthCodedString(fields[${s}].encoding)` : `packet.parseJson(fields[${s}].encoding, ${c});`;
		switch (e.columnType) {
			case i.TINY: return f ? "packet.readInt8();" : "packet.readSInt8();";
			case i.SHORT: return f ? "packet.readInt16();" : "packet.readSInt16();";
			case i.LONG:
			case i.INT24: return f ? "packet.readInt32();" : "packet.readSInt32();";
			case i.YEAR: return "packet.readInt16()";
			case i.FLOAT: return "packet.readFloat();";
			case i.DOUBLE: return "packet.readDouble();";
			case i.NULL: return "null;";
			case i.DATE:
			case i.DATETIME:
			case i.TIMESTAMP:
			case i.NEWDATE: return a.typeMatch(e.columnType, d, i) ? `packet.readDateTimeString(${parseInt(e.decimals, 10)}, null, ${e.columnType});` : `packet.readDateTime(${a.srcEscape(u)});`;
			case i.TIME: return "packet.readTimeString()";
			case i.DECIMAL:
			case i.NEWDECIMAL: return t.decimalNumbers ? "packet.parseLengthCodedFloat();" : "packet.readLengthCodedString(\"ascii\");";
			case i.GEOMETRY: return "packet.parseGeometryValue();";
			case i.VECTOR: return "packet.parseVector()";
			case i.JSON: return t.jsonStrings ? "packet.readLengthCodedString(\"utf8\")" : `packet.parseJson("utf8", ${c});`;
			case i.LONGLONG: return c ? l ? f ? "packet.readInt64String();" : "packet.readSInt64String();" : f ? "packet.readInt64();" : "packet.readSInt64();" : f ? "packet.readInt64JSNumber();" : "packet.readSInt64JSNumber();";
			default: return e.characterSet === r.BINARY ? "packet.readLengthCodedBuffer();" : `packet.readLengthCodedString(fields[${s}].encoding)`;
		}
	}
	function d(e, t, r) {
		let s = o(), c = Math.floor((e.length + 7 + 2) / 8);
		function d(e, t) {
			return {
				type: l[e.columnType],
				extendedTypeName: e.extendedTypeName,
				...
				name: e.name,
				string: function(r = e.encoding) {
					if (e.columnType === i.JSON && r === e.encoding && console.warn(`typeCast: JSON column "${e.name}" is interpreted as BINARY by default, recommended to manually set utf8 encoding: \`field.string("utf8")\``), [
						i.DATETIME,
						i.NEWDATE,
						i.TIMESTAMP,
						i.DATE
					].includes(e.columnType)) return t.readDateTimeString(parseInt(e.decimals, 10), " ", e.columnType);
					if (e.columnType === i.TINY) {
						let r = e.flags & n.UNSIGNED;
						return String(r ? t.readInt8() : t.readSInt8());
					}
					return e.columnType === i.TIME ? t.readTimeString() : t.readLengthCodedString(r);
				},
				buffer: function() {
					return t.readLengthCodedBuffer();
				},
		...
		s("(function(){"), s("return class BinaryRow {"), s("constructor() {"), s("}"), s("next(packet, fields, options) {"), t.rowsAsArray ? s(`const result = new Array(${e.length});`) : s("const result = {};"), typeof r.typeCast == "function" && typeof t.typeCast != "function" && (t.typeCast = r.typeCast), s("packet.readInt8();");
		for (let e = 0; e < c; ++e) s(`const nullBitmaskByte${e} = packet.readInt8();`);
		let f = "", p = 4, m = 0, h = "", g = "";
		for (let n = 0; n < e.length; n++) {
			if (h = a.fieldEscape(e[n].name), typeof t.nestTables == "string" ? f = `result[${a.fieldEscape(e[n].table + t.nestTables + e[n].name)}]` : t.nestTables === !0 ? (g = a.fieldEscape(e[n].table), s(`if (!result[${g}]) result[${g}] = {};`), f = `result[${g}][${h}]`) : f = t.rowsAsArray ? `result[${n.toString(10)}]` : `result[${h}]`, s(`if (nullBitmaskByte${m} & ${p}) `), s(`${f} = null;`), s("else {"), t.typeCast === !1) s(`${f} = packet.readLengthCodedBuffer();`);
			else {
				let i = `fieldWrapper${n}`;
				s(`const ${i} = wrap(fields[${n}], packet);`);
				let a = u(e[n], r, t, n);
				typeof t.typeCast == "function" ? s(`${f} = options.typeCast(${i}, function() { return ${a} });`) : s(`${f} = ${a};`);
			}
			s("}"), p *= 2, p === 256 && (p = 1, m++);
		}
		return s("return result;"), s("}"), s("};")("})()"), r.debug && a.printDebugWithCode("Compiled binary protocol row parser", s.toString()), s.toFunction({ wrap: d });
	}
	function f(e, t, n) {
		return c.getParser("binary", e, t, n, d);
	}
	t.exports = f;
})), ft = /* @__PURE__ */ i(((e, t) => {
	var n = Me(), r = R(), i = A(), a = z(), o = [];
	for (let e in i) o[i[e]] = e;
	function s(e, t, s) {
		function c(t, o, s, c, l) {
			let u = !!(s.supportBigNumbers || o.supportBigNumbers), d = !!(s.bigNumberStrings || o.bigNumberStrings), f = s.timezone || o.timezone, p = s.dateStrings || o.dateStrings, m = t.flags & n.UNSIGNED;
			if (t.extendedFormat === "json") return o.jsonStrings ? l.readLengthCodedString(t.encoding) : l.parseJson(t.encoding, u);
			switch (t.columnType) {
				case i.TINY: return m ? l.readInt8() : l.readSInt8();
				case i.SHORT: return m ? l.readInt16() : l.readSInt16();
				case i.LONG:
				case i.INT24: return m ? l.readInt32() : l.readSInt32();
				case i.YEAR: return l.readInt16();
				case i.FLOAT: return l.readFloat();
				case i.DOUBLE: return l.readDouble();
				case i.NULL: return null;
				case i.DATE:
				case i.DATETIME:
				case i.TIMESTAMP:
				case i.NEWDATE: return a.typeMatch(t.columnType, p, i) ? l.readDateTimeString(parseInt(t.decimals, 10), null, t.columnType) : l.readDateTime(f);
				case i.TIME: return l.readTimeString();
				case i.DECIMAL:
				case i.NEWDECIMAL: return o.decimalNumbers ? l.parseLengthCodedFloat() : l.readLengthCodedString("ascii");
				case i.GEOMETRY: return l.parseGeometryValue();
				case i.VECTOR: return l.parseVector();
				case i.JSON: return o.jsonStrings ? l.readLengthCodedString("utf8") : l.parseJson("utf8", u);
				case i.LONGLONG: return u ? d ? m ? l.readInt64String() : l.readSInt64String() : m ? l.readInt64() : l.readSInt64() : m ? l.readInt64JSNumber() : l.readSInt64JSNumber();
				default: return t.characterSet === r.BINARY ? l.readLengthCodedBuffer() : l.readLengthCodedString(e[c].encoding);
			}
		}
		return class {
			constructor() {}
			next(e, t, r) {
				e.readInt8();
				let l = Math.floor((t.length + 7 + 2) / 8), u = Array(l);
				for (let t = 0; t < l; t++) u[t] = e.readInt8();
				let d = r.rowsAsArray ? Array(t.length) : {}, f = 4, p = 0;
				for (let l = 0; l < t.length; l++) {
					let m = t[l], h = r.typeCast === void 0 ? s.typeCast : r.typeCast, g;
					if (u[p] & f) g = null;
					else if (r.typeCast === !1) g = e.readLengthCodedBuffer();
					else {
						let t = () => c(m, s, r, l, e);
						g = typeof h == "function" ? h({
							type: o[m.columnType],
							extendedTypeName: m.extendedTypeName,
							extendedFormat: m.extendedFormat,
							length: m.columnLength,
							db: m.schema,
							table: m.table,
							name: m.name,
							string: function(t = m.encoding) {
								if (m.columnType === i.JSON && t === m.encoding && console.warn(`typeCast: JSON column "${m.name}" is interpreted as BINARY by default, recommended to manually set utf8 encoding: \`field.string("utf8")\``), [
									i.DATETIME,
									i.NEWDATE,
									i.TIMESTAMP,
									i.DATE
								].includes(m.columnType)) return e.readDateTimeString(parseInt(m.decimals, 10), " ", m.columnType);
								if (m.columnType === i.TINY) {
									let t = m.flags & n.UNSIGNED;
									return String(t ? e.readInt8() : e.readSInt8());
								}
								return m.columnType === i.TIME ? e.readTimeString() : e.readLengthCodedString(t);
							},
							buffer: function() {
					...
					if (r.rowsAsArray) d[l] = g;
					else if (typeof r.nestTables == "string") {
						let e = a.fieldEscape(m.table + r.nestTables + m.name, !1);
						d[e] = g;
					} else if (r.nestTables === !0) {
						let e = a.fieldEscape(m.table, !1);
						d[e] || (d[e] = {});
						let t = a.fieldEscape(m.name, !1);
						d[e][t] = g;
					} else {
						let e = a.fieldEscape(m.name, !1);
						d[e] = g;
					}
					f *= 2, f === 256 && (f = 1, p++);
				}
	...
	var n = L(), r = lt(), i = I(), a = dt(), o = ft(), s = class e extends n {
		constructor(e, t) {
			super(), this.statement = e.statement, this.sql = e.sql, this.values = e.values, this.onResult = t, this.parameters = e.values, this.insertId = 0, this.timeout = e.timeout, this.queryTimeout = null, this._rows = [], this._fields = [], this._result = [], this._fieldCount = 0, this._rowParser = null, this._executeOptions = e, this._resultIndex = 0, this._localStream = null, this._unpipeStream = function() {}, this._streamFactory = e.infileStreamFactory, this._connection = null;
		}
		buildParserFromFields(e, t) {
			return this.options.disableEval ? o(e, this.options, t.config) : a(e, this.options, t.config);
		}
		start(t, n) {
			this._connection = n, this.options = Object.assign({}, n.config, this._executeOptions), this._setTimeout();
			let r = n.config.clientFlags & (n.serverCapabilityFlags || 0), a = new i.Execute(this.statement.id, this.parameters, n.config.charsetNumber, n.config.timezone, this._executeOptions.attributes, r, n._isMariaDB);
			try {
				n.writePacket(a.toPacket(1));
			} catch (e) {
				this.onResult(e);
			}
			return e.prototype.resultsetHeader;
		}
		readField(t, n) {
			let r, a = new i.ColumnDefinition(t, n.clientEncoding, n._mariadbExtendedMetadata);
			return this._receivedFieldsCount++, this._fields[this._resultIndex].push(a), this._receivedFieldsCount === this._fieldCount ? (r = this._fields[this._resultIndex], this.emit("fields", r, this._resultIndex), e.prototype.fieldsEOF) : e.prototype.readField;
		}
		fieldsEOF(t, n) {
			return t.isEOF() ? (this._rowParser = new (this.buildParserFromFields(this._fields[this._resultIndex], n))(), e.prototype.row) : n.protocolError("Expected EOF packet");
		}
	};
	s.prototype.done = r.prototype.done, s.prototype.doneInsert = r.prototype.doneInsert, s.prototype.resultsetHeader = r.prototype.resultsetHeader, s.prototype._findOrCreateReadStream = r.prototype._findOrCreateReadStream, s.prototype._streamLocalInfile = r.prototype._streamLocalInfile, s.prototype._setTimeout = r.prototype._setTimeout, s.prototype._handleTimeoutError = r.prototype._handleTimeoutError, s.prototype.row = r.prototype.row, s.prototype.stream = r.prototype.stream, t.exports = s;
})), mt = /* @__PURE__ */ i(((e, t) => {
	var n = I(), r = L(), i = ut(), a = pt(), o = class {
		constructor(e, t, n, r, i) {
			this.query = e, this.id = t, this.columns = n, this.parameters = r, this.rowParser = null, this._connection = i;
		}
		close() {
			return this._connection.addCommand(new i(this.id));
		}
		execute(e, t) {
			return typeof e == "function" && (t = e, e = []), this._connection.addCommand(new a({
				statement: this,
				values: e
			}, t));
		}
	...
	t.exports = class e extends r {
		constructor(e, t) {
			super(), this.query = e.sql, this.onResult = t, this.id = 0, this.fieldCount = 0, this.parameterCount = 0, this.fields = [], this.parameterDefinitions = [], this.options = e;
		}
		start(t, r) {
			let i = r.constructor;
			this.key = i.statementKey(this.options);
			let a = r._statements.get(this.key);
			if (a) return this.onResult && this.onResult(null, a), null;
			let o = new n.PrepareStatement(this.query, r.config.charsetNumber, this.options.values);
			return r.writePacket(o.toPacket(1)), e.prototype.prepareHeader;
		}
		prepareHeader(t, r) {
			let i = new n.PreparedStatementHeader(t);
			return this.id = i.id, this.fieldCount = i.fieldCount, this.parameterCount = i.parameterCount, this.parameterCount > 0 ? e.prototype.readParameter : this.fieldCount > 0 ? e.prototype.readField : this.prepareDone(r);
		}
		readParameter(t, r) {
			if (t.isEOF()) return this.fieldCount > 0 ? e.prototype.readField : this.prepareDone(r);
			let i = new n.ColumnDefinition(t, r.clientEncoding, r._mariadbExtendedMetadata);
			return this.parameterDefinitions.push(i), this.parameterDefinitions.length === this.parameterCount ? e.prototype.parametersEOF : this.readParameter;
		}
		readField(t, r) {
			if (t.isEOF()) return this.prepareDone(r);
			let i = new n.ColumnDefinition(t, r.clientEncoding, r._mariadbExtendedMetadata);
			return this.fields.push(i), this.fields.length === this.fieldCount ? e.prototype.fieldsEOF : e.prototype.readField;
		}
		parametersEOF(t, n) {
			return t.isEOF() ? this.fieldCount > 0 ? e.prototype.readField : this.prepareDone(n) : n.protocolError("Expected EOF packet after parameters");
		}
		fieldsEOF(e, t) {
			return e.isEOF() ? this.prepareDone(t) : t.protocolError("Expected EOF packet after fields");
		}
		prepareDone(e) {
			let t = new o(this.query, this.id, this.fields, this.parameterDefinitions, e);
			return e._statements.set(this.key, t), this.onResult && this.onResult(null, t), null;
		}
	};
})), ht = /* @__PURE__ */ i(((e, t) => {
	var n = L(), r = M(), i = j();
	t.exports = class e extends n {
		constructor(e) {
			super(), this.onResult = e;
		}
		start(t, n) {
			let a = new i(0, Buffer.from([
				1,
				0,
				0,
				0,
			...
			return n.writePacket(a), e.prototype.pingResponse;
		}
		pingResponse() {
	...
	t.exports = class e extends n {
		constructor(e, t) {
			super(), this.onResult = t, this.opts = e;
		}
		start(t, n) {
			let i = new r.RegisterSlave(this.opts);
			return n.writePacket(i.toPacket(1)), e.prototype.registerResponse;
		}
		registerResponse() {
			return this.onResult && process.nextTick(this.onResult.bind(this)), null;
		}
	...
	t.exports = function(e) {
		let t = {}, r = 0, i, a, o;
		for (; r < e.length;) switch (i = e[r++], i) {
			case n.FLAGS2:
				t.flags = e.readUInt32LE(r), r += 4;
				break;
			case n.SQL_MODE:
				t.sqlMode = e.readUInt32LE(r), r += 8;
				break;
			case n.CATALOG:
				a = e[r++], t.catalog = e.toString("utf8", r, r + a), r += a + 1;
				break;
			case n.CHARSET:
				t.clientCharset = e.readUInt16LE(r), t.connectionCollation = e.readUInt16LE(r + 2), t.serverCharset = e.readUInt16LE(r + 4), r += 6;
				break;
			case n.TIME_ZONE:
				a = e[r++], t.timeZone = e.toString("utf8", r, r + a), r += a;
				break;
			case n.CATALOG_NZ:
				a = e[r++], t.catalogNz = e.toString("utf8", r, r + a), r += a;
				break;
			case n.LC_TIME_NAMES:
				t.lcTimeNames = e.readUInt16LE(r), r += 2;
				break;
			case n.CHARSET_DATABASE:
				t.schemaCharset = e.readUInt16LE(r), r += 2;
				break;
			case n.TABLE_MAP_FOR_UPDATE:
				t.mapForUpdate1 = e.readUInt32LE(r), t.mapForUpdate2 = e.readUInt32LE(r + 4), r += 8;
				break;
			case n.MASTER_DATA_WRITTEN:
				t.masterDataWritten = e.readUInt32LE(r), r += 4;
				break;
			case n.INVOKERS:
				a = e[r++], t.invokerUsername = e.toString("utf8", r, r + a), r += a, a = e[r++], t.invokerHostname = e.toString("utf8", r, r + a), r += a;
				break;
			case n.UPDATED_DB_NAMES:
				for (a = e[r++], t.updatedDBs = []; a; --a) {
					for (o = r; e[r++] && r < e.length;);
					t.updatedDBs.push(e.toString("utf8", o, r - 1));
				}
				break;
			case n.MICROSECONDS: t.microseconds = e.readInt16LE(r) + (e[r + 2] << 16), r += 3;
		}
		return t;
	};
})), vt = /* @__PURE__ */ i(((e, t) => {
	var n = L(), r = I(), i = [], a = class {
		constructor(e) {
			this.timestamp = e.readInt32(), this.eventType = e.readInt8(), this.serverId = e.readInt32(), this.eventSize = e.readInt32(), this.logPos = e.readInt32(), this.flags = e.readInt16();
		}
	}, o = class e extends n {
		constructor(e) {
			super(), this.opts = e;
		...
		start(t, n) {
			let i = new r.BinlogDump(this.opts);
			return n.writePacket(i.toPacket(1)), e.prototype.binlogData;
		}
		binlogData(t) {
			if (t.isEOF()) return this.emit("eof"), null;
			t.readInt8();
			let n = new a(t), r = i[n.eventType], o;
			return o = r ? new r(t) : { name: "UNKNOWN" }, o.header = n, this.emit("event", o), e.prototype.binlogData;
		}
	}, s = class {
		constructor(e) {
			this.pposition = e.readInt32(), e.readInt32(), this.nextBinlog = e.readString(), this.name = "RotateEvent";
		}
	}, c = class {
		constructor(e) {
			this.binlogVersion = e.readInt16(), this.serverVersion = e.readString(50).replace(/\u0000.*/, ""), this.createTimestamp = e.readInt32(), this.eventHeaderLength = e.readInt8(), this.eventsLength = e.readBuffer(), this.name = "FormatDescriptionEvent";
		}
	}, l = class {
		constructor(e) {
			let t = _t();
			this.slaveProxyId = e.readInt32(), this.executionTime = e.readInt32();
			let n = e.readInt8();
			this.errorCode = e.readInt16();
			let r = e.readInt16(), i = e.readBuffer(r);
			this.schema = e.readString(n), e.readInt8(), this.statusVars = t(i), this.query = e.readString(), this.name = "QueryEvent";
		}
	}, u = class {
		constructor(e) {
			this.binlogVersion = e.readInt16(), this.xid = e.readInt64(), this.name = "XidEvent";
		}
	};
	i[2] = l, i[4] = s, i[15] = c, i[16] = u, t.exports = o;
})), yt = /* @__PURE__ */ i(((e, t) => {
	var n = L(), r = I(), i = N(), a = rt(), o = F(), s = class e extends n {
		constructor(e, t) {
			super(), this.onResult = t, this.user = e.user, this.password = e.password, this.password1 = e.password, this.password2 = e.password2, this.password3 = e.password3, this.database = e.database, this.passwordSha1 = e.passwordSha1, this.charsetNumber = e.charsetNumber, this.currentConfig = e.currentConfig, this.authenticationFactor = 0;
		}
		start(t, n) {
			let a = new r.ChangeUser({
			...
			return this.currentConfig.user = this.user, this.currentConfig.password = this.password, this.currentConfig.database = this.database, this.currentConfig.charsetNumber = this.charsetNumber, n.clientEncoding = o[this.charsetNumber], n._statements.clear(), n.writePacket(a.toPacket()), n.serverCapabilityFlags & i.MULTI_FACTOR_AUTHENTICATION && (this.authenticationFactor = 1), e.prototype.handshakeResult;
		}
	};
	s.prototype.handshakeResult = a.prototype.handshakeResult, s.prototype.calculateNativePasswordAuthToken = a.prototype.calculateNativePasswordAuthToken, t.exports = s;
})), bt = /* @__PURE__ */ i(((e, t) => {
	var n = L(), r = I();
	t.exports = class e extends n {
		constructor(e) {
		...
		start(t, n) {
			let i = new r.ResetConnection();
			return n.writePacket(i.toPacket()), e.prototype.resetConnectionResponse;
		}
		resetConnectionResponse(e, t) {
			return t._statements && t._statements.clear(), this.onResult && process.nextTick(this.onResult.bind(this, null)), null;
		}
	};
})), xt = /* @__PURE__ */ i(((e, t) => {
	var n = L(), r = M(), i = j();
	...
	typings: () => W,
	version: () => V
}), B, V, H, U, W, G, K, q, J, Y, X, wt, Tt, Et, Dt, Ot, kt, At, jt = n((() => {
	B = "mysql2", V = "3.23.0", H = "fast mysql driver. Implements core protocol, prepared statements, ssl and compression in native JS", U = "index.js", W = "typings/mysql/index", G = "commonjs", K = {
	...
	}, J = "https://sidorares.github.io/node-mysql2/docs", Y = [
		"mysql",
		"client",
		"server"
	], X = [
	...
	}, Tt = { node: ">= 8.0" }, Et = "Andrey Sidorov <andrey.sidorov@gmail.com>", Dt = {
	...
	var n = Mt(), r = Nt(), i = { ca: r.proxies }, a = { ca: [...n.defaults, ...r.proxies] };
	t.exports = a, t.exports.proxyBundle = i, t.exports.default = a;
})), Ft = /* @__PURE__ */ i(((e) => {
	e["Amazon RDS"] = { ca: Pt().ca };
})), It = /* @__PURE__ */ i(((n, r) => {
	var { URL: i } = t("url"), a = N(), o = R(), { version: s } = (jt(), e(Ct).default), c = null, l = {
		authPlugins: 1,
		authSwitchHandler: 1,
		bigNumberStrings: 1,
		charset: 1,
	...
	r.exports = class e {
		constructor(t) {
			if (typeof t == "string") t = e.parseUrl(t);
			else if (t && t.uri) {
				let n = e.parseUrl(t.uri);
				for (let e in n) Object.prototype.hasOwnProperty.call(n, e) && (t[e] || (t[e] = n[e]));
			}
			for (let e in t) Object.prototype.hasOwnProperty.call(t, e) && l[e] !== 1 && console.error(`Ignoring invalid configuration option passed to Connection: ${e}. This is currently a warning, but in future versions of MySQL2, an error will be thrown if you pass an invalid configuration option to a Connection`);
			if (this.isServer = t.isServer, this.stream = t.stream, this.host = t.host || "localhost", this.port = (typeof t.port == "string" ? parseInt(t.port, 10) : t.port) || 3306, this.localAddress = t.localAddress, this.socketPath = t.socketPath, this.user = t.user || void 0, this.password = t.password || t.password1 || void 0, this.password2 = t.password2 || void 0, this.password3 = t.password3 || void 0, this.passwordSha1 = t.passwordSha1 || void 0, this.database = t.database, this.connectTimeout = isNaN(t.connectTimeout) ? 10 * 1e3 : t.connectTimeout, this.insecureAuth = t.insecureAuth || !1, this.infileStreamFactory = t.infileStreamFactory || void 0, this.supportBigNumbers = t.supportBigNumbers || !1, this.bigNumberStrings = t.bigNumberStrings || !1, this.decimalNumbers = t.decimalNumbers || !1, this.dateStrings = t.dateStrings || !1, this.debug = t.debug, this.trace = t.trace !== !1, this.stringifyObjects = t.stringifyObjects || !1, this.enableKeepAlive = t.enableKeepAlive !== !1, this.keepAliveInitialDelay = t.keepAliveInitialDelay, t.timezone && !/^(?:local|Z|[ +-]\d\d:\d\d)$/.test(t.timezone) ? (console.error(`Ignoring invalid timezone passed to Connection: ${t.timezone}. This is currently a warning, but in future versions of MySQL2, an error will be thrown if you pass an invalid configuration option to a Connection`), this.timezone = "Z") : this.timezone = t.timezone || "local", this.queryFormat = t.queryFormat, this.pool = t.pool || void 0, this.ssl = typeof t.ssl == "string" ? e.getSSLProfile(t.ssl) : t.ssl || !1, this.multipleStatements = t.multipleStatements || !1, this.rowsAsArray = t.rowsAsArray || !1, this.namedPlaceholders = t.namedPlaceholders || !1, this.nestTables = t.nestTables === void 0 ? void 0 : t.nestTables, this.typeCast = t.typeCast === void 0 ? !0 : t.typeCast, this.disableEval = !!t.disableEval, this.enableCleartextPlugin = !!t.enableCleartextPlugin, this.timezone[0] === " " && (this.timezone = `+${this.timezone.slice(1)}`), this.ssl) {
				if (typeof this.ssl != "object") throw TypeError(`SSL profile must be an object, instead it's a ${typeof this.ssl}`);
				this.ssl.rejectUnauthorized = this.ssl.rejectUnauthorized !== !1;
			}
			this.maxPacketSize = 0, this.charsetNumber = t.charset ? e.getCharsetNumber(t.charset) : t.charsetNumber || o.UTF8MB4_UNICODE_CI, this.compress = t.compress || !1, this.authPlugins = t.authPlugins, this.authSwitchHandler = t.authSwitchHandler, this.clientFlags = e.mergeFlags(e.getDefaultFlags(t), t.flags || "");
			let n = {
			...
			this.connectAttributes = {
				...n,
				...t.connectAttributes || {}
			}, this.maxPreparedStatements = t.maxPreparedStatements || 16e3, this.jsonStrings = t.jsonStrings || !1, this.gracefulEnd = t.gracefulEnd || !1;
		}
		static mergeFlags(e, t) {
			let n = 0, r;
			for (r in Array.isArray(t) || (t = String(t || "").toUpperCase().split(/\s*,+\s*/)), e) t.indexOf(`-${e[r]}`) >= 0 || (n |= a[e[r]] || 0);
			for (r in t) t[r][0] !== "-" && (e.indexOf(t[r]) >= 0 || (n |= a[t[r]] || 0));
			return n;
		}
		static getDefaultFlags(e) {
			let t = [
				"LONG_PASSWORD",
				"FOUND_ROWS",
				"LONG_FLAG",
			...
			return e && e.multipleStatements && t.push("MULTI_STATEMENTS"), t.push("PLUGIN_AUTH"), t.push("PLUGIN_AUTH_LENENC_CLIENT_DATA"), t;
		}
		static getCharsetNumber(e) {
			let t = o[e.toUpperCase()];
			if (t === void 0) throw TypeError(`Unknown charset '${e}'`);
			return t;
		}
		static getSSLProfile(e) {
			c ||= Ft();
			let t = c[e];
			if (t === void 0) throw TypeError(`Unknown SSL profile '${e}'`);
			return t;
		}
		static parseUrl(e) {
			let t = new i(e), n = {
			...
			for (let [e, r] of t.searchParams) if (!(e in n)) try {
				n[e] = JSON.parse(r);
			} catch {
				n[e] = r;
			}
	...
	var r = t("process"), i = (() => {
		try {
			return "getBuiltinModule" in r ? r.getBuiltinModule("node:diagnostics_channel") : t("node:diagnostics_channel");
		} catch {
			return;
		}
	})(), a = typeof i?.tracingChannel == "function", o = a ? i.tracingChannel("mysql2:query") : void 0, s = a ? i.tracingChannel("mysql2:execute") : void 0, c = a ? i.tracingChannel("mysql2:connect") : void 0, l = a ? i.tracingChannel("mysql2:pool:connect") : void 0;
	function u(e) {
		return e.socketPath ? {
			serverAddress: e.socketPath,
			serverPort: void 0
		} : {
			serverAddress: e.host || "localhost",
			serverPort: e.port || 3306
		};
	}
	function d(e) {
		return e == null ? !1 : e.hasSubscribers ?? e.start?.hasSubscribers ?? !1;
	}
	function f(e, t, n, r, i, ...a) {
		return d(e) ? e.traceCallback(t, n, r(), i, ...a) : t.apply(i, a);
	}
	function p(e, t, n) {
		return d(e) ? e.tracePromise(t, n()) : t();
	}
	n.exports = {
		dc: i,
		hasTracingChannel: a,
		...
		executeChannel: s,
		connectChannel: c,
		poolConnectChannel: l,
		getServerContext: u,
		traceCallback: f,
		tracePromise: p
	};
})), Rt = /* @__PURE__ */ i(((e, t) => {
	var n = /(?:\?)|(?::(\d+|(?:[a-zA-Z][a-zA-Z0-9_]*)))/g, r = 34, i = 39, a = 92;
	function s(e) {
		let t = n.exec(e), o = 0, s = 0, c, l = [], u = !1, d = !1, f, p = [], m = 0, h = 0, g;
		if (t) {
			do {
				for (g = o, c = t.index; g < c; ++g) {
					let t = e.charCodeAt(g);
					if (t === a) d = !d;
					else {
						if (d) {
							d = !1;
						...
						if (u && t === f) {
							if (e.charCodeAt(g + 1) === f) {
								++g;
								continue;
							}
							u = !1;
						} else !u && (t === r || t === i) && (u = !0, f = t);
					}
				}
				u || (l.push(e.substring(s, c)), p.push(t[0].length === 1 ? m++ : t[1]), s = c + t[0].length, h = s), o = c + t[0].length;
			} while (t = n.exec(e));
			if (p.length) return o < e.length && l.push(e.substring(h)), [l, p];
		}
		return [e];
	}
	function c(e) {
		e ||= {}, e.placeholder ||= "?";
		let t = 100, n;
		typeof e.cache == "number" && (t = e.cache), typeof e.cache == "object" && (n = e.cache), e.cache !== !1 && !n && (n = o().createLRU({ max: t }));
		function r(e, t) {
			let n = [];
			if (e.length === 1) return [e[0], []];
			if (t === void 0) throw Error("Named query contains placeholders, but parameters object is undefined");
			let r = e[1];
		...
		function a(t) {
			...
			let n = i(t[0][0]);
			for (let r = 1; r < t[0].length; ++r) t[0][r - 1].slice(-1) === ":" && (n += e.placeholder), n += e.placeholder, n += i(t[0][r]);
			let r = t[0][t[0].length - 1];
			return t[0].length === t[1].length && (r.slice(-1) === ":" && (n += e.placeholder), n += e.placeholder), [n, t[1]];
		}
		function c(e, t) {
			let i;
			return n && (i = n.get(e)) ? r(i, t) : (i = a(s(e)), n && n.set(e, i), r(i, t));
		}
		return c.parse = s, c;
	}
	function l(e, t) {
		let n = s(e), r = [];
		if (n.length === 1) return [n[0], r];
		let i = {}, a = 0, o = "", c, l = [];
		for (let e = 0; e < n[0].length; ++e) c = i[n[1][e]], c || (c = ++a, i[n[1][e]] = c), n[1][e] ? (l[c - 1] = n[1][e], o += `${n[0][e]}$${c}`) : o += n[0][e];
		return [o, l.map((e) => t[e])];
	}
	t.exports = c, t.exports.toNumbered = l;
})), zt = /* @__PURE__ */ i(((e, n) => {
	var r = t("net"), i = t("tls"), s = t("timers"), l = t("events").EventEmitter, u = t("stream").Readable, d = c(), f = a(), { createLRU: p } = o(), m = Ce(), h = I(), g = St(), _ = It(), v = F(), { traceCallback: y, tracePromise: b, getServerContext: x, shouldTrace: S, queryChannel: C, executeChannel: w, connectChannel: T } = Lt(), E = 0, D = null;
	n.exports = class e extends l {
		constructor(e) {
			super(), this.config = e.config, e.config.stream ? typeof e.config.stream == "function" ? this.stream = e.config.stream(e) : this.stream = e.config.stream : e.config.socketPath ? this.stream = r.connect(e.config.socketPath) : (this.stream = r.connect(e.config.port, e.config.host), this.config.enableKeepAlive && this.stream.on("connect", () => {
				this.stream.setKeepAlive(!0, this.config.keepAliveInitialDelay);
			}), this.stream.setNoDelay(!0)), this._internalId = E++, this._commands = new d(), this._command = null, this._paused = !1, this._paused_packets = new d(), this._statements = p({
				max: this.config.maxPreparedStatements,
				onEviction: function(e, t) {
					t.close();
				}
			}), this.serverCapabilityFlags = 0, this._isMariaDB = !1, this._mariadbExtendedMetadata = !1, this.authorized = !1, this.sequenceId = 0, this.compressedSequenceId = 0, this.threadId = null, this._handshakePacket = null, this._fatalError = null, this._protocolError = null, this._outOfOrderPackets = [], this.clientEncoding = v[this.config.charsetNumber], this.stream.on("error", this._handleNetworkError.bind(this)), this.packetParser = new m((e) => {
				this.handlePacket(e);
			}), this.stream.on("data", (e) => {
				this.connectTimeout &&= (s.clearTimeout(this.connectTimeout), null), this.packetParser.execute(e);
			}), this.stream.on("end", () => {
				this.emit("end");
			}), this.stream.on("close", () => {
				this._closing || (this._protocolError || (this._protocolError = /* @__PURE__ */ Error("Connection lost: The server closed the connection."), this._protocolError.fatal = !0, this._protocolError.code = "PROTOCOL_CONNECTION_LOST"), this._notifyError(this._protocolError));
			});
			let t;
			if (!this.config.isServer && (t = new g.ClientHandshake(this.config.clientFlags), t.on("end", () => {
				!t.handshake || this._fatalError || this._protocolError || (this._handshakePacket = t.handshake, this.threadId = t.handshake.connectionId, this.emit("connect", t.handshake));
			}), t.on("error", (e) => {
				this._closing = !0, this._notifyError(e);
			}), this.addCommand(t), S(T))) {
				let e = this.config;
				b(T, () => new Promise((e, t) => {
					let n, r;
					n = (t) => {
						this.removeListener("error", r), e(t);
					}, r = (e) => {
						this.removeListener("connect", n), t(e);
					}, this.once("connect", n), this.once("error", r);
				}), () => {
					let t = x(e);
					return {
						database: e.database || "",
			...
			if (this.serverEncoding = "utf8", this.config.connectTimeout) {
				let e = this._handleTimeoutError.bind(this);
				this.connectTimeout = s.setTimeout(e, this.config.connectTimeout);
			}
		}
		_addCommandClosedState(e) {
			let t = /* @__PURE__ */ Error("Can't add new command when connection is in closed state");
			t.fatal = !0, e.onResult ? e.onResult(t) : this.emit("error", t);
		}
		_handleFatalError(e) {
			e.fatal = !0, this.stream.removeAllListeners("data"), this.addCommand = this._addCommandClosedState, this.write = () => {
				this.emit("error", /* @__PURE__ */ Error("Can't write in closed state"));
			}, this._notifyError(e), this._fatalError = e;
		}
		_handleNetworkError(e) {
			this.connectTimeout &&= (s.clearTimeout(this.connectTimeout), null), !(e.code === "ECONNRESET" && this._closing) && this._handleFatalError(e);
		}
		_handleTimeoutError() {
			this.connectTimeout &&= (s.clearTimeout(this.connectTimeout), null), this.stream.destroy && this.stream.destroy();
			let e = /* @__PURE__ */ Error("connect ETIMEDOUT");
			e.errorno = "ETIMEDOUT", e.code = "ETIMEDOUT", e.syscall = "connect", this._handleNetworkError(e);
		}
		_notifyError(e) {
			if (this.connectTimeout &&= (s.clearTimeout(this.connectTimeout), null), this._fatalError) return;
			let t, n = !this._command;
			for (this._command && this._command.onResult ? (this._command.onResult(e), this._command = null) : this._command && this._command.constructor === g.ClientHandshake && this._commands.length > 0 || (n = !0); t = this._commands.shift();) t.onResult ? t.onResult(e) : n = !0;
			(n || this._pool) && this.emit("error", e), e.fatal && this.close();
		}
		write(e) {
			this.stream.write(e, (e) => {
		...
		_bumpCompressedSequenceId(e) {
			this.compressedSequenceId += e, this.compressedSequenceId %= 256;
		}
		_bumpSequenceId(e) {
			this.sequenceId += e, this.sequenceId %= 256;
		}
		writePacket(e) {
			let t = 16777215, n = e.length(), r, i, a;
			if (n < t) e.writeHeader(this.sequenceId), this.config.debug && (console.log(`${this._internalId} ${this.connectionId} <== ${this._command._commandName}#${this._command.stateName()}(${[
				this.sequenceId,
				e._name,
				e.length()
			].join(",")})`), console.log(`${this._internalId} ${this.connectionId} <== ${e.buffer.toString("hex")}`)), this._bumpSequenceId(1), this.write(e.buffer);
			else for (this.config.debug && (console.log(`${this._internalId} ${this.connectionId} <== Writing large packet, raw content not written:`), console.log(`${this._internalId} ${this.connectionId} <== ${this._command._commandName}#${this._command.stateName()}(${[
				this.sequenceId,
				e._name,
				e.length()
			].join(",")})`)), i = 4; i < 4 + n; i += t) r = e.buffer.slice(i, i + t), a = r.length === t ? Buffer.from([
				255,
				255,
				255,
				this.sequenceId
				...
				r.length >> 16 & 255,
				this.sequenceId
			]), this._bumpSequenceId(1), this.write(a), this.write(r);
		}
		startTLS(e) {
			this.config.debug && console.log("Upgrading connection to TLS");
			let t = i.createSecureContext({
			...
			}), n = this.config.ssl.rejectUnauthorized, a = this.config.ssl.verifyIdentity, o = r.isIP(this.config.host) ? void 0 : this.config.host, s = !1;
			this.stream.removeAllListeners("data");
			let c = i.connect({
				rejectUnauthorized: n,
				requestCert: n,
				checkServerIdentity: a ? i.checkServerIdentity : function() {},
				secureContext: t,
				isServer: !1,
				socket: this.stream,
				servername: o
			}, () => {
				if (s = !0, n && typeof o == "string" && a) {
					let t = c.getPeerCertificate(!0), n = i.checkServerIdentity(o, t);
					if (n) {
						e(n);
						return;
					}
			...
			c.on("error", (t) => {
				s ? this._handleNetworkError(t) : e(t);
			}), c.on("data", (e) => {
				this.packetParser.execute(e);
			}), this.stream = c;
		}
		protocolError(e, t) {
			if (this._closing) return;
			let n = Error(e);
			n.fatal = !0, n.code = t || "PROTOCOL_ERROR", this.emit("error", n);
		}
		get state() {
		...
		handlePacket(e) {
			if (this._paused) {
				this._paused_packets.push(e);
				return;
			}
			if (this.config.debug && e) {
				console.log(` raw: ${e.buffer.slice(e.offset, e.offset + e.length()).toString("hex")}`), console.trace();
				let t = this._command ? this._command._commandName : "(no command)", n = this._command ? this._command.stateName() : "(no command)";
				console.log(`${this._internalId} ${this.connectionId} ==> ${t}#${n}(${[
					e.sequenceId,
					e.type(),
					e.length()
				].join(",")})`);
			...
			if (!this._command) {
				if (e.peekByte() === 255) {
					let t = h.Error.fromPacket(e);
					this.protocolError(t.message, t.code);
			...
			if (e) {
				if (this.sequenceId !== e.sequenceId) {
					let t = /* @__PURE__ */ Error(`Warning: got packets out of order. Expected ${this.sequenceId} but received ${e.sequenceId}`);
					t.expected = this.sequenceId, t.received = e.sequenceId, this.emit("warn", t), console.error(t.message);
				}
				this._bumpSequenceId(e.numPackets);
			}
			try {
				if (this._fatalError) return;
				this._command.execute(e, this) && (this._command = this._commands.shift(), this._command && (this.sequenceId = 0, this.compressedSequenceId = 0, this.handlePacket()));
			} catch (e) {
				this._handleFatalError(e), this.stream.destroy();
			}
		}
		addCommand(e) {
			if (this.config.debug) {
				let t = e.constructor.name;
				console.log(`Add command: ${t}`), e._commandName = t;
			}
			return this._command ? this._commands.push(e) : (this._command = e, this.handlePacket()), e;
		}
		format(e, t) {
			if (typeof this.config.queryFormat == "function") return this.config.queryFormat.call(this, e, t, this.config.timezone);
			let n = {
				sql: e,
				values: t
			};
			return this._resolveNamedPlaceholders(n), f.format(n.sql, n.values, this.config.stringifyObjects, this.config.timezone);
		}
		escape(e) {
			return f.escape(e, !1, this.config.timezone);
		}
		escapeId(e) {
			return f.escapeId(e, !1);
		}
		raw(e) {
			return f.raw(e);
		}
		_resolveNamedPlaceholders(e) {
			let t;
			if (this.config.namedPlaceholders || e.namedPlaceholders) {
				if (Array.isArray(e.values)) return;
				D === null && (D = Rt()()), t = D(e.sql, e.values), e.sql = t[0], e.values = t[1];
			}
		}
		query(t, n, r) {
			let i;
			i = t.constructor === g.Query ? t : e.createQuery(t, n, r, this.config), this._resolveNamedPlaceholders(i);
			let a = this.format(i.sql, i.values === void 0 ? [] : i.values);
			return i.sql = a, i.onResult ? y(C, (e) => {
				i.onResult = e, this.addCommand(i);
			}, 0, () => {
				let e = x(this.config);
				return {
					query: i.sql,
			...
			}, null, i.onResult) : S(C) ? b(C, () => new Promise((e, t) => {
				i.once("error", t), i.once("end", () => e()), this.addCommand(i);
			}), () => {
				let e = x(this.config);
				return {
					query: i.sql,
		...
		resume() {
			let e;
			for (this._paused = !1; e = this._paused_packets.shift();) if (this.handlePacket(e), this._paused) return;
			this.stream.resume();
		}
		prepare(e, t) {
			return typeof e == "string" && (e = { sql: e }), this.addCommand(new g.Prepare(e, t));
		}
		unprepare(t) {
			let n = {};
			typeof t == "object" ? n = t : n.sql = t;
			let r = e.statementKey(n), i = this._statements.get(r);
			return i && (this._statements.delete(r), i.close()), i;
		}
		execute(e, t, n) {
			let r = { infileStreamFactory: this.config.infileStreamFactory };
			if (typeof e == "object" ? (r = {
				...r,
				...e,
				sql: e.sql,
				values: e.values
			}, typeof t == "function" ? n = t : r.values = r.values || t) : typeof t == "function" ? (n = t, r.sql = e, r.values = void 0) : (r.sql = e, r.values = t), this._resolveNamedPlaceholders(r), r.values) {
				if (!Array.isArray(r.values)) throw TypeError("Bind parameters must be array if namedPlaceholders parameter is not enabled");
				r.values.forEach((e) => {
					if (!Array.isArray(r.values)) throw TypeError("Bind parameters must be array if namedPlaceholders parameter is not enabled");
					if (e === void 0) throw TypeError("Bind parameters must not contain undefined. To pass SQL NULL specify JS null");
					if (typeof e == "function") throw TypeError("Bind parameters must not contain function(s). To pass the body of a function as a string call .toString() first");
				});
			}
			let i = new g.Execute(r, n), a = (e) => {
				let t = new g.Prepare(r, (t, n) => {
					if (t) {
						i.start = function() {
							return null;
						}, e(t), i.emit("end");
				...
				this.addCommand(t), this.addCommand(i);
			};
			if (i.onResult) {
				let e = i.onResult;
				y(w, (e) => {
			...
			} else S(w) ? b(w, () => new Promise((e, t) => {
				a((e) => {
					i.emit("error", e);
				}), i.once("error", t), i.once("end", () => e());
			}), () => {
				let e = x(this.config);
				return {
					query: r.sql,
		...
		changeUser(e, t) {
			...
			let n = e.charset ? _.getCharsetNumber(e.charset) : this.config.charsetNumber;
			return this.addCommand(new g.ChangeUser({
				user: e.user || this.config.user,
				password: e.password || e.password1 || this.config.password || this.config.password1,
				password2: e.password2 || this.config.password2,
				password3: e.password3 || this.config.password3,
				passwordSha1: e.passwordSha1 || this.config.passwordSha1,
		...
		beginTransaction(e) {
			return this.query("START TRANSACTION", e);
		}
		commit(e) {
			return this.query("COMMIT", e);
		}
		rollback(e) {
			return this.query("ROLLBACK", e);
		}
		ping(e) {
			return this.addCommand(new g.Ping(e));
		}
		reset(e) {
			return this.addCommand(new g.ResetConnection(e));
		}
		_registerSlave(e, t) {
			return this.addCommand(new g.RegisterSlave(e, t));
		}
		_binlogDump(e, t) {
			return this.addCommand(new g.BinlogDump(e, t));
		}
		destroy() {
			this.close();
		}
		close() {
			this.connectTimeout &&= (s.clearTimeout(this.connectTimeout), null), this._closing = !0, this.stream.end(), this.addCommand = this._addCommandClosedState;
		}
		createBinlogStream(e) {
			let t = 1, n = new u({ objectMode: !0 });
			return n._read = function() {
				return { data: t++ };
			}, this._registerSlave(e, () => {
				let t = this._binlogDump(e);
				t.on("event", (e) => {
					n.push(e);
				}), t.on("eof", () => {
					n.push(null), e.flags && e.flags & 1 && this.close();
				});
			}), n;
		}
		connect(e) {
			if (!e) return;
			if (this._fatalError || this._protocolError) return e(this._fatalError || this._protocolError);
			if (this._handshakePacket) return e(null, this);
			let t, n;
			t = (t) => {
				this.removeListener("connect", n), e(t);
			}, n = (n) => {
				this.removeListener("error", t), e(null, n);
			}, this.once("error", t), this.once("connect", n);
		}
		writeColumns(e) {
			this.writePacket(h.ResultSetHeader.toPacket(e.length)), e.forEach((e) => {
				this.writePacket(h.ColumnDefinition.toPacket(e, this.serverConfig.encoding));
			}), this.writeEof();
		}
		writeTextRow(e) {
			this.writePacket(h.TextRow.toPacket(e, this.serverConfig.encoding));
		}
		writeBinaryRow(e) {
			this.writePacket(h.BinaryRow.toPacket(e, this.serverConfig.encoding));
		}
		writeTextResult(e, t, n = !1) {
			this.writeColumns(t), e.forEach((e) => {
				let r = Array(t.length);
				t.forEach((t) => {
					r.push(e[t.name]);
				}), n ? this.writeBinaryRow(r) : this.writeTextRow(r);
			}), this.writeEof();
		}
		writeEof(e, t) {
			this.writePacket(h.EOF.toPacket(e, t));
		}
		writeOk(e) {
			e ||= { affectedRows: 0 }, this.writePacket(h.OK.toPacket(e, this.serverConfig.encoding));
		}
		writeError(e) {
			let t = this.serverConfig ? this.serverConfig.encoding : "cesu8";
			this.writePacket(h.Error.toPacket(e, t));
		}
		serverHandshake(e) {
			return this.serverConfig = e, this.serverConfig.encoding = v[this.serverConfig.characterSet], this.addCommand(new g.ServerHandshake(e));
		}
		[Symbol.dispose]() {
			this._closing || this.end();
		}
		end(e) {
			...
			let t = this.addCommand(new g.Quit(e));
			return this.addCommand = this._addCommandClosedState, t;
		}
		static createQuery(e, t, n, r) {
			let i = {
				rowsAsArray: r.rowsAsArray,
				infileStreamFactory: r.infileStreamFactory
			};
			return typeof e == "object" ? (i = {
				...i,
				...e,
				sql: e.sql,
				values: e.values
			}, typeof t == "function" ? n = t : t !== void 0 && (i.values = t)) : typeof t == "function" ? (n = t, i.sql = e, i.values = void 0) : (i.sql = e, i.values = t), new g.Query(i, n);
		}
		static statementKey(e) {
			return `${typeof e.nestTables}/${e.nestTables}/${e.rowsAsArray}${e.sql}`;
		}
	};
})), Z = /* @__PURE__ */ i(((e, t) => {
	function n(e) {
		let t = {};
		return Error.captureStackTrace(t, e), t;
	}
	function r(e, t) {
		let n = t && t.stack;
		if (typeof n != "string" || !n) return;
		let r = n.split("\n");
		r[0] = `${e.name}: ${e.message}`, e.stack = r.join("\n");
	}
	t.exports = {
		captureStackHolder: n,
		applyCapturedStack: r
	};
})), Q = /* @__PURE__ */ i(((e, t) => {
	var { applyCapturedStack: n } = Z();
	function r(e, t, r) {
	...
	var { captureStackHolder: n } = Z(), r = Q();
	t.exports = class e {
		constructor(e, t) {
			this.statement = e, this.Promise = t;
		}
		execute(t) {
			let i = this.statement, a = n(e.prototype.execute);
			return new this.Promise((e, n) => {
				let o = r(e, n, a);
				t ? i.execute(t, o) : i.execute(o);
			});
		}
		close() {
			return new this.Promise((e) => {
				this.statement.close(), e();
			});
		}
	};
})), Vt = /* @__PURE__ */ i(((e, t) => {
	function n(e, t, n) {
		let r = {};
		t.on("newListener", (i) => {
			n.indexOf(i) >= 0 && !t.listenerCount(i) && e.on(i, r[i] = function() {
				let e = [].slice.call(arguments);
				e.unshift(i), t.emit.apply(t, e);
			});
		}).on("removeListener", (i) => {
			n.indexOf(i) >= 0 && !t.listenerCount(i) && (e.removeListener(i, r[i]), delete r[i]);
		});
	}
	t.exports = n;
})), Ht = /* @__PURE__ */ i(((e, n) => {
	var r = t("events").EventEmitter, i = Bt(), { captureStackHolder: a, applyCapturedStack: o } = Z(), s = Q(), c = Vt(), l = zt(), u = class e extends r {
		constructor(e, t) {
			super(), this.connection = e, this.Promise = t || Promise, c(e, this, [
				"error",
				"drain",
				"connect",
				"end",
		...
		query(t, n) {
			let r = this.connection, i = a(e.prototype.query);
			if (typeof n == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, a) => {
				let o = s(e, a, i);
				n === void 0 ? r.query(t, o) : r.query(t, n, o);
			});
		}
		execute(t, n) {
			let r = this.connection, i = a(e.prototype.execute);
			if (typeof n == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, a) => {
				let o = s(e, a, i);
				n === void 0 ? r.execute(t, o) : r.execute(t, n, o);
			});
		}
		end() {
			return new this.Promise((e) => {
		...
		async [Symbol.asyncDispose]() {
			this.connection._closing || await this.end();
		}
		beginTransaction() {
			let t = this.connection, n = a(e.prototype.beginTransaction);
			return new this.Promise((e, r) => {
				let i = s(e, r, n);
				t.beginTransaction(i);
			});
		}
		commit() {
			let t = this.connection, n = a(e.prototype.commit);
			return new this.Promise((e, r) => {
				let i = s(e, r, n);
				t.commit(i);
			});
		...
		rollback() {
			let t = this.connection, n = a(e.prototype.rollback);
			return new this.Promise((e, r) => {
				let i = s(e, r, n);
				t.rollback(i);
			});
		...
		ping() {
			let t = this.connection, n = a(e.prototype.ping);
			return new this.Promise((e, r) => {
				t.ping((t) => {
					t ? (o(t, n), r(t)) : e(!0);
				});
		...
		reset() {
			let t = this.connection, n = a(e.prototype.reset);
			return new this.Promise((e, r) => {
				t.reset((t) => {
					t ? (o(t, n), r(t)) : e();
				});
		...
		connect() {
			let t = this.connection, n = a(e.prototype.connect);
			return new this.Promise((e, r) => {
				t.connect((t, i) => {
					t ? (o(t, n), r(t)) : e(i);
				});
		...
		prepare(t) {
			let n = this.connection, r = this.Promise, s = a(e.prototype.prepare);
			return new this.Promise((e, a) => {
				n.prepare(t, (t, n) => {
					t ? (o(t, s), a(t)) : e(new i(n, r));
				});
			});
		}
		changeUser(t) {
			let n = this.connection, r = a(e.prototype.changeUser);
			return new this.Promise((e, i) => {
				n.changeUser(t, (t) => {
					t ? (o(t, r), i(t)) : e();
				});
			});
	...
	(function(e) {
		for (let t = 0; e && t < e.length; t++) {
			let n = e[t];
			typeof l.prototype[n] == "function" && u.prototype[n] === void 0 && (u.prototype[n] = (function(e) {
				return function() {
					return l.prototype[e].apply(this.connection, arguments);
				};
			})(n));
		}
	})([
	...
	var n = Ut(), r = class extends n {
		constructor(e, t) {
			super(t), this._pool = e, this._released = !1, this.lastActiveTime = Date.now(), this.once("end", () => {
		...
		release() {
			this._released || !this._pool || this._pool._closed || (this._released = !0, this.lastActiveTime = Date.now(), this._pool.releaseConnection(this));
		}
		[Symbol.dispose]() {
			this.release();
		}
			...
			if (this.config.gracefulEnd) {
				this._removeFromPool(), super.end(e);
				return;
			}
			let t = /* @__PURE__ */ Error("Calling conn.end() to release a pooled connection is deprecated. In next version calling conn.end() will be restored to default conn.end() behavior. Use conn.release() instead.");
			this.emit("warn", t), console.warn(t.message), this.release(), typeof e == "function" && e();
		}
		destroy() {
		...
		_removeFromPool() {
			...
			let e = this._pool;
			this._pool = null, e._removeConnection(this);
		}
		promise(e) {
			return new ($())(this, e);
		}
	};
	r.statementKey = n.statementKey, t.exports = r, r.prototype._realEnd = n.prototype.end;
})), Gt = /* @__PURE__ */ i(((e, n) => {
	var r = t("process"), i = a(), o = t("events").EventEmitter, s = Wt(), u = c(), d = zt(), f = l(), { traceCallback: p, getServerContext: m, poolConnectChannel: h } = Lt();
	function g(e) {
		return !e || !e.errno ? !1 : e.errno === f.ER_OPTION_PREVENTS_STATEMENT || e.errno === f.ER_CANT_EXECUTE_IN_READ_ONLY_TRANSACTION || e.errno === f.ER_READ_ONLY_MODE;
	}
	function _(e, t) {
		let n = e.length;
		for (let r = 0; r < n; r++) if (e.get(r) === t) {
			e.removeOne(r);
			break;
		}
	}
	n.exports = class extends o {
		constructor(e) {
			super(), this.config = e.config, this.config.connectionConfig.pool = this, this._allConnections = new u(), this._freeConnections = new u(), this._connectionQueue = new u(), this._closed = !1, this.config.maxIdle < this.config.connectionLimit && this._removeIdleTimeoutConnections();
		}
		getConnection(e) {
			let t = (e) => {
				if (this._closed) return r.nextTick(() => e(/* @__PURE__ */ Error("Pool is closed.")));
				let t;
				return this._freeConnections.length > 0 ? (t = this._freeConnections.pop(), this.emit("acquire", t), r.nextTick(() => {
					t._released = !1, e(null, t);
				})) : this.config.connectionLimit === 0 || this._allConnections.length < this.config.connectionLimit ? (t = new s(this, { config: this.config.connectionConfig }), this._allConnections.push(t), t.connect((n) => this._closed ? e(/* @__PURE__ */ Error("Pool is closed.")) : n ? e(n) : (this.emit("connection", t), this.emit("acquire", t), e(null, t)))) : this.config.waitForConnections ? this.config.queueLimit && this._connectionQueue.length >= this.config.queueLimit ? e(/* @__PURE__ */ Error("Queue limit reached.")) : (this.emit("enqueue"), this._connectionQueue.push(e)) : r.nextTick(() => e(/* @__PURE__ */ Error("No connections available.")));
			}, n = this.config.connectionConfig;
			p(h, t, 0, () => {
				let e = m(n);
				return {
					database: n.database || "",
		...
		releaseConnection(e) {
			let t;
			if (!e._pool) {
				this._connectionQueue.length && (t = this._connectionQueue.shift(), r.nextTick(this.getConnection.bind(this, t)));
				return;
			}
			this.config.resetOnRelease && e.reset ? e.reset((n) => {
				if (n) {
					e._pool = null, _(this._allConnections, e), e.destroy(), this._connectionQueue.length && (t = this._connectionQueue.shift(), r.nextTick(this.getConnection.bind(this, t)));
					return;
				}
				this._handleSuccessfulRelease(e);
			}) : this._handleSuccessfulRelease(e);
		}
		_handleSuccessfulRelease(e) {
			let t;
			this._connectionQueue.length ? (t = this._connectionQueue.shift(), r.nextTick(() => {
				e._released = !1, t(null, e);
			})) : (this._freeConnections.push(e), this.emit("release", e));
		}
		[Symbol.dispose]() {
			this._closed || this.end();
		}
		end(e) {
			for (this._closed = !0, clearTimeout(this._removeIdleTimeoutConnectionsTimer), typeof e != "function" && (e = function(e) {
				if (e) throw e;
			}); this._connectionQueue.length > 0;) {
				let e = this._connectionQueue.shift();
				r.nextTick(() => e(/* @__PURE__ */ Error("Pool is closed.")));
			}
			let t = !1, n = 0, i, a = function(r) {
				if (!t && (r || ++n >= this._allConnections.length)) {
					t = !0, e(r);
					return;
				}
			}.bind(this);
			...
			for (let e = 0; e < this._allConnections.length; e++) i = this._allConnections.get(e), i._realEnd(a);
		}
		query(e, t, n) {
			let r = d.createQuery(e, t, n, this.config.connectionConfig);
			return r.namedPlaceholders === void 0 && (r.namedPlaceholders = this.config.connectionConfig.namedPlaceholders), this.getConnection((e, t) => {
				if (e) {
					typeof r.onResult == "function" ? r.onResult(e) : r.emit("error", e);
					return;
				}
				try {
					let e = null, n = r.onResult;
					n ? r.onResult = function(t, r, i) {
						e = t || null, n(t, r, i);
					} : r.once("error", (t) => {
						e = t;
					}), t.query(r).once("end", () => {
						g(e) ? t.destroy() : t.release();
					});
				} catch (e) {
					throw t.release(), e;
				}
		...
		execute(e, t, n) {
			typeof t == "function" && (n = t, t = []), this.getConnection((r, i) => {
				if (r) return n(r);
				try {
					i.execute(e, t, (e, t, r) => {
						g(e) && i.destroy(), n(e, t, r);
					}).once("end", () => {
						i.release();
					});
				} catch (e) {
					return i.release(), n(e);
				}
			});
		}
		_removeConnection(e) {
			_(this._allConnections, e), _(this._freeConnections, e), this.releaseConnection(e);
		}
		_removeIdleTimeoutConnections() {
			this._removeIdleTimeoutConnectionsTimer && clearTimeout(this._removeIdleTimeoutConnectionsTimer), this._removeIdleTimeoutConnectionsTimer = setTimeout(() => {
				try {
					for (; this._freeConnections.length > this.config.maxIdle || this._freeConnections.length > 0 && Date.now() - this._freeConnections.get(0).lastActiveTime > this.config.idleTimeout;) this.config.connectionConfig.gracefulEnd ? this._freeConnections.get(0).end() : this._freeConnections.get(0).destroy();
				} finally {
		...
		format(e, t) {
			return i.format(e, t, this.config.connectionConfig.stringifyObjects, this.config.connectionConfig.timezone);
		}
		escape(e) {
	...
	var r = t("events").EventEmitter, { captureStackHolder: i, applyCapturedStack: a } = Z(), o = Q(), s = $(), c = Vt(), l = Gt(), u = class e extends r {
		constructor(e, t) {
			super(), this.pool = e, this.Promise = t || Promise, c(e, this, [
				"acquire",
				"connection",
				"enqueue",
				"release"
		...
		getConnection() {
			...
			return new this.Promise((t, n) => {
				e.getConnection((e, r) => {
					e ? n(e) : t(new s(r, this.Promise));
				});
			});
		}
		releaseConnection(e) {
			e instanceof s && e.release();
		}
		query(t, n) {
			let r = this.pool, a = i(e.prototype.query);
			if (typeof n == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, i) => {
				let s = o(e, i, a);
				n === void 0 ? r.query(t, s) : r.query(t, n, s);
			});
		}
		execute(t, n) {
			let r = this.pool, a = i(e.prototype.execute);
			if (typeof n == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, i) => {
				let s = o(e, i, a);
				n ? r.execute(t, n, s) : r.execute(t, s);
			});
		}
		end() {
			let t = this.pool, n = i(e.prototype.end);
			return new this.Promise((e, r) => {
				t.end((t) => {
					t ? (a(t, n), r(t)) : e();
				});
		...
		async [Symbol.asyncDispose]() {
			this.pool._closed || await this.end();
		}
	};
	(function(e) {
		for (let t = 0; e && t < e.length; t++) {
			...
			typeof l.prototype[n] == "function" && u.prototype[n] === void 0 && (u.prototype[n] = (function(e) {
				return function() {
					return l.prototype[e].apply(this.pool, arguments);
				};
			})(n));
		}
	})([
	...
	t.exports = class {
		constructor(e) {
			typeof e == "string" && (e = n.parseUrl(e)), this.connectionConfig = new n(e), this.waitForConnections = e.waitForConnections === void 0 ? !0 : !!e.waitForConnections, this.connectionLimit = isNaN(e.connectionLimit) ? 10 : Number(e.connectionLimit), this.maxIdle = isNaN(e.maxIdle) ? this.connectionLimit : Number(e.maxIdle), this.idleTimeout = isNaN(e.idleTimeout) ? 6e4 : Number(e.idleTimeout), this.queueLimit = isNaN(e.queueLimit) ? 0 : Number(e.queueLimit), this.resetOnRelease = e.resetOnRelease === void 0 ? !1 : !!e.resetOnRelease;
		}
	};
})), Yt = /* @__PURE__ */ i(((e, n) => {
	var r = t("process"), i = qt(), a = Jt(), o = Ut(), s = t("events").EventEmitter, c = {
		RR() {
			let e = 0;
			return (t) => t[e++ % t.length];
		},
		RANDOM() {
		...
		let e;
		return typeof r.hrtime == "function" ? (e = r.hrtime(), e = e[0] * 1e3 + e[1] * 1e-6) : e = r.uptime() * 1e3, Math.floor(e);
	}, u = function(e) {
		...
		constructor(e, t, n) {
			this._cluster = e, this._pattern = t, this._selector = c[n]();
		}
		getConnection(e) {
			let t = this._getClusterNode();
			if (t === null) {
				let t = /* @__PURE__ */ Error("Pool does Not exist.");
				return t.code = "POOL_NOEXIST", this._cluster._findNodeIds(this._pattern, !0).length !== 0 && (t = /* @__PURE__ */ Error("Pool does Not have online node."), t.code = "POOL_NONEONLINE"), e(t);
			}
			return this._cluster._getConnection(t, (t, n) => t ? this._cluster._canRetry && this._cluster._findNodeIds(this._pattern).length !== 0 ? (this._cluster.emit("warn", t), this.getConnection(e)) : e(t) : e(null, n));
		}
		query(e, t, n) {
			let r = o.createQuery(e, t, n, {});
			return this.getConnection((e, t) => {
				if (e) {
					typeof r.onResult == "function" ? r.onResult(e) : r.emit("error", e);
					return;
				}
		...
		_getClusterNode() {
			let e = this._cluster._findNodeIds(this._pattern);
			if (e.length === 0) return null;
			let t = e.length === 1 ? e[0] : this._selector(e);
			return this._cluster._getNode(t);
		}
	};
	n.exports = class extends s {
		constructor(e) {
			super(), e ||= {}, this._canRetry = e.canRetry === void 0 ? !0 : e.canRetry, this._removeNodeErrorCount = e.removeNodeErrorCount || 5, this._restoreNodeTimeout = e.restoreNodeTimeout || 0, this._defaultSelector = e.defaultSelector || "RR", this._closed = !1, this._lastId = 0, this._nodes = {}, this._serviceableNodeIds = [], this._namespaces = {}, this._findCaches = {};
		}
		of(e, t) {
			e ||= "*", t ||= this._defaultSelector, t = t.toUpperCase(), !c[t] === "undefined" && (t = this._defaultSelector);
			let n = e + t;
			return this._namespaces[n] === void 0 && (this._namespaces[n] = new d(this, e, t)), this._namespaces[n];
		}
		add(e, t) {
			typeof e == "object" && (t = e, e = `CLUSTER::${++this._lastId}`), this._nodes[e] === void 0 && (this._nodes[e] = {
				id: e,
				errorCount: 0,
				pool: new i({ config: new a(t) }),
				_offlineUntil: 0
			}, this._serviceableNodeIds.push(e), this._clearFindCaches());
		}
		remove(e) {
			let t = this._findNodeIds(e, !0);
			for (let e = 0; e < t.length; e++) {
				let n = this._getNode(t[e]);
				n && this._removeNode(n);
			}
		}
		getConnection(e, t, n) {
			let r;
			typeof e == "function" ? (n = e, r = this.of()) : (typeof t == "function" && (n = t, t = this._defaultSelector), r = this.of(e, t)), r.getConnection(n);
		}
		[Symbol.dispose]() {
			this._closed || this.end();
		}
			...
			this._closed = !0;
			let n = !1, i = 0, a = (e) => {
				if (!n && (e || --i <= 0)) return n = !0, t(e);
			};
			for (let e in this._nodes) i++, this._nodes[e].pool.end(a);
			i === 0 && r.nextTick(a);
		}
		_findNodeIds(e, t) {
			let n = 0, r = this._findCaches[e];
			if (r === void 0) {
				let t = u(e);
				r = this._serviceableNodeIds.filter((e) => e.match(t));
			}
			return this._findCaches[e] = r, t ? r : r.filter((e) => {
				let t = this._getNode(e);
				return t._offlineUntil ? (n ||= l(), t._offlineUntil <= n) : !0;
			});
		}
		_getNode(e) {
		...
		_increaseErrorCount(e) {
			...
			if (!(this._removeNodeErrorCount > t)) {
				if (this._restoreNodeTimeout > 0) {
					e._offlineUntil = l() + this._restoreNodeTimeout, this.emit("offline", e.id);
					return;
				}
		...
		_getConnection(e, t) {
			e.pool.getConnection((n, r) => n ? (this._increaseErrorCount(e), t(n)) : (this._decreaseErrorCount(e), r._clusterId = e.id, t(null, r)));
		}
		_removeNode(e) {
			let t = this._serviceableNodeIds.indexOf(e.id);
	...
	var { captureStackHolder: n } = Z(), r = $(), i = Q();
	t.exports = class e {
		constructor(e, t) {
			this.poolNamespace = e, this.Promise = t || Promise;
		}
		getConnection() {
			let e = this.poolNamespace;
			return new this.Promise((t, n) => {
				e.getConnection((e, i) => {
					e ? n(e) : t(new r(i, this.Promise));
				});
			});
		}
		query(t, r) {
			let a = this.poolNamespace, o = n(e.prototype.query);
			if (typeof r == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, n) => {
				let s = i(e, n, o);
				a.query(t, r, s);
			});
		...
		execute(t, r) {
			let a = this.poolNamespace, o = n(e.prototype.execute);
			if (typeof r == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, n) => {
				let s = i(e, n, o);
				a.execute(t, r, s);
	...
	var n = a(), r = t("events").EventEmitter, i = s(), o = Yt(), c = Xt(), l = Zt(), u = Qt(), d = Ht(), f = Kt(), { captureStackHolder: p, applyCapturedStack: m } = Z(), h = Q(), g = $(), _ = Vt(), v = $t();
	function y(e) {
		let t = c(e), n = p(y), r = e.Promise || Promise;
		if (!r) throw Error("no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }");
		return new r((e, i) => {
			t.once("connect", () => {
				e(new d(t, r));
			}), t.once("error", (e) => {
	...
	function b(e) {
		let t = l(e), n = e.Promise || Promise;
		if (!n) throw Error("no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }");
		return new f(t, n);
	}
	var x = class e extends r {
		constructor(e, t) {
			super(), this.poolCluster = e, this.Promise = t || Promise, _(e, this, [
				"warn",
				"remove",
				"online",
				"offline"
		...
		getConnection(e, t) {
			let n = this.poolCluster;
			return new this.Promise((r, i) => {
				n.getConnection(e, t, (e, t) => {
					e ? i(e) : r(new g(t, this.Promise));
				});
			});
		}
		query(t, n) {
			let r = this.poolCluster, i = p(e.prototype.query);
			if (typeof n == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, a) => {
				let o = h(e, a, i);
				r.query(t, n, o);
		...
		execute(t, n) {
			let r = this.poolCluster, i = p(e.prototype.execute);
			if (typeof n == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((e, a) => {
				let o = h(e, a, i);
				r.execute(t, n, o);
		...
		of(e, t) {
			return new v(this.poolCluster.of(e, t), this.Promise);
		}
		end() {
			let t = this.poolCluster, n = p(e.prototype.end);
			return new this.Promise((e, r) => {
				t.end((t) => {
					t ? (m(t, n), r(t)) : e();
				});
		...
		async [Symbol.asyncDispose]() {
			this.poolCluster._closed || await this.end();
		}
	};
	(function(e) {
		for (let t = 0; e && t < e.length; t++) {
			let n = e[t];
			typeof o.prototype[n] == "function" && x.prototype[n] === void 0 && (x.prototype[n] = (function(e) {
				return function() {
					return o.prototype[e].apply(this.poolCluster, arguments);
				};
			})(n));
		}
	})(["add", "remove"]);
	function S(e) {
		let t = u(e), n = e && e.Promise || Promise;
		if (!n) throw Error("no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }");
		return new x(t, n);
	}
	e.createConnection = y, e.createPool = b, e.createPoolCluster = S, e.escape = n.escape, e.escapeId = n.escapeId, e.format = n.format, e.raw = n.raw, e.Connection = d, e.PoolConnection = g, e.PromisePool = f, e.PromiseConnection = d, e.PromisePoolConnection = g, e.__defineGetter__("Types", () => A()), e.__defineGetter__("Charsets", () => R()), e.__defineGetter__("CharsetToEncoding", () => F()), e.setMaxParserCache = function(e) {
		i.setMaxCache(e);
