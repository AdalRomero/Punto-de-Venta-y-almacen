import { a as __toCommonJS, i as __require, n as __esmMin, r as __exportAll, t as __commonJSMin } from "./main.js";
...
var require_lib$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var isInSetAssignmentList = (sql, setEnd, placeholderPosition) => {
		const length = sql.length;
		let depth = 0;
	...
	var format = (sql, values, stringifyObjects, timezone) => {
		...
		while (valuesIndex < length && placeholderPosition !== -1) {
			...
			else if (typeof currentValue === "object" && currentValue !== null && !stringifyObjects) if (!(Array.isArray(currentValue) || currentValue instanceof Uint8Array || currentValue instanceof Date || hasSqlString(currentValue) || isDate(currentValue)) && (isRecord(currentValue) || currentValue instanceof Map)) {
	...
	var createLRU = (options) => {
		...
		const _shrink = (newMax) => {
			...
			for (let i = 0; i < remove; i++) {
				...
				onEviction === null || onEviction === void 0 || onEviction(key, valList[head]);
				keyMap.delete(key);
				head = next[head];
			}
...
//#endregion
//#region node_modules/mysql2/lib/parsers/parser_cache.js
var require_parser_cache = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { createLRU } = require_lib$2();
	var parserCache = createLRU({ max: 15e3 });
...
//#endregion
//#region node_modules/denque/index.js
var require_denque = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
...
//#endregion
//#region node_modules/mysql2/lib/constants/errors.js
...
var require_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		function preferDefault(exports$2) {
			return exports$2.default || exports$2;
		}
		if (typeof define === "function" && define.amd) define([], function() {
			var exports$3 = {};
			factory(exports$3);
			return preferDefault(exports$3);
		});
			...
			var exports$4 = {};
			factory(exports$4);
			global.Long = preferDefault(exports$4);
		})();
...
//#endregion
//#region node_modules/mysql2/lib/parsers/string.js
var require_string = /* @__PURE__ */ __commonJSMin(((exports) => {
	var Iconv = require_lib$1();
	var { createLRU } = require_lib$2();
	var decoderCache = createLRU({ max: 500 });
...
//#endregion
//#region node_modules/mysql2/lib/constants/types.js
...
var require_packet = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function jsonBigNumberReviver(key, value, context) {
		if (typeof value === "number" && !Number.isSafeInteger(value) && context !== void 0 && jsonIntegerSource.test(context.source)) return context.source;
		return value;
	}
	...
	module.exports = class Packet {
		...
		readDateTimeString(decimals, timeSep, columnType) {
			...
			} else if (columnType === Types.DATETIME || columnType === Types.TIMESTAMP) str += " 00:00:00";
			if (length > 10) {
				ms = this.readInt32();
				str += ".";
				if (decimals) {
		...
		parseJson(encoding, supportBigNumbers) {
			...
			if (supportBigNumbers && jsonSourceAccessSupported && str !== null && jsonBigNumeral.test(str)) return JSON.parse(str, jsonBigNumberReviver);
...
var require_packet_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_auth_next_factor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	module.exports = class AuthNextFactor {
		constructor(opts) {
...
var require_auth_switch_request = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	module.exports = class AuthSwitchRequest {
		constructor(opts) {
			this.pluginName = opts.pluginName;
			this.pluginData = opts.pluginData;
		}
...
var require_auth_switch_request_more_data = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	module.exports = class AuthSwitchRequestMoreData {
		constructor(data) {
			this.data = data;
		}
		toPacket() {
...
var require_auth_switch_response = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	module.exports = class AuthSwitchResponse {
		constructor(data) {
...
var require_binary_row = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Types = require_types();
	var Packet = require_packet();
...
//#endregion
//#region node_modules/mysql2/lib/constants/commands.js
var require_commands$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		SLEEP: 0,
		QUIT: 1,
		INIT_DB: 2,
...
var require_binlog_dump$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	var CommandCodes = require_commands$1();
...
//#endregion
//#region node_modules/mysql2/lib/constants/client.js
...
//#endregion
//#region node_modules/mysql2/lib/constants/charset_encodings.js
var require_charset_encodings = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var encodings = [
		"utf8",
		"big5",
		"latin2",
	...
	for (let id = 1025; id < 1024 + padSpaceLength; id++) encodings[id] = encodings[id - 1024];
	for (const [start, encoding] of [
		[2048, "cesu8"],
		[2304, "utf8"],
		[2560, "ucs2"],
		[2816, "utf16"],
		[3072, "utf32"]
	]) for (let id = start; id < start + 256; id++) encodings[id] = encoding;
	module.exports = encodings;
}));
//#endregion
//#region node_modules/mysql2/lib/packets/change_user.js
var require_change_user$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var CommandCode = require_commands$1();
...
var require_close_statement$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	var CommandCodes = require_commands$1();
...
//#endregion
//#region node_modules/mysql2/lib/constants/field_flags.js
var require_field_flags = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.NOT_NULL = 1;
	exports.PRI_KEY = 2;
...
var require_column_definition = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	var StringParser = require_string();
	var CharsetToEncoding = require_charset_encodings();
	var fields = [
	...
	var ColumnDefinition = class {
		constructor(packet, clientEncoding, mariadbExtendedMetadata) {
			...
			if (mariadbExtendedMetadata) this._parseMariadbExtendedMetadata(packet);
			packet.skip(1);
		...
		_parseMariadbExtendedMetadata(packet) {
			...
			while (packet.offset < extendedMetadataEnd) {
				...
				if (id === 0) this.extendedTypeName = value;
				else if (id === 1) this.extendedFormat = value;
			}
...
//#endregion
//#region node_modules/mysql2/lib/constants/cursor.js
...
var require_encode_parameter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Types = require_types();
	var Packet = require_packet();
		...
		if (value !== null) switch (typeof value) {
			...
			case "object":
				if (Object.prototype.toString.call(value) === "[object Date]") {
					...
					if (!jsonAsString) type = Types.JSON;
...
var require_execute$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Execute = class {
		...
		static fromPacket(packet, encoding) {
			...
			while (i < packet.end - 1) {
				if ((packet.buffer[i + 1] === Types.VAR_STRING || packet.buffer[i + 1] === Types.BLOB || packet.buffer[i + 1] === Types.NULL || packet.buffer[i + 1] === Types.DOUBLE || packet.buffer[i + 1] === Types.TINY || packet.buffer[i + 1] === Types.DATETIME || packet.buffer[i + 1] === Types.JSON) && packet.buffer[i] === 1 && packet.buffer[i + 2] === 0) break;
				else packet.readInt8();
				i++;
			}
			const types = [];
			for (let i = packet.offset + 1; i < packet.end - 1; i++) if ((packet.buffer[i] === Types.VAR_STRING || packet.buffer[i] === Types.BLOB || packet.buffer[i] === Types.NULL || packet.buffer[i] === Types.DOUBLE || packet.buffer[i] === Types.TINY || packet.buffer[i] === Types.DATETIME || packet.buffer[i] === Types.JSON) && packet.buffer[i + 1] === 0) {
			...
			for (let i = 0; i < types.length; i++) {
				...
				else if (types[i] === Types.BLOB) values.push(packet.readLengthCodedBuffer());
	...
	module.exports = class Handshake {
		...
		static fromPacket(packet) {
			...
			if (packet.haveMoreData()) {
				...
				} else args.mariadbExtendedCapabilityFlags = packet.readInt32();
			} else {
...
var require_handshake_response = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var ClientConstants = require_client();
	var CharsetToEncoding = require_charset_encodings();
	var Packet = require_packet();
	var auth41 = require_auth_41();
...
var require_prepare_statement = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	var CommandCodes = require_commands$1();
	var StringParser = require_string();
	var CharsetToEncoding = require_charset_encodings();
...
var require_prepared_statement_header = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_query$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Query = class {
		...
		toPacket() {
			if (!(this.clientFlags & ClientConstants.CLIENT_QUERY_ATTRIBUTES)) {
				const buf = StringParser.encode(this.query, this.encoding);
				const length = 5 + buf.length;
				const packet = new Packet(0, Buffer.allocUnsafe(length), 0, length);
				packet.offset = 4;
...
var require_register_slave$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	var CommandCodes = require_commands$1();
...
var require_reset_connection$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	var CommandCodes = require_commands$1();
...
var require_server_status = /* @__PURE__ */ __commonJSMin(((exports) => {
	/**
...
//#endregion
//#region node_modules/mysql2/lib/constants/encoding_charset.js
var require_encoding_charset = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		big5: 1,
		latin2: 2,
		dec8: 3,
...
//#endregion
//#region node_modules/mysql2/lib/constants/session_track.js
var require_session_track = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region node_modules/mysql2/lib/packets/resultset_header.js
var require_resultset_header = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	var ClientConstants = require_client();
...
//#endregion
//#region node_modules/mysql2/lib/packets/ssl_request.js
var require_ssl_request = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var ClientConstants = require_client();
	var Packet = require_packet();
...
var require_text_row = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packet = require_packet();
	module.exports = class TextRow {
		constructor(columns) {
			this.columns = columns || [];
		}
		static fromPacket(packet) {
...
//#endregion
//#region node_modules/mysql2/lib/constants/mariadb_client.js
var require_mariadb_client = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.MARIADB_CLIENT_PROGRESS = 1;
	exports.MARIADB_CLIENT_COM_MULTI = 2;
	exports.MARIADB_CLIENT_STMT_BULK_OPERATIONS = 4;
	exports.MARIADB_CLIENT_EXTENDED_METADATA = 8;
	exports.MARIADB_CLIENT_CACHE_METADATA = 16;
	exports.MARIADB_CLIENT_BULK_UNIT_RESULTS = 32;
}));
//#endregion
...
//#endregion
//#region node_modules/mysql2/lib/auth_plugins/mysql_native_password.js
var require_mysql_native_password = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var auth41 = require_auth_41();
...
//#endregion
//#region node_modules/mysql2/lib/auth_plugins/mysql_clear_password.js
var require_mysql_clear_password = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_auth_switch = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var standardAuthPlugins = Object.assign(Object.create(null), {
...
var require_client_handshake = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var { calculateToken: calculateSha2Token } = require_caching_sha2_password();
	function flagNames(flags) {
		const res = [];
		for (const c in ClientConstants) if (flags & ClientConstants[c]) res.push(c.replace(/_/g, " ").toLowerCase());
		return res;
	}
	module.exports = class ClientHandshake extends Command {
...
var require_server_handshake = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var CommandCode = require_commands$1();
	var Errors = require_errors();
	var Command = require_command();
	var Packets = require_packets();
	module.exports = class ServerHandshake extends Command {
		constructor(args) {
			super();
			this.args = args;
		}
...
//#endregion
//#region node_modules/mysql2/lib/constants/charsets.js
var require_charsets = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region node_modules/mysql2/lib/helpers.js
...
//#endregion
//#region node_modules/is-property/is-property.js
...
//#endregion
//#region node_modules/mysql2/lib/parsers/text_parser.js
var require_text_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Types = require_types();
	...
	function readCodeFor(field, encodingExpr, config, options) {
		...
		if (field.extendedFormat === "json") return config.jsonStrings ? `packet.readLengthCodedString(${encodingExpr})` : `packet.parseJson(${encodingExpr}, ${supportBigNumbers})`;
		switch (type) {
			case Types.TINY:
			case Types.SHORT:
			case Types.LONG:
			...
			case Types.JSON: return config.jsonStrings ? "packet.readLengthCodedString(\"utf8\")" : `packet.parseJson("utf8", ${supportBigNumbers})`;
			default:
...
//#endregion
//#region node_modules/mysql2/lib/parsers/static_text_parser.js
var require_static_text_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Types = require_types();
	var Charsets = require_charsets();
	var helpers = require_helpers();
	var typeNames = [];
	...
	function readField({ packet, field, type, charset, encoding, config, options }) {
		...
		const timezone = options.timezone || config.timezone;
		const dateStrings = options.dateStrings || config.dateStrings;
		if (field.extendedFormat === "json") return config.jsonStrings ? packet.readLengthCodedString(encoding) : packet.parseJson(encoding, supportBigNumbers);
		switch (type) {
			case Types.TINY:
			case Types.SHORT:
			case Types.LONG:
...
var require_close_statement = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Command = require_command();
	var Packets = require_packets();
...
//#endregion
//#region node_modules/mysql2/lib/parsers/binary_parser.js
var require_binary_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function readCodeFor(field, config, options, fieldNum) {
		...
		if (field.extendedFormat === "json") return config.jsonStrings ? `packet.readLengthCodedString(fields[${fieldNum}].encoding)` : `packet.parseJson(fields[${fieldNum}].encoding, ${supportBigNumbers});`;
...
//#endregion
//#region node_modules/mysql2/lib/parsers/static_binary_parser.js
var require_static_binary_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var FieldFlags = require_field_flags();
	var Charsets = require_charsets();
	var Types = require_types();
	var helpers = require_helpers();
	...
	function getBinaryParser(fields, _options, config) {
		function readCode(field, config, options, fieldNum, packet) {
			...
			const dateStrings = options.dateStrings || config.dateStrings;
			const unsigned = field.flags & FieldFlags.UNSIGNED;
			if (field.extendedFormat === "json") return config.jsonStrings ? packet.readLengthCodedString(field.encoding) : packet.parseJson(field.encoding, supportBigNumbers);
			switch (field.columnType) {
				case Types.TINY: return unsigned ? packet.readInt8() : packet.readSInt8();
				case Types.SHORT: return unsigned ? packet.readInt16() : packet.readSInt16();
				case Types.LONG:
...
var require_prepare = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Packets = require_packets();
	var Command = require_command();
	...
	module.exports = class Prepare extends Command {
		constructor(options, callback) {
			super();
...
var require_ping = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Command = require_command();
	var CommandCode = require_commands$1();
	var Packet = require_packet();
...
var require_register_slave = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Command = require_command();
	var Packets = require_packets();
	module.exports = class RegisterSlave extends Command {
...
//#endregion
//#region node_modules/mysql2/lib/packets/binlog_query_statusvars.js
var require_binlog_query_statusvars = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var keys = {
		FLAGS2: 0,
		SQL_MODE: 1,
		CATALOG: 2,
...
var require_binlog_dump = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Command = require_command();
	var Packets = require_packets();
	var eventParsers = [];
...
var require_change_user = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Command = require_command();
	var Packets = require_packets();
	var ClientConstants = require_client();
...
var require_reset_connection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Command = require_command();
	var Packets = require_packets();
	module.exports = class ResetConnection extends Command {
		constructor(callback) {
			super();
			this.onResult = callback;
		}
...
var require_quit = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Command = require_command();
	var CommandCode = require_commands$1();
	var Packet = require_packet();
...
//#endregion
//#region node_modules/mysql2/lib/commands/index.js
var require_commands = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		ClientHandshake: require_client_handshake(),
		ServerHandshake: require_server_handshake(),
		Query: require_query(),
		Prepare: require_prepare(),
		CloseStatement: require_close_statement(),
		Execute: require_execute(),
		Ping: require_ping(),
		RegisterSlave: require_register_slave(),
		BinlogDump: require_binlog_dump(),
		ChangeUser: require_change_user(),
		ResetConnection: require_reset_connection(),
		Quit: require_quit()
	};
}));
//#endregion
//#region node_modules/mysql2/package.json
var package_exports = /* @__PURE__ */ __exportAll({
	...
	typings: () => typings,
	version: () => version
}), name, version, description, main, typings, type, scripts, repository, homepage, keywords, files, exports$1, engines, author, dependencies, peerDependencies, devDependencies, package_default;
...
var require_proxies = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/aws-ssl-profiles/lib/index.js
var require_lib = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var defaults_js_1 = require_defaults();
	var proxies_js_1 = require_proxies();
	var proxyBundle = { ca: proxies_js_1.proxies };
	var profiles = { ca: [...defaults_js_1.defaults, ...proxies_js_1.proxies] };
	module.exports = profiles;
	module.exports.proxyBundle = proxyBundle;
	module.exports.default = profiles;
}));
//#endregion
//#region node_modules/mysql2/lib/constants/ssl_profiles.js
var require_ssl_profiles = /* @__PURE__ */ __commonJSMin(((exports) => {
	/**
	* @deprecated
	* Please, use [**aws-ssl-profiles**](https://github.com/mysqljs/aws-ssl-profiles).
	*/
	exports["Amazon RDS"] = { ca: require_lib().ca };
}));
//#endregion
...
var require_connection_config = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = class ConnectionConfig {
		constructor(options) {
...
var require_tracing = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function traceCallback(channel, fn, position, context, thisArg, ...args) {
		if (shouldTrace(channel)) return channel.traceCallback(fn, position, context(), thisArg, ...args);
		return fn.apply(thisArg, args);
	}
	function tracePromise(channel, fn, contextFactory) {
		if (shouldTrace(channel)) return channel.tracePromise(fn, contextFactory());
		return fn();
	}
	module.exports = {
		dc,
...
var require_named_placeholders = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var RE_PARAM = /(?:\?)|(?::(\d+|(?:[a-zA-Z][a-zA-Z0-9_]*)))/g, DQUOTE = 34, SQUOTE = 39, BSLASH = 92;
...
var require_connection$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var CharsetToEncoding = require_charset_encodings();
	var { traceCallback, tracePromise, getServerContext, shouldTrace, queryChannel, executeChannel, connectChannel } = require_tracing();
	var _connectionId = 0;
	var convertNamedPlaceholders = null;
	module.exports = class BaseConnection extends EventEmitter$5 {
		constructor(opts) {
			super();
...
//#endregion
//#region node_modules/mysql2/lib/promise/capture_local_err.js
var require_capture_local_err = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_make_done_cb = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/mysql2/lib/promise/prepared_statement_info.js
var require_prepared_statement_info = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { captureStackHolder } = require_capture_local_err();
	var makeDoneCb = require_make_done_cb();
	module.exports = class PromisePreparedStatementInfo {
...
//#endregion
//#region node_modules/mysql2/lib/promise/inherit_events.js
var require_inherit_events = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_connection$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var PromiseConnection = class PromiseConnection extends EventEmitter$4 {
...
var require_pool_connection$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var PromiseConnection = require_connection$1();
...
var require_pool_connection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_pool$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var BaseConnection = require_connection$2();
	var Errors = require_errors();
	var { traceCallback, getServerContext, poolConnectChannel } = require_tracing();
		...
		query(sql, values, cb) {
			...
			this.getConnection((err, conn) => {
				...
				try {
					...
					if (origOnResult) cmdQuery.onResult = function(err, rows, fields) {
						queryError = err || null;
						origOnResult(err, rows, fields);
					};
					else cmdQuery.once("error", (err) => {
						queryError = err;
					});
			...
			this.getConnection((err, conn) => {
				...
				try {
					conn.execute(sql, values, (err, rows, fields) => {
						if (isReadOnlyError(err)) conn.destroy();
						cb(err, rows, fields);
					}).once("end", () => {
						conn.release();
					});
...
var require_pool$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var inheritEvents = require_inherit_events();
	var BasePool = require_pool$2();
	var PromisePool = class PromisePool extends EventEmitter$2 {
...
//#endregion
//#region node_modules/mysql2/lib/pool.js
...
//#endregion
//#region node_modules/mysql2/lib/pool_config.js
var require_pool_config = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var ConnectionConfig = require_connection_config();
...
//#endregion
//#region node_modules/mysql2/lib/create_connection.js
var require_create_connection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Connection = require_connection();
	var ConnectionConfig = require_connection_config();
...
//#endregion
//#region node_modules/mysql2/lib/create_pool.js
var require_create_pool = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Pool = require_pool();
	var PoolConfig = require_pool_config();
...
//#endregion
//#region node_modules/mysql2/lib/create_pool_cluster.js
var require_create_pool_cluster = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/mysql2/lib/promise/pool_cluster.js
var require_pool_cluster = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { captureStackHolder } = require_capture_local_err();
	var PromisePoolConnection = require_pool_connection$1();
	var makeDoneCb = require_make_done_cb();
	module.exports = class PromisePoolNamespace {
...
var require_promise = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var PromiseConnection = require_connection$1();
	var PromisePool = require_pool$1();
	var { captureStackHolder, applyCapturedStack } = require_capture_local_err();
	var makeDoneCb = require_make_done_cb();
	var PromisePoolConnection = require_pool_connection$1();
	var inheritEvents = require_inherit_events();
	var PromisePoolNamespace = require_pool_cluster();
	...
	var PromisePoolCluster = class PromisePoolCluster extends EventEmitter {
